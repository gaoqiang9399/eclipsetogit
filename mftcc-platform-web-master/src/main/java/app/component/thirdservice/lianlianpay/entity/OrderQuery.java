...
字，精确到秒
    ...
    /**
     * 查询版本号 不传就是老版本 默认 1.0
1.1 版本查询新增 memo 字段、银行名称
bank_name 字段
     * @return
     * @author MaHao
     * @date 2017-10-24 上午9:15:47
     */
