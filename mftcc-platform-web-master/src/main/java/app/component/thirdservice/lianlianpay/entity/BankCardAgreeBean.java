...
public class BankCardAgreeBean extends TranBaseBean{
    ...
    private String risk_item;//此字段填写风控参数，采用 json 串的模式传入，字段名和字段内容彼此对应好，例如：    {"frms_ware_category":"2010","user_info_mercht_userno":"123456","user_info_bind_phone":"13812345678","user_info_dt_register":"20141015165530","user_info_full_name":" 张 三    ","user_info_id_no":"3306821990012121221","user_info_identify_type":"1","user_info_identify_state":"1"}
    private String app_request ;//1-Android 2-ios 3-WAP
	...
	/**
	 * 连连支付签约平台在用户签约成功后或者失败
通知商户服务端的地址，注意不可带参数
	 * @return
	 * @author MaHao
	 * @date 2017-9-26 下午1:06:53
	 */
