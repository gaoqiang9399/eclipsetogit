...
@Controller
@RequestMapping(value = {"/sysWareLogin"})
public class SysWareLoginController extends BaseFormBean {
    ...
    @RequestMapping(value = "/wareLogin", method = RequestMethod.GET)
    public String index(Model model) {
        //仓储机构登录
        YmlConfig ymlConfig = (YmlConfig)SpringUtil.getBean(YmlConfig.class);
        String  exitStr = ymlConfig.getWebservice().get("loginJspPath");
        return exitStr;
    ...
    public String shiroCheck(Model model, String opNo, String opName, String passwordhash, String frame, String ztName) throws Exception {
        ...
        if(isUse.equals("1")){
            exitStr= ymlConfig.getWebservice().get("loginJspPath");
        }
        ...
        if (sysUser != null) {
            ...
            //仓储系统，开启后只支持仓储人员登录
            if(isUse.equals("1") && !BizPubParm.OP_NO_TYPE4.equals(opNoType)){
...
//		}
    ...
    private String handleLoginSuccessBusiness(Model model, String remeg, SysUser sysUser, String returnflag, String frame, String opNo, HttpServletRequest request) throws Exception {
        ...
        if (frame.equals("viewIE8")) {
            ...
            returnFlag="/layout/view/wareView";
