...
/**
* Title: PssSaleReturnBill.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Thu Sep 14 15:30:38 CST 2017
* @version：1.0
**/
public class PssSaleReturnBill extends BaseDomain {
	private String saleReturnBillId;//主键
	...
	private Double amount;//销货退货金额
	private Double quantity;//数量
	private Double discountRate;//优惠率(%)
	private Double discountAmount;//退款优惠金额
	private Double discountAfterAmount;//优惠后金额
	private Double thisRefund;//本次退款
	private Double refunded;//已退款
	private String settlementAccount;//结算账户
	private Double thisDebt;//本次欠款
	private Double saleRefundExpense;//销售退货费用
	private String refundState;//退款状态(01-未退款 02-部分退款 03-全部退款)
	...
	private Double invoiceState;//开票状态(01-已全部开票 02-未全部开票)
	...
	public String getSaleReturnBillId() {
	 	return saleReturnBillId;
	}
	/**
	 * @设置 主键
	 * @param saleReturnBillId
	 */
	public void setSaleReturnBillId(String saleReturnBillId) {
	 	this.saleReturnBillId = saleReturnBillId;
	}
	/**
	 * @return 销货退货单号
	 */
	 ...
	 * @param thisRefund
	 */
	public void setThisRefund(Double thisRefund) {
	 	this.thisRefund = thisRefund;
	}
	/**
	 * @return 已退款
	 */
	 ...
	 * @return 销售退货费用
	 */
	public Double getSaleRefundExpense() {
	 	return saleRefundExpense;
	}
	/**
	 * @设置 销售退货费用
	 * @param saleRefundExpense
	 */
	public void setSaleRefundExpense(Double saleRefundExpense) {
	 	this.saleRefundExpense = saleRefundExpense;
	}
	/**
	 * @return 退款状态(01-未退款 02-部分退款 03-全部退款)
	 */
	public String getRefundState() {
	 	return refundState;
	}
	/**
	 * @设置 退款状态(01-未退款 02-部分退款 03-全部退款)
	 * @param refundState
	 */
	...
	/**
	 * @return 开票状态(01-已全部开票 02-未全部开票)
	 */
	public Double getInvoiceState() {
	 	return invoiceState;
	}
	/**
	 * @设置 开票状态(01-已全部开票 02-未全部开票)
	 * @param invoiceState
	 */
