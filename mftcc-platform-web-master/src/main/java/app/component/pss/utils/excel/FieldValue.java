...
public class FieldValue {
	...
	private Class<?> clazz;
	/** Field子类属性的全部定义 */
	private List<FieldChildValue> fieldChildValues = new ArrayList<FieldChildValue>();
	...
	public List<FieldChildValue> getFieldChildValues() {
		return fieldChildValues;
	}

	public void setFieldChildValues(List<FieldChildValue> fieldChildValues) {
