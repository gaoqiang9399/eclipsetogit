...
/**
* Title: PssCustomerContacts.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Fri Dec 01 16:24:00 SGT 2017
* @version：1.0
**/
public class PssCustomerContacts extends BaseDomain {
	private String customerContactsId;//主键
	private String cusNo;//客户主表主键
	 ...
	 */
	public void setCustomerContactsId(String customerContactsId) {
