...
/**
* Title: PssBuyReturnBill.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Thu Sep 14 14:19:26 CST 2017
* @version：1.0
**/
public class PssBuyReturnBill extends BaseDomain {
	private String buyReturnBillId;//主键
	 ...
	 * @return 主键
	 */
	public String getBuyReturnBillId() {
	 	return buyReturnBillId;
	}
	/**
	 * @设置 主键
	 * @param buyReturnBillId
	 */
	public void setBuyReturnBillId(String buyReturnBillId) {
	 	this.buyReturnBillId = buyReturnBillId;
	}
	/**
	 * @return 购货退货单号
	 */
