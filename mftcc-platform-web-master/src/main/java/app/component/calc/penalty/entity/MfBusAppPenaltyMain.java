...
/**
* Title: MfBusAppPenaltyMain.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Sat Jul 01 17:31:56 CST 2017
* @version：1.0
**/
public class MfBusAppPenaltyMain extends BaseDomain {
	private String id;//唯一序号
	private String appId;//申请id
	private String pactId;//合同id
	private String fincId;//借据id
	private String sysPenaltyMainId;//表mf_sys_penalty_main的id
	private String kindNo;//产品种类编号
	private String repayTypeNo;//还款方式编号
	private String penaltyReceiveType;//违约金计算类型:1-百分比%,2-固定金额,3-阶梯比例Parm_dic表PENALTY_RECEIVE_TYPE
	...
	private String penaltyType;//违约金分类 ：1-逾期违约金，2-提前还款违约金
	...
	/**
	 * @return 表mf_sys_penalty_main的id
	 */
	public String getSysPenaltyMainId() {
	 	return sysPenaltyMainId;
	}
	/**
	 * @设置 表mf_sys_penalty_main的id
	 * @param sysPenaltyMainId
	 */
	public void setSysPenaltyMainId(String sysPenaltyMainId) {
	 	this.sysPenaltyMainId = sysPenaltyMainId;
	}
	/**
	 * @return 产品种类编号
	 */
	...
	/**
	 * @return 违约金计算类型:1-百分比%,2-固定金额,3-阶梯比例Parm_dic表PENALTY_RECEIVE_TYPE
	 */
	public String getPenaltyReceiveType() {
	 	return penaltyReceiveType;
	}
	/**
	 * @设置 违约金计算类型:1-百分比%,2-固定金额,3-阶梯比例Parm_dic表PENALTY_RECEIVE_TYPE
