...
/**
* Title: MfFrontAppformVO.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Thu Jun 26 17:18:20 CST 2017
* @version：1.0
**/
public class MfFrontAppformVO extends FormActive {
	private String id;//
	private String kindNo;//产品编号
//	private String fieldName;//数据库中的字段名称 FormActive已存在
