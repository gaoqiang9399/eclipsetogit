...
/**
 * 
 * @author  这个类是辅助计算xirr的类， 主要是以时间对应现金的形式组成一条现金流 而xirr则是由多条现金流计算出来的
 */
public class XirrDate {
	...
	public XirrDate(int year, int month, int day, double payment) {
		this.year = year;
		this.month = month;
		this.day = day;
	 ...
	 * @param payment  对应的现金
	 */
	public XirrDate(String stringTime, double payment) {
		try {			
