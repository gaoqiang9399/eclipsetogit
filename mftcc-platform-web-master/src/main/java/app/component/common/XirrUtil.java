...
public class XirrUtil {
	...
	private ArrayList<XirrDate> listUpbaa;
	public XirrUtil(ArrayList<XirrDate> listUpbaa){		
	...
	public static void main(String[] args) {
		ArrayList<XirrDate> list=new ArrayList<XirrDate>();
		XirrDate  date01=new XirrDate("2016/09/20",-200000);
		XirrDate  date02=new XirrDate("2016/10/20",41067.66);
		XirrDate  date03=new XirrDate("2016/11/20",41067.66);
		XirrDate  date04=new XirrDate("2016/12/20",41067.66);
		XirrDate  date05=new XirrDate("2017/01/20",41067.66);
		XirrDate  date06=new XirrDate("2017/02/20",41067.66);
		...
		XirrUtil Xirr=new XirrUtil(list);
