...
/**
* Title: RecallConfigLetter.java
* Description:
* @author：kaifa@dhcc.com.cn
* @Thu Mar 23 15:31:18 CST 2017
* @version：1.0
**/
public class RecallConfigLetter extends BaseDomain {
	private String letterNo;//催收信函配置编号
	...
	private String returnBeforeDays;
	private String returnAfterDays;
