...
<html>
  <head>
		...
		function closePop(){
			...
			var path = '${webPath}';
			var viewMenuData = [{css:"qian2", name:"财务", no:"88", seqn:7, url:webPath+"/mfBusFincApp/getListPage?entranceNo=88"}];
			var myLayout;
	...
	<body onLoad="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);">
		...
		<div class="outer-west" style="overflow:visible!important;">
			...
			<div class="outer-west-center" style="background-color: #153754 !important;overflow:visible;">
				...
				<ul class ="menu_A" style="" id="cwMenu">
					<li class = "menu-active">
						<i class="i i-wenjian2"></i><a href="${webPath}/vcVehicleCertificate/getListPage" pagetype="diannao" onclick="return false">合格证</a>
					</li>
					<li class = "">
						<i class="i i-zhihuan"></i><a href="${webPath}/vcChangeCertificateApply/getListPage" pagetype="qian2" onclick="return false">换证</a>
					</li>
					<li class = "">
						<i class="i i-plejiancha"></i><a href="${webPath}/vcTakeStockMain/getListPage" pagetype="qian2" onclick="return false">盘库</a>
					</li>
						<li class = "">
						<i class="i  i-duizhang"></i><a href="${webPath}/vcReconciliationMain/getListPage" pagetype="qian2" onclick="return false">对账</a>
					</li>
					<li class = "">
						<i class="i i-caiji"></i><a href="${webPath}/vcCertificateScanfile/getListPage" pagetype="qian2" onclick="return false">扫描件</a>
					</li>
					<li class = "">
						<i class="i i-jingbao1"></i><a href="${webPath}/vcSysWarningInfo/getListPage" pagetype="qian2" onclick="return false">预警</a>
					</li>
					<li class = "">
						<i class="i i-fangdajing"></i><a href="${webPath}/vcmsReportFilter/getListPage" pagetype="qian2" onclick="return false">查询</a>
					</li>
					<li class = "">
						<i class="i i-chilun"></i><a href="${webPath}/vcmsSettings/settingPage" pagetype="qian2" onclick="return false">设置</a>
					</li>
				</ul>
			</div>
		</div>
