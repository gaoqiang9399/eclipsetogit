		...
		<div class="outer-center">
			...
			<div id="middle-north" class="middle-north">
				...
				<div class="middle-north-west TopBar-chevron" style="height:55px;">
					...
					<img src="${webPath}/<%= mfSysCompanyMst.getPropagandaLanguageImg() %>" style="width: 214px;height:39px; margin-top:15px; margin-left:283px;" />
				</div>
			    ...
			    <div class="middle-north-center">
			    	<div class="pull-right">
						 <ul class="nav navbar-nav">
							<%--<dhcc:pmsTag pmsId="nav-search-all">
								 <li>
									 <a id="searchGlobalForNav" href="#" class="task-msg" onclick="toSearchGlobalPage();">
										 <i class="i i-fangda middle-north-i"></i>
										 <span class="pull-left">搜索</span>
									 </a>
								 </li>
							</dhcc:pmsTag>--%>
							<!--待办任务-->
...
<script type="text/javascript">
	...
	function getMessagePage(){
     ...
     function toSearchGlobalPage(){
        // rzzl.skipPage(webPath+"/mfQueryEntrance/getSearchGlobalPage");
         top.showDialog(webPath+"/mfQueryEntrance/getSearchGlobalPage","全局搜索","90","95");
         LoadingAnimate.stop();
         $("#searchGlobalForNav").addClass("messagePageSel");
         $(".menu-active").removeClass("menu-active");
         $("#perDa").removeClass("messagePageSel");
