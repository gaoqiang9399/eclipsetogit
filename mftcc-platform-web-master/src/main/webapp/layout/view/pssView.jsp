...
String opNo =User.getRegNo(ServletActionContext.getRequest());
  ...
  <head>
		...
		function closePop(){
			...
			$(document).ready(function() {
				...
				<%-- $.get("CwInitSystemActionAjax_getSysInitFlagAjax.action", function(data){
	...
	<body class="bgView" onLoad="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);">
		<div class="outer-center">
			<div class="middle-center pt-perspective">
				...
				<!-- 详情 -->
			    <div class="middle-north-center" style="background-color:#32b5cb;">
		...
		<div class="outer-west" style="overflow:visible!important;">
			<!-- LOGO-->
			<!-- 视角-->
			<div class="outer-west-center" style="background-color: #153754 !important;overflow:visible;">
				...
				<ul class ="menu_A" id="cwMenu">
					<dhcc:pmsTag pmsId="pss-general-menu">
						<li class = "menu-active" id="pssGeneralLi">
							<i class="i i-fangkuai"></i><a href="${webPath}/component/pss/general/pssGeneral.jsp" pagetype="qian2" onclick="return false">概况</a>
						</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="pss-purchases-menu">
						<li class = "" id="pssBuyLi">
							<i class="i i-tihuo"></i><a href="${webPath}/component/pss/purchases/PurchasesEntrance.jsp" pagetype="qian2" onclick="return false">采购</a>
						</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="pss-sales-menu">
						<li class = "" id="pssSaleLi">
							<i class="i i-selfinc"></i><a href="${webPath}/component/pss/sales/SalesEntrance.jsp" pagetype="qian2" onclick="return false">销售</a>
						</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="pss-stock-menu">
						<li class = "" id="pssStoreLi">
							<i class="i i-assets"></i><a href="${webPath}/component/pss/stock/StoreStockEntrance.jsp" pagetype="qian2" onclick="return false">仓库</a>
						</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="pss-fund-menu">
						<li class = "" id="pssFundLi">
							<i class="i i-banian"></i><a href="${webPath}/component/pss/fund/FundEntrance.jsp" pagetype="qian2" onclick="return false">资金</a>
						</li>
					</dhcc:pmsTag>
					<li class = "" id="pssReportLi">
						<i class="i i-tongji"></i><a href="${webPath}/PssReportAction_getReportListPage.action" pagetype="qian2" onclick="return false">报表</a>
					</li>
					<dhcc:pmsTag pmsId="pss-set-menu">
						<li class = "" id="pssInfoLi">
							<i class="i i-chilun"></i><a href="${webPath}/component/pss/information/infoEntrance.jsp" pagetype="qian2" onclick="return false">设置</a>
						</li>
					</dhcc:pmsTag>
				</ul>
				<%-- <ul class ="menu_A" style="display: none;" id="cwInitMenu">
					<li class = "menu-active">
						<a href="${webPath}/component/finance/paramset/CwSystemInit.jsp" pagetype="diannao" onclick="return false">进销存初始化</a>
					</li>
				</ul> --%>
			</div>
		</div>
