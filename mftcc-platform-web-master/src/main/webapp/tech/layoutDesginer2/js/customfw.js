...
function onDrop($item,wall){
	...
	$("body .fw-float .fa-trash").bind("click", {cell:$("body .fw-float")} , delCell);
	$("body .fw-float .fa-refresh").bind("click", {cell:$("body .fw-float")} , refreshCell);
	var $info = $("body .fw-float .info");
	$info.parent().append("<div class='pluginBorder info_hover' style='background-color:transparent;position: absolute;display: none;'><a class='btn' onclick='edit(this)'><i class='icon-edit'></i>锟洁辑</a></div>");
