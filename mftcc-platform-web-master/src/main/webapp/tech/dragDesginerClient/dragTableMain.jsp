...
<!--引用自己的样式 -->
<link rel="stylesheet" href="./app/table/css/dragTableMain.css"/>
<!--引用font awesome 图标库-->
...
<script src="./app/common/config/tableConfig.js"></script>
<script>
    // Set configuration
    seajs.config({
    ...
    seajs.use("<%=contextpath%>/tech/dragDesginerClient/app/table/js/dragTableMain.js");
    //解决兼容性
    seajs.use('compatibility/html5shiv.min.js');
    seajs.use('compatibility/respond.min.1.4.2.js');
     seajs.use('<%=contextpath%>/tech/dragDesginerClient/app/common/js/leaseSelect.js',function(auto){
