...
(function($) {
    ...
    function Freewall(selector) {
        ...
        setting = $.extend({}, layoutManager.defaultConfig);
        runtime = {
            arguments: null,
        ...
        $.extend(klass, {
            ...
            */
            ...
            fitHeight: function(heightArgs) {

                var height = heightArgs ? heightArgs : container.height() || $W.height();
            ...
            fitWidth: function(widthArgs) {

                var width = widthArgs ? widthArgs : container.width() || $W.width();
