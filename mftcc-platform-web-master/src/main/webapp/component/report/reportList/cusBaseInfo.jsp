...
<%@ page import="app.component.report.entity.MfReportCustomer"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=b43d3610cea5954c25b960095cc38c55";
	List<MfReportCustomer> list = new ArrayList<MfReportCustomer>();
