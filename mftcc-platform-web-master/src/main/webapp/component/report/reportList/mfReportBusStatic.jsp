...
<%@ page import="app.component.report.entity.MfReportStatic"%>
<% 
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=5605a9d5ebc1fc22cb7c2add06fbae2e";
	List<MfReportStatic> list = new ArrayList<MfReportStatic>();
