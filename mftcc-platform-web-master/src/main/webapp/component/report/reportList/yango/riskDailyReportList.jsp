...
<%@ page import="app.component.report.wangxin.entity.BlackListBean"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=b59415fe666bf696b3c7d99ae12d321c";
	List<BlackListBean> list = new ArrayList<BlackListBean>();
	list = (List)request.getAttribute("riskList");
	Gson gson = new Gson();
