...
<body class="bg-white">
	...
	<fieldset>
		...
		<div class="form-group">
			<label class="col-xs-4 control-label" for="date1">放款日期：</label>
			<div class="col-xs-1">
				<input class="form-control" name="date1" id="date1" type="text">
			</div>
			<div class="col-xs-1 tubiao" align="absmiddle"><i class="i i-rili"></i>&nbsp;&nbsp;&nbsp;&nbsp;-----</div>
			<div class="col-xs-1">
...
<script type="text/javascript" src="js/MfReport_overdueAll.js"></script>
<script>
	$(function(){
		overdueAll.init();
	});
