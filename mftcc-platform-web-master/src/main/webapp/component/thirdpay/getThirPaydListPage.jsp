	...
	<head>
		...
		<script type="text/javascript" >
			$(function(){
				...
				url : webPath+"/mfRequestThirdPartyRecord/findByPageAjax", //列表数据查询的url
			...
			function makeLoansAjax(obj, url) {
				alert("是否重新发起放款？", 2, function() {
					$.ajax({
						type : "post",
						url : webPath + url,
						success : function(data) {
							if (data.flag == "success") {
								alert(data.msg, 3, function() {
									location.href = webPath+'/mfRequestThirdPartyRecord/getThirPaydListPage';
								});
							} else {
								alert(data.msg, 0, function() {
									location.href = webPath+'/mfRequestThirdPartyRecord/getThirPaydListPage';
								});
							}
						}
