	...
	<head>
		...
		<script type="text/javascript">
			...
			function ajaxSubmitThis(obj){
				var modelContent = $("textarea[name=pliWarnContent]").val();
				if(modelContent == ''){
					alert("催收模板内容不能为空",0);
					return ;
				}
							
				parent.dialog.get("PliWarnDialog").close(modelContent);
			}
		</script>
		<style type="text/css">
.input-class1 {
...
.content_btn {
				...
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="urgeModelInsertForm" theme="simple" name="operform">
							<dhcc:bootstarpTag property="formpliwarnmodel0002" mode="query"/>
						</form>
					</div>
				</div>
	   		</div>
	...
	<script type="text/javascript">
        ...
        function insertText(objinput) {
            ...
            str = '\\${'+str+'}';
            $("textarea[name='pliWarnContent']").insertContent(str);
        };
			(function($) {
			_initModel();
            $.fn.extend({
