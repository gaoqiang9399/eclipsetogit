...
<html>
	<head>
		...
		$(function(){
            ...
            $("textarea[name=cuslendWarnContent]").parents("tr").hide();
		  });
		...
		*/
		...
		varUsage = varUsage.replace(/\|/g,",");
			dialog({
				...
				title:'模板内容',
				url: webPath + '/cuslendWarning/getModelInputPage?cuslendWarnNo='+cuslendWarnNo+'&varUsage='+varUsage,
				width:1200,
				height:470,
				backdropOpacity:0,
				onshow:function(){
		...
		function saveMsgConfig(obj){
			...
			if(flag){
				...
				$.ajax({
					...
					data : {ajaxData : dataParam,jsonStr:"insert"},
					async : false,
				...
				<div class="scroll-content">
					<div class="col-md-8 col-md-offset-2 column margin_top_20">
						<div class="bootstarpTag">
							...
							<form method="post" id="cuslendForm" theme="simple" name="operform" action="${webPath}/cuslendWarning/insertAjax">
