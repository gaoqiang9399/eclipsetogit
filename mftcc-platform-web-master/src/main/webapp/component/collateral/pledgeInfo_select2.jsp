...
<head>
	...
	<script type="text/javascript" >
        ...
        $(function(){
            ...
            getPledgePageByAppIdSelect();
        });
        //只查询跟业务关联的押品
        function getPledgePageByAppIdSelect(){
            myCustomScrollbar({
                ...
                data:{cusNo:cusNo,appId:appId,collateralType:collateralType,pleFlag:"warrant"},//指定参数
                callback:function(){
                    LoadingAnimate.stop();
        ...
        function enterClick(parm){
            ...
            var pledgeMethod = parmArray[2].split("=")[1];
            var data = new Object();
            data.pledgeNo=pledgeNo;
            data.pledgeName=pledgeName;
            data.pledgeMethod=pledgeMethod;
