;
var WkfReceRebateViewPoint=function(window,$){
	var _init=function(){
...
//		});
	...
	var _doSubmit=function(obj){
		...
		if(flag){
			commitProcess(webPath+"/mfReceivablesRebateApp/submitUpdateAjax?opinionType"+opinionType+"&rebateAppId="+rebateAppId
