$(function(){
	...
	$("#receBaseInfo").html(dataMap.htmlStr);
...
function buyerRepayment(){
    top.flag=false;
    top.window.openBigForm(webPath+'/mfRepayment/repaymentJspForBuy?fincId='+fincId,'买方付款','');
}
//卖方还款
function repayment(){
    top.flag=false;
    top.window.openBigForm(webPath+'/mfRepayment/repaymentJspForAccount?fincId='+fincId,'反转让','');
}
