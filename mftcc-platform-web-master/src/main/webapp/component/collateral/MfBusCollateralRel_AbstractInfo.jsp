...
<%
	...
	fincMainId = StringUtil.KillNull(fincMainId);
...
%>
<script type="text/javascript" src="${webPath}/component/collateral/js/MfBusCollateralRel_AbstractInfo.js"></script>
...
$(function(){
	...
	MfBusCollateralRel_AbstractInfo.fincMainId = '<%=fincMainId%>';
    ...
    MfBusCollateralRel_AbstractInfo.extensionApplyId = '<%=extensionApplyId%>';
...
<div id="pleInfono" class="row clearfix no-content hide">
	...
	<div class="col-xs-9 col-md-9 column no-content-tip">
		...
		<span id="noPledge" onclick="addCollateralInfo()" style="display:none;font-size: 14;">添加反担保信息</span>
	</div>
</div>
<!-- 展示押品信息 -->
