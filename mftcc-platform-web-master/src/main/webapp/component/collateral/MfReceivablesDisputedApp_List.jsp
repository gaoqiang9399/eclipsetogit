...
<html>
	<head>
		<title>列表</title>
          ...
          <script type="text/javascript" src="${webPath}/component/collateral/js/MfReceivablesDisputedAppList.js"></script>
		<script type="text/javascript" >
			var busPleId = '${busPleId}';
			var appSts = '${mfReceivablesDisputedApp.appSts}';
			var disputedAppId = '${mfReceivablesDisputedApp.disputedAppId}';
			$(function(){
		...
		<div class="container scroll-content">
			...
			<div class="row clearfix">
				<div class="col-md-12">
					...
					<dhcc:tableTag paginate="mfReceivablesDisputedAppList" property="tablerecedisputed0001" head="true" />
					</div>
				</div>
