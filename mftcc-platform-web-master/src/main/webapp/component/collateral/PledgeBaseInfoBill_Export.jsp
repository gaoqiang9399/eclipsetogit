...
<script type="text/javascript">
	$(function() {
		...
		var uploadInstance = WebUploader.create({
			...
			// 文件接收服务端。
			server: '${webPath}/pledgeBaseInfoBill/importPledgeBillPlateAjax',
			//参数
...
<body>
	<div class="mod-toolbar-top">
		<div class="left mod-crumb">
			<a href="javascript:void(0);">押品清单</a>&gt; <span class="cur">Excel导入</span>
		</div>
	</div>
	<div class="wrapper">
		...
		<div class="mod-inner">
			...
			<div id="import-wrap" class="cf">
				<div id="import-step1" class="step-item" style="">
					...
					<a href="${webPath}/pledgeBaseInfoBill/printPledgeBillTemplate" class="link">下载模版</a>
					<div class="step-btns">
...
<!-- 					<input type="checkbox" id="voucherReSeq" checked="checked" name="voucherReSeq"> <label for="voucherReSeq">凭证重新编号</label> -->
					<div class="ctn file-import-ctn">
						<span class="tit">请选择要导入的Excel文件：</span> 
