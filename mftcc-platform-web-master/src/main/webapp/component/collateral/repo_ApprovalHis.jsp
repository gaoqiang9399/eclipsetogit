...
<head >
	...
	<script type="text/javascript" src='${webPath}/component/auth/js/repo_ApprovalHis.js'></script>
...
<%-- 			<iframe src='tech/wkf/processDetail.jsp?appNo=${repoAppId}&appWorkflowNo=' marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" id = "processDetailIframe"></iframe> --%>
