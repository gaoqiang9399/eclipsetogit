	...
	<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				...
				<form  method="post" id="collateralClass" theme="simple" name="operform" action="${webPath}/mfCollateralClass/collateralTypeInsertAjax">
					<dhcc:bootstarpTag property="formdlcollateralclass0001" mode="query" />
				</form>
			</div>
		</div>
	</div> 
