...
<html>
		...
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 margin_top_20">
					<div class="bootstarpTag">
						...
						<form  method="post" id="MfMoveableClaimGoodsApplyForm" theme="simple" name="operform" action="${webPath}/mfMoveableClaimGoodsApply/insertAjax">
							<dhcc:bootstarpTag property="formclaim0002" mode="query"/>
						</form>
					</div>
			...
			<div class="formRowCenter">
				<!-- ajaxSave方法不适用时需另行实现。新写JS代码必须闭包。 -->
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfMoveableClaimGoodsApply.ajaxClaimGoodsApplySave('#MfMoveableClaimGoodsApplyForm')"></dhcc:thirdButton>
	...
	<script type="text/javascript">
		...
		var pledgeSumAmt="";
		var claimGoodsBal='${claimGoodsBal}';
        var processId='${processId}';
		$(function(){
			MfMoveableClaimGoodsApply.init();
		});
        function chooseNextApprovalUser(){
            var obj = $("input[name=firstApprovalUserName]")
            WkfApprove.getNextUserByNodePage(obj,'node5437924222');
        }
	</script>
</html>
