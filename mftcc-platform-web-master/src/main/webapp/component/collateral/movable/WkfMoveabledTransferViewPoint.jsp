...
<html>
  <head>
		...
		<script type="text/javascript" src="${webPath}/component/collateral/js/WkfMoveabledTransferViewPoint.js"></script>
		<script type="text/javascript">
			var transferId='${transferId}';
			var appId='${appId}';
			var busPleId='${mfMoveableTransferApply.busPleId}';
			$(function(){
				WkfMoveabledTransferViewPoint.init();
			});
		</script>
</head>
...
<body  class="overflowHidden bg-white">
		...
		<div id="approvalDiv" class="scroll-content" style="display:none;">
			<div class="col-md-8 col-md-offset-2 column margin_top_20" >
				<div class="bootstarpTag">
					...
					<form  id="moveTranApprovForm">
						<dhcc:bootstarpTag property="formtransferappro0001" mode="query" />
					</form>		
				</div>
				<div id="goodsDetailListdiv" class="bigform_content col_content">
						<div class="title"><h5 >货物明细</h5></div>
							<div id="goodsDetailList" class="table_content">
								<dhcc:tableTag paginate="pledgeBaseInfoBillList" property="tabledlpledgebaseinfobill00006" head="true" />
							</div> 
				</div>
			</div>
		</div>
		<div id="approvalBtn" class="formRowCenter " style="display:block;">
			<dhcc:thirdButton value="审批" action="审批" onclick="WkfMoveabledTransferViewPoint.getApprovaPage();"></dhcc:thirdButton>
		...
		<div id="submitBtn" class="formRowCenter" style="display:none;">
			<dhcc:thirdButton value="提交" action="提交" onclick="WkfMoveabledTransferViewPoint.doSubmit('#moveTranApprovForm');"></dhcc:thirdButton>
			<dhcc:thirdButton value="返回" action="返回" typeclass="cancel" onclick="WkfMoveabledTransferViewPoint.approvalBack();"></dhcc:thirdButton>
		</div>
	</div>	
