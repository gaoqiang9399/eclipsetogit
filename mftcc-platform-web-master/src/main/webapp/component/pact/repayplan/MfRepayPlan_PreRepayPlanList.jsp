...
<head>
    ...
    <script type="text/javascript">
        ...
        var planEndDate = '${repayPlanEndDate}';
        var planBeginDate = '${mfBusPact.beginDate}';
                        ...
                        <form id="repayPlanForm">
                            <table id="repayPlan_tablist" width="100%" border="0" align="center"
                                ...
                                <tr>
                                    ...
                                    <th scope="col" align="center" name="planBeginDate" sorttype="0">开始日</th>
                                ...
                                <c:forEach items="${repayPlanList}" varStatus="i" var="repayPlan">
								   ...
								   <span class="tab_span"
                                        ...
                                        <td id="tdRepayIntst_${repayPlan.termNum}"
                                            ondblclick="repayPlan_List.showRepayIntsInputValue(this)">
											<span class="tab_span money_right"
...
<div class="formRowCenter" style="text-align: center;position: fixed">
    ...
    <dhcc:thirdButton value="保存" action="保存"
                      onclick="repayPlan_List.doEditorPrePlanAjax(this);"></dhcc:thirdButton>
