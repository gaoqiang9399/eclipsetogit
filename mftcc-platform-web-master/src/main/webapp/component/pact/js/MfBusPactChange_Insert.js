;
var MfBusPactChange_Insert = function(window, $) {
    ...
    var _selectChangePact = function () {
        $("input[name='pactNo']").popupList({
            ...
            ajaxUrl:webPath+"/mfBusPactChange/getPactList",//请求数据URL
            title: "选择合同",//标题
    ...
    var _getForm = function(pactNo){
        $.ajax({
            url : webPath+"/mfBusPactChange/getPactChangeApply?pactNo=" + pactNo,
