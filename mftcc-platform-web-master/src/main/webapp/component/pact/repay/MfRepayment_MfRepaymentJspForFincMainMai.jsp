...
<script type="text/javascript" src="${webPath}/component/pact/repay/js/mfRepaymentJspForFincMainMai.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
        ...
        MfRepaymentJspForFincMainMai.init();
	});
...
<div class="container form-container">
	<div class="scroll-content">
		<div class="col-md-12  column  margin_top_20">
			<div class="bootstarpTag fourColumn">
				...
				<form method="post" id="buyerRepayment" theme="simple" name="operform" action="${webPath}/mfBusFincAppMain/doRepaymentOperateForBuyFincMainMai">
	...
	<div class="formRowCenter">
		...
		<dhcc:thirdButton value="保存" action="保存" onclick="MfRepaymentJspForFincMainMai.ajaxInsert('#buyerRepayment')"></dhcc:thirdButton>
