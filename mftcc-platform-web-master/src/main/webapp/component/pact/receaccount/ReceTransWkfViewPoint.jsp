		...
		<script type="text/javascript">
			...
			function doSubmit(obj){
				...
				if(flag){
					...
					commitProcess(webPath+"/mfBusReceTransferMain/submitUpdateAjax?appId=${appId}&transMainId="+transMainId+"&appNo="+transMainId+"&opinionType="+opinionType,obj,'applySP');
				}
...
<body  class="overflowHidden bg-white">
	<div class="container form-container">
		<div id="infoDiv" style="display:block;height:100%;">
			...
			<iframe src="${webPath}/mfBusReceBaseInfo/getReceDetail?appId=${appId}&cusNo=${cusNo}&busEntrance=pact_approve&transMainId=${transMainId}" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
		</div>
		<div id="approvalDiv" class="scroll-content" style="display:none;">
			<div class="col-md-10 col-md-offset-1 column margin_top_20" >
				<div class="bootstarpTag fourColumn">
					...
					<form id="edit-form">
						<dhcc:bootstarpTag property="formrecetransinfo" mode="query" />
					</form>	
				</div>
				<div class="list-table">
					...
					<div id="accountList" class="content collapse in" aria-expanded="true">
						<dhcc:tableTag property="tablecertiReceTransApprovalBaseList" paginate="mfBusReceTransferList" head="true"></dhcc:tableTag>
					</div>
				</div>
			</div>
		</div>
