;
var pub_batch_finc_main_head_info = function(window, $) {
    var _appId = '';
    var _pactId = '';
    var _fincMainId = '';
    var _init = function () {
        $.ajax({
            ...
            data:{fincMainId:pub_batch_finc_main_head_info.fincMainId,appId:pub_batch_finc_main_head_info.appId,pactId:pub_batch_finc_main_head_info.pactId},
    ...
    var _getKindInfo = function(){
        top.window.openBigForm(webPath+'/mfBusAppKind/getById?appId='+pub_batch_finc_main_head_info.appId,'产品信息',function(){});
    }
	return {
		init : _init,
