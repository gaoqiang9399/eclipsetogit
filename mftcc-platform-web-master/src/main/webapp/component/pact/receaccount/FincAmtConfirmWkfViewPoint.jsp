		...
		<script type="text/javascript">
			...
			function doSubmit(obj){
				...
				if(flag){
					...
					commitProcess(webPath+"/mfBusFincAmtConfirm/submitUpdateAjax?appId=${appId}&confirmId="+confirmId+"&appNo="+confirmId+"&opinionType="+opinionType,obj,'applySP');
				}
		...
		<div id="approvalDiv" class="scroll-content" style="display:none;">
			<div class="col-md-10 col-md-offset-1 column margin_top_20" >
				<div class="bootstarpTag fourColumn">
					...
					<form id="edit-form">
						<dhcc:bootstarpTag property="formconfirmapprovalbase" mode="query" />
					</form>	
				</div>
