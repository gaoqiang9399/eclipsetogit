...
<html>
		...
		<script type="text/javascript" >
			...
			$(function(){
			      myCustomScrollbar({
			    	...
			    	url:webPath+"/mfLitigationExpenseApply/getAssetManageList?applyFlag="+applyFlag,
			    	tableId:"tableassetapplylist",//列表数据查询的table编号
	...
	<script type="text/javascript">
			function choseCredit(parm){
                ...
                var applyFlag='${applyFlag}';
				$.ajax({
					url:webPath+"/mfLitigationExpenseApply/getInfo",
					dataType:"json",
