...
<html>
	<head>
		<title>列表</title>
		<script type="text/javascript" src="${webPath}/component/pact/assetmanage/js/MfAssetManage_List.js"></script>
		<script type="text/javascript" >
		var applyFlag='${applyFlag}';
			$(function(){
			    myCustomScrollbar({
			    	obj:"#content",//页面内容绑定的id
			    	url:webPath+"/mfAssetManage/findByPageAjax?applyFlag="+applyFlag,//列表数据查询的url
			    	tableId:"tablequeryassetmanage0001",//列表数据查询的table编号
		...
		<div class="row clearfix bg-white tabCont">
			...
			<div class="btn-div">
				...
				<div class="col-md-8 text-center">
					<c:if test="${applyFlag eq '0'}">
					<span class="top-title">依法收贷</span>
					</c:if>
					<c:if test="${applyFlag eq '1'}">
					<span class="top-title">诉讼申请</span>
					</c:if>
				</div>
			</div>
