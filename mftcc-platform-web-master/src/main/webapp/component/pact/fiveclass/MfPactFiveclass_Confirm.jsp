...
<html>
	<head>
		<link rel="stylesheet" href="${webPath}/themes/factor/css/view-detail.css?v=v0310" />
		...
		<div class="mf_content">
					...
					<div class="row clearfix padding_top_15 padding_left_40">
						<div class="col-md-12 column">
							<div class="col-md-3 column">
								<span>客户名称：</span>
								<span class="margin_top_15"><span class="">${mfCusCustomer.cusName}</span> </span>
							</div>
							<div class="col-md-3 column">
								<span>合同编号：</span>
								<span class="margin_top_15"><span class="">${mfBusPact.pactId}</span> </span>
							</div>
					   ...
					   <div class="col-md-12 column">
					   		<div class="col-md-3 column">
								<span>项目名称：</span>
								<span class="margin_top_15"><span class="">${mfBusPact.appName}</span> </span>
							</div>
					   		<div class="col-md-3 column">
								<span>合同金额：</span>
								<span class="margin_top_15"><span class="">${mfBusPact.pactAmt}</span>元</span>
							</div>
					   </div>	
					   <div class="col-md-12 column">
					   		<div class="col-md-3 column">
							...
							<div class="col-md-3 column">
								...
								<span class="margin_top_15">
									<span class="business-span">
										<c:if test="${mfPactFiveclass.systemFiveclass == 1}">正常</c:if>
										<c:if test="${mfPactFiveclass.systemFiveclass == 2}">关注</c:if>
										<c:if test="${mfPactFiveclass.systemFiveclass == 3}">次级</c:if>
										<c:if test="${mfPactFiveclass.systemFiveclass == 4}">可疑</c:if>
										<c:if test="${mfPactFiveclass.systemFiveclass == 5}">损失</c:if>
									</span> 
								</span>
							</div>
					   </div>
			...
			<div class="content-box" style="width: 83%;">
				...
				<div class="tab-content">
					<form method="post" id="operform"   name="operform" action="MfPactFiveclass/confirmAjax">
