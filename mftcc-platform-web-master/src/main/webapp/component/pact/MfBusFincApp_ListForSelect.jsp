	...
	<head>
        ...
        var sts5 = '${sts5}';
			$(function(){
				...
				var table = "tablefincSelect";
				var url = webPath+"/mfBusFincApp/findByPageAjax";
			    myCustomScrollbar({
			...
			function chooseFinc(parm){
				...
				$.ajax({
					url:webPath+"/mfBusFincApp/getWithAppByIdAjax?fincId="+fincId,
					dataType:"json",
					type:"POST",
					success:function(data){
						if(data.flag == "success"){
							var obj = $.extend({},data.mfBusApply, data.mfBusFincApp);
