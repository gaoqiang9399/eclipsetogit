...
<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div id="infoDiv" style="height:100%;width:75%;float: left;">
				<iframe src="${webPath}/mfGuaranteeLift/getById?pactId=${pactId}&from=approval" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
			</div>
			<div id="approvalDiv" class="scroll-content" style="width: 25%;float: right;">
				<div class="col-md-10 col-md-offset-1 column margin_top_20" >
					<div class="bootstarpTag fourColumn" id="formButton">
						...
						<form id="mfGuaranteeLiftForm">
							<dhcc:bootstarpTag property="formGuaranteeLiftApprove" mode="query" />
						</form>
					</div>
				</div>
			</div>
			<div id="submitBtn" class="formRowCenter">
					<dhcc:thirdButton value="提交" action="提交" onclick="WkfGuaranteeLiftViewPoint.doSubmitAjax('#mfGuaranteeLiftForm');"></dhcc:thirdButton>
...
<script type="text/javascript" src="${webPath}/component/pact/guarantee/js/WkfGuaranteeLiftViewPoint.js"></script>
<script type="text/javascript">
		$(function(){
			WkfGuaranteeLiftViewPoint.init();
		});
</script>
<style>
	.block-left {
