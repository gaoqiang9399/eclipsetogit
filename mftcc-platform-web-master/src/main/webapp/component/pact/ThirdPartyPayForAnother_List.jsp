		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
					...
					url:webPath+"/thirdPartyPayForAnother/findByPageAjax", //列表数据查询的url
					tableId : "tablethirdPartyPay0001", //列表数据查询的table编号
			...
			function exportExcel(){
				...
				$.ajax({
					url:webPath+"/thirdPartyPayForAnother/exportListAjax",
					data : {exportFincId:exportFincIdStr},
					success:function(data){
						LoadingAnimate.stop();
						if(data.flag == "success"){
							window.top.location.href = encodeURI("DocUploadAction_fileDownload_fuyiou.action?path="+data.filePath+"&fuyiouType=1");
						}else{
							alert(data.msg,0);
						}
					},error:function(){
