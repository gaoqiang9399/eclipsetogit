  ...
  <head>
		...
		<script type="text/javascript">
			...
			function doSubmit(obj){
				...
				if(flag){
					commitProcess(webPath+"/mfBusPactChange/submitUpdateAjax?opinionType="+opinionType+"&changePactId="+changePactId+"&appNo="+changePactId,obj,'pactChangeSP');
				}
			}
		</script>
</head>
		...
		<div id="approvalDiv" class="scroll-content">
			<div class="col-md-10 col-md-offset-1 column margin_top_20" >
				<div class="bootstarpTag">
					...
					<form id="edit-form"  >
						<dhcc:bootstarpTag property="formchangePact" mode="query" />
					</form>	
				</div>
