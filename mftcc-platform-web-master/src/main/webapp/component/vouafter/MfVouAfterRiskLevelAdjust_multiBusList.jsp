...
<html>
	...
	var mfVouAfterRiskLevelAdjustProjectListSize='${mfVouAfterRiskLevelAdjustProjectListSize}';
	$(function(){
        //处理暂无数据的情况
        if(mfVouAfterRiskLevelAdjustProjectListSize == "0"){
...
<body class="bg-white">
 	<div class="container scroll-content">
 		 <div class="row clearfix">
			<c:if test="${mfVouAfterRiskLevelAdjustProjectList != null and fn:length(mfVouAfterRiskLevelAdjustProjectList) > 0}">
				<div class="arch_sort">
