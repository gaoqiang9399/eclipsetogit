...
<body class="overflowHidden bg-white">   
		<div class="container form-container">
			<div id="infoDiv" style="height:100%;width:75%;float: left;">
				<iframe src="${webPath}/mfVouAfterRiskLevelAdjust/getById?id=${id}&nodeNo=${nodeNo}" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
			</div>
			<div id="approvalDiv" class="scroll-content" style="width: 25%;float: right;">
				<div class="col-md-10 col-md-offset-1 column margin_top_20" >
					<div class="bootstarpTag fourColumn" id="formButton">
						...
						<form id="mfVouAfterRiskLevelAdjustForm">
							<dhcc:bootstarpTag property="formVouAfterRiskLevelAdjustApprove" mode="query" />
						</form>
					</div>
				</div>
			</div>
			<div id="submitBtn" class="formRowCenter">
				<dhcc:thirdButton value="提交" action="提交" onclick="WkfVouAfterRiskLevelAdjustViewPoint.doSubmitAjax('#mfVouAfterRiskLevelAdjustForm');"></dhcc:thirdButton>
...
<script type="text/javascript" src="${webPath}/component/vouafter/js/WkfVouAfterRiskLevelAdjustViewPoint.js"></script>
<script type="text/javascript">
		$(function(){
			WkfVouAfterRiskLevelAdjustViewPoint.init();
		});	
</script>
<style>
	.block-left {
