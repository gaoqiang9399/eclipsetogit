...
<html>
	...
	var mfHandAmtManageProjectListSize='${mfHandAmtManageProjectListSize}';
	$(function(){
        //处理暂无数据的情况
        if(mfHandAmtManageProjectListSize == "0"){
...
<body class="bg-white">
 	<div class="container scroll-content">
 		 <div class="row clearfix">
			<c:if test="${mfHandAmtManageProjectList != null and fn:length(mfHandAmtManageProjectList) > 0}">
				<div class="arch_sort">
