...
<html>
	...
	var mfRefundManageProjectListSize='${mfRefundManageProjectListSize}';
	$(function(){
        //处理暂无数据的情况
        if(mfRefundManageProjectListSize == "0"){
...
<body class="bg-white">
 	<div class="container scroll-content">
 		 <div class="row clearfix">
			<c:if test="${mfRefundManageProjectList != null and fn:length(mfRefundManageProjectList) > 0}">
				<div class="arch_sort">
