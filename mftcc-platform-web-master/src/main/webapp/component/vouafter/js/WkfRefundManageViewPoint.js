;
var WkfRefundManageViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfRefundManage/submitUpdateAjax?appNo="+id+"&opinionType="+opinionType,formObj,'RefundManage');
		}
	};
