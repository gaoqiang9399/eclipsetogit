...
<body class="overflowHidden bg-white">   
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-xs-10 col-md-offset-1 column margin_top_20">
					<div class="bootstarpTag">
						<div class="form-title"></div><%--发票审批--%>
						<div class="form-tips">说明：带*号的为必填项信息，请填写完整。</div>
						<form  method="post" id="cusInsertForm" theme="simple" name="operform" action="${webPath}/mfBusInvoicemanage/submitUpdateOutAjax">
			...
			<div id="approvalBtn" class="formRowCenter " style="display:block;">
				<dhcc:thirdButton value="审批" action="审批" onclick="WkfInvoiceOutViewPoint.doSubmitAjax('#cusInsertForm');"></dhcc:thirdButton>
...
<script type="text/javascript" src="${webPath}/component/invoicemanage/js/WkfInvoiceOutViewPoint.js"></script>
<script type="text/javascript">
		$(function(){
            WkfInvoiceOutViewPoint.init();
		});	
</script>
</html>