;
var WkfInvoiceViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfBusInvoicemanage/submitUpdateAjax?appNo="+invoiceId+"&opinionType="+opinionType,formObj,'mfBusinvoicecheck');
		}
	};
	//返回详情页面
