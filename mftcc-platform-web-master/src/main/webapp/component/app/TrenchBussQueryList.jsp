...
<link rel="stylesheet" href="${webPath}/component/app/css/TrenchBussQueryList.css?v=${cssJsVersion}" />
<script type="text/javascript" src="${webPath}/component/app/js/TrenchBussQueryList.js?v=${cssJsVersion}"></script>
<script type="text/javascript">
	$(function() {
		TrenchBussQueryList.init();
	});
	
	function getDetailPage(obj,url){
		/* var param=url.split("?")[1];
		url = "MfBusApplyAction_getTrenchApplySummary.action?"+param; */
			...
			<div class="col-md-12 column">
				<div class="search-title">
					<ul class="nav nav-tabs">
						<li id="menu-all"><a class="active">全部</a></li>
						<li id="menu-repay"><a>还款中</a></li>
						<li id="menu-finish"><a>已完结</a></li>
					</ul>
				</div>
