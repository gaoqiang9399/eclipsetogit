(function($) {
		...
		fSelect.prototype = {
			...
			reloadDropdownLabel : function() {
				...
				this.$wrap.find('.fs-option.selected').each(function(i, el) {
					var obj = {};
					obj["id"] = $(el).attr('data-value');
					obj["name"] = $(el).find('.fs-option-label').text();
					labelVal.push(obj);
	...
	$(document).on('click', '.fs-option', function() {
		...
		if ($wrap.hasClass('multiple')) {
			...
			var changeCallback = $wrap.find('select').data('fSelect').settings.changeCallback;
			if (changeCallback && typeof (changeCallback) == "function") {
				changeCallback.call(this, labelVal);
			}
		} else {
