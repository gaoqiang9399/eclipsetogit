		...
		<div class="scroll-content">
			<div class="col-md-8 col-md-offset-2 column margin_top_20">
				<div class="bootstarpTag">
					...
					<form method="post" id="updateForm" theme="simple" name="operform" action="${webPath}/vwBannerManage/updateAjax">
						<dhcc:bootstarpTag property="formvwbanner0001" mode="query" />
					</form>
				</div>
			</div>
		</div>
...
<script src="${webPath}/component/frontview/js/AppBannerManage_Detail.js"></script>
<script type="text/javascript">
var webPath="${webPath}";
$(function(){
	AppBannerManageDetail.init();
})
</script>
</html>
