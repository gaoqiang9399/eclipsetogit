		...
		<div class="row clearfix bg-white tabCont">
			...
			<div  class="btn-div">
						<button type="button" class="btn btn-primary pull-left"
							onclick="finForm_input('${webPath}/vwBannerManage/input');">新增</button>
...
<script src="${webPath}/component/frontview/js/VwBannerManage_List.js"></script>
<script type="text/javascript">
	$(function(){
		VwBannerManageList.init();
	});
</script>
</html>
