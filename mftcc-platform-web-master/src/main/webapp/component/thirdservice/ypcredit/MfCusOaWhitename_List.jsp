	...
	<head>
		...
		<script type="text/javascript" >
			$(function(){
				...
				url :webPath+ "/mfCusOaWhitename/findByPageAjax", //列表数据查询的url
				tableId : "tableoawhitename", //列表数据查询的table编号
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="search-div">
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=名称/身份证号"/>
					</div>
				</div>
			</div>
