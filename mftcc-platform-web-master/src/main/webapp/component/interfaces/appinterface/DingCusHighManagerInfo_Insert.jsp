...
// 			$("input[name='cusName']").attr("readonly","readonly");
			$("input[name='brithday']").attr("type","date");
			//自动性别生日赋值
			$("input[name='idNum']").blur(function(){
				DingUtil.setBirthyAndSexByID(this,"sex","brithday");
			});
	  	};
		...
		function beforeSaveAjax(obj){
			...
			var idNumResult = DingUtil.checkUniqueVal(idNum,idNumTitle,relationId,"MfCusHighInfo","01","insert","");
	...
	<body>
		<form method="post" action="${webPath}/dingCusBusiness/insertHighManagerAjax" class="weui_cells weui_cells_form" id="insertForm">
