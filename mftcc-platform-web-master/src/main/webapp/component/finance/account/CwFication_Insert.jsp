...
<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					...
					<form method="post" theme="simple" name="operform" id="fication_form" action="${webPath}/cwFication/insertAjax">
						<dhcc:bootstarpTag property="formfication0002" mode="query" />
						<%-- <div class="formRowCenter" style="position: fixed; left: 40%; bottom: 0px;">
							<dhcc:thirdButton value="保存" action="保存"
								onclick="ajaxInsertThis('#fication_form');"></dhcc:thirdButton>
		...
		<div class="formRowCenter">
				<dhcc:thirdButton value="保存" action="保存" onclick="ajaxInsertThis('#fication_form');"></dhcc:thirdButton>
