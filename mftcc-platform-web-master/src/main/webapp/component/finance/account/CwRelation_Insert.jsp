...
<html>
	<head>
		...
		function getCowItemInfoArtDialog(cowItemInfo){
			...
			$("input[name=accNo]").val(cowItemInfo.accName+'['+cowItemInfo.accNo+']');
...
<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" theme="simple" name="operform" id="cwrelation_form" action="${webPath}/cwRelation/insertAjax">
			...
			<div class="formRowCenter">
				<dhcc:thirdButton value="保存" action="保存" onclick="ajaxInsertThis('#cwrelation_form');"></dhcc:thirdButton>
...
<script type="text/javascript">
	$(function() {
		...
		//var value=$("input[name='accName']").val();
		$("input[name='accNo']").parent().html("");
		accNohtml
				.append("<input class='form-control Required' type=\"text\" title=\"科目编号\" id=\"accNo\" name=\"accNo\"  datatype=\"0\" mustinput=\"1\" maxlength=\"30\" onblur=\"func_uior_valTypeImm(this);\" onmousedown=\"enterKey()\" onclick=\"autoComPleter(this, '2', comPlateBack)\" onkeydown=\"enterKey();\">");
		accNohtml
