		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/cwFicationData/findByPageAjax?txType="+${txType},//列表数据查询的url
			    	tableId:"tableficationdata0001",//列表数据查询的table编号
		...
		<div class="row clearfix bg-white tabCont">
			<div class="col-md-12 column">
				<div class="btn-div">
					...
					<button type="button" class="btn btn-primary pull-left" onclick="addCwFicationData()">新增</button>
				...
				<!-- <div class="col-md-12 column">
				<div class="btn-div">
					<button type="button" class="btn btn-primary" onclick="addCwFicationData()">新增</button>
				</div>
...
<script type="text/javascript">
		function addCwFicationData(){
			var txType = $("#txType").text();
			//top.showDialog("${webPath}/cwFicationData/input?txType="+txType,"新增辅助项数据", "50","70");
			
			top.addFlag = false;
		 	top.htmlStrFlag = false;
			top.createShowDialog("${webPath}/cwFicationData/input?txType="+txType,"新增辅助项数据",'75','70',function(){
			if(top.addFlag){
		...
		function getFicationById(url){
			top.addFlag = false;
		 	top.htmlStrFlag = false;
			top.createShowDialog(webPath+"/"+url,"辅助项详情",'75','70',function(){
			if(top.addFlag){
			updateTableData();//重新加载列表数据
