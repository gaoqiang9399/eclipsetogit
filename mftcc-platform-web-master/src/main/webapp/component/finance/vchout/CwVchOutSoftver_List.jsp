...
<script type="text/javascript">
	$(function() {
		myCustomScrollbar({
			...
			url:webPath+"/cwVchOutSoftver/findByPageAjax", //列表数据查询的url
			tableId : "tablevchout0001", //列表数据查询的table编号
	...
	<div class="container">
		<div class="row clearfix bg-white tabCont">
			<div class="col-md-12">
				...
				<div class="btn-div">
					<button type="button" class="btn btn-primary" onclick="toCorrBindList();">对应关系设置</button>
				</div>
