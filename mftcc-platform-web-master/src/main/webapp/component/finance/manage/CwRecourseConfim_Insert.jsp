...
<script type="text/javascript">
	...
	function save(obj){
		...
		if (flag) {
			...
			$.ajax({
				...
				url : "${webPath}/cwRecourseConfim/insertAjax",
				dataType : "json",
	...
	function changeCollectBankInfo(bankAcc){
		$("input[name='vouBankAccId']").val(bankAcc.id);
	...
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="cwBillForm" theme="simple" name="operform" action="${webPath}/cwRecourseConfim/insertAjax">
					<dhcc:bootstarpTag property="formcwrecourseconfimedit" mode="query"/>
				</form>
			</div>
		</div>
	</div>
	<div class="formRowCenter">
		<dhcc:thirdButton value="确认" action="确认" onclick="save('#cwBillForm');"></dhcc:thirdButton>
