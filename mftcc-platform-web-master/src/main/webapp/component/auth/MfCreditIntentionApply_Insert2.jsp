...
<html>
		...
		<div class="container form-container">
			...
			<div class="col-md-10 col-md-offset-1 column margin_top_20">
				...
				<div class="form-tips">说明：带*号的为必填项信息，请填写完整。</div>
					<form  method="post" theme="simple" name="operform" id="operform" action="${webPath}/mfCreditIntentionApply/insertAjax">
			...
			<div class="formRowCenter">
				<dhcc:thirdButton value="保存" action="保存" typeclass="saveButton" onclick="mfCreditIntentionApplyInsert.ajaxInsert('#operform')"></dhcc:thirdButton>
	...
	<script type="text/javascript" src='${webPath}/component/auth/js/MfCusCreditApply_Insert.js'></script>
		...
		<script type="text/javascript">
			...
			var $form=$("#operform");
			var cusNo='${cusNo}';
			var creditModel='${creditModel}';//授信模式
