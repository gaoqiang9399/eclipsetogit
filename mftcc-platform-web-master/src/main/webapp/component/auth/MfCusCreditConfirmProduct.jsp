...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var userId ="";
			$(function(){
				MfCusCreditConfirmProduct.init();
			});
			...
			<div class="scroll-content">
				<div class="col-md-10 col-md-offset-1 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form  method="post" theme="simple" name="operform" id="operform" action="${webPath}/mfCusCreditApply/saveConfirmProductAjax">
							<dhcc:bootstarpTag property="formcreditProjectProduct" mode="query"/>
						</form>
					</div>
				...
				<div class="formRowCenter">
					 <dhcc:thirdButton value="提交" action="提交" onclick="MfCusCreditConfirmProduct.ajaxInsert('#operform');"></dhcc:thirdButton>
					 <dhcc:thirdButton value="关闭" action="关闭" typeclass="cancel" onclick="myclose();"></dhcc:thirdButton>
				</div>
		</div>
	</body>
	<script type="text/javascript" src='${webPath}/component/auth/js/MfCusCreditApply_Detail.js'></script>
	<script type="text/javascript" src='${webPath}/component/auth/js/MfCusCreditConfirmProduct.js'></script>
