...
<script type="text/javascript">
	...
	var extendTableId = '${param.formId}';
	$(function() {
        $.ajax({
            url:webPath+"/mfCusCreditApply/getExendListHtmlAjax?creditAppId="+creditAppId+"&tableId="+extendTableId,
            type:'post',
            dataType:'json',
     ...
     function extendDetail (obj, url) {
         top.window.openBigForm( webPath + url + "&creditAppId="+creditAppId,'非系统生成相关合同详情',function() {
         });
    }
</script>
<!--收款计划信息 -->
<div class="row clearfix" id="pactExtendListDiv">
	<div class="col-xs-12 column">
		<div class="list-table-replan">
			<div class="title">
				<span><i class="i i-xing blockDian"></i>授信非业务生成合同信息</span>
			...
			<div class="content margin_left_15 collapse in" id="mfBusPactExtendList">
				<dhcc:tableTag property="tablepactExtendCreditList" paginate="mfBusPactExtendList" head="true"></dhcc:tableTag>
			</div>
		</div>
	</div>
</div>
