		...
		<div class="container form-container">
			<div class="scroll-content">
				...
				<div class="col-md-10 col-md-offset-1 margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="MfCusCreditChildContractForm" theme="simple" name="operform" action="/mfCusCreditChildContract/insertAjax.action">
			...
			<div class="formRowCenter">
				<!-- ajaxSave方法不适用时需另行实现。新写JS代码必须闭包。 -->
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfCusCreditChildContract_Insert.ajaxInsert('#MfCusCreditChildContractForm')"></dhcc:thirdButton>
