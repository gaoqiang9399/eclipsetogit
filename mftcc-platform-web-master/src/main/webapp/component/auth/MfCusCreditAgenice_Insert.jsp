...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
                MfCusCreditAgencies_Insert.init();
			});
		</script>
	</head>
		...
		<div class="container form-container">
			...
			<div class="formRowCenter">
				<!-- ajaxSave方法不适用时需另行实现。新写JS代码必须闭包。 -->
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfCusCreditAgencies_Insert.ajaxSave('#MfCusCreditAgenciesForm')"></dhcc:thirdButton>
