	...
	<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-10 col-md-offset-1 column margin_top_20">
					<div class="bootstarpTag fourColumn">
						...
						<form method="post" id="ecamIndexInsertForm" theme="simple" name="operform" action="${webPath}/mfExamIndex/insertAjax">
			...
			<div class="formRowCenter">
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfExamIndex.ajaxInsertThis('#ecamIndexInsertForm');"></dhcc:thirdButton>
