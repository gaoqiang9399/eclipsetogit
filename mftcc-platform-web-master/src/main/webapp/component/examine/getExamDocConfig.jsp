...
<html>
		...
		<div class="container form-container">
			<div class="scroll-content">
				...
				<div class="bootstarpTag">
					...
					<form method="post" id="docModelForm" theme="simple" name="operform" action='${webPath}/mfExamineTemplateConfig/updateDocAjax'>
						<dhcc:bootstarpTag property="formexamdoc" mode="query" />
					</form>
				</div>
	...
	<script type="text/javascript" src='${webPath}/component/examine/js/getExamDocConfig.js'></script>
	<script type="text/javascript">
