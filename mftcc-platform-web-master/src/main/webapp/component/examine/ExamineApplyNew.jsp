	...
	*/
	$(function(){
        ...
        if (getFlag=="add"||getFlag=="apply"||getFlag=="query"){
            ExamineApply.initTemplateOptions(templateType);
        }
        ExamineApply.init();
	});
					...
					<div  name="evalapp" class="li_content_type container form-container">
						<div class="scroll-content" id="evalapp">
							...
							<div class="col-md-10 col-md-offset-1 column" >
								<button class="btn btn-opt" onclick="ExamineApply.getPfsDialog();"
										type="button">
									<i class="i i-qian1"></i><span>上传财务报表</span>
								</button>
							</div>
							<!-- 检查模板 -->
							<div class="col-md-10 col-md-offset-1 column" >
						...
						<c:if test="${query!='query'}">
							<div class="formRowCenter" id ="evalappButton" style="display: none;bottom:40px\9;">
								<dhcc:thirdButton value="暂存" action="暂存" onclick="ExamineApplySave.temporaryUpdate('#evalMsg')"></dhcc:thirdButton>
