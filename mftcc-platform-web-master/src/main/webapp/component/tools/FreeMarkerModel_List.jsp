    ...
    <script type="text/javascript" >
        $(function(){
            myCustomScrollbar({
                ...
                url : webPath + "/freeMarkerDownloadModel/findByPageAjax", //列表数据查询的url
                tableId : "tablefreeMarker0001", //列表数据查询的table编号
        ...
        function addConfig(){
            top.openBigForm(webPath + "/freeMarkerDownloadModel/getInputPage","新增",function(){
            ...
            <div class="search-div">
                <div class="col-xs-9 column">
                    ...
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">freeMarker配置</li>
                    </ol>
                </div>
