 ...
 */ 
baidu.flash.imageUploader = baidu.flash.imageUploader || function(optionsArgs){
 ...
 */
baidu.flash.fileUploader = baidu.flash.fileUploader || function(optionsArgs){
    var me = this,
        options = optionsArgs || {};
     ...
     * @return {Null};
     */
    me.addFileType = function(typeArgs){
        var type = typeArgs || [[]];
     ...
     * @return {Null};
     */
    me.setFileType = function(typeArgs){
        var type = typeArgs || [[]];
