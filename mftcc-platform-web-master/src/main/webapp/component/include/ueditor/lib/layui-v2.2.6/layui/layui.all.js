...
! function(e) {
	...
	o.prototype.cache = n, o.prototype.define = function(e, t) {
		...
		return t
	}, o.prototype.router = function(eArgs) {
		var t = this,
			e = eArgs || location.hash,
			n = {
				path: [],
				search: {},
				hash: (e.match(/[^#](#.*$)/) || [])[1] || ""
...
! function(e, t) {
	...
	l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
		...
		return t.move && l.css("cursor", "move"), l.on("mousedown", function(e) {
            ...
            var a,o;
			if(c.moveStart) {
				a = i.clientX - c.offset[0];
				o = i.clientY - c.offset[1];
				var	l = "fixed" === s.css("position");
...
layui.define("jquery", function(t) {
	...
	var o = ".layui-nav",
		...
		f = {
			tabClick: function(t, iArgs, s, o) {
				o = o || {};
				var r = s || a(this),
					i = iArgs || r.parent().children("li").index(r),
...
layui.define("layer", function(e) {
	...
	p.prototype.config = {
		...
		number: 0,
		multiple: !1
	}, p.prototype.render = function(eArgs) {
		var i = this,
			e = i.config;
...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
	...
	M.prototype.config = {
		...
		try {
			var nOther = n || e.data("field");
			if(c.sortKey && !a && nOther === c.sortKey.field && i === c.sortKey.sort) return;
			var p = c.layHeader.find("th .laytable-cell-" + h.index + "-" + nOther).find(w);
