		...
		<div class="container form-container">
			<div class="scroll-content">
				...
				<div class="col-md-8 col-md-offset-2 margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="MfCusClosingManageForm" theme="simple" name="operform" action="${webPath}/mfCusClosingManage/updateAjax">
							<dhcc:bootstarpTag property="formcusClosingManageDetail" mode="query"/>
						</form>
					</div>
			...
			<div class="formRowCenter">
				<!-- ajaxSave方法不适用时需另行实现。新写JS代码必须闭包。 -->
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfCusClosingManage.ajaxSave('#MfCusClosingManageForm')"></dhcc:thirdButton>
