	...
	<head >
		...
		$(function(){
			...
			myCustomScrollbar({
		    	...
		    	url:webPath+"/mfCusReportItem/getItemCalcSetListAjax",//列表数据查询的url
		...
		function insertRow(obj) {
			...
			var $divtd2 = $('<td align="left"><input type="text" name="calcItem" onclick="openDialog(this)"  value=""><span class="glyphicon glyphicon-search search-addon" onclick="openDialog(this)"></span></td>');
			...
			var $gsTyep = $('<select name="gsType" title="gsType"></select>');//<option value="1"> 科目 </option>
		...
		function openDialog(obj){
			...
			if('1'==optype){
				...
				openReportItemDialog(reportTypeId, function(data){
					$(obj).parent('td').children('input').val(data.reportItemId + '/' + data.reportName);
				})
			}
		}
...
//					
			...
			jQuery.ajax({
				url:webPath+"/mfCusReportItem/updateDeployAjax",
