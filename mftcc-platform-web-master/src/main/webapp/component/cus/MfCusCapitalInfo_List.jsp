		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/mfCusCapitalInfo/findByPageAjax",//列表数据查询的url
			    	tableId:"tablecuscapi00001",//列表数据查询的table编号
	...
	<body>
		<div>
			<div style="vertical-align: bottom;display: block;" class="tabCont">
				<strong >资产负债表（企业客户）</strong>
				<div class="search-group">
					<!--我的筛选选中后的显示块-->
					<div class="search-lable" id="pills">
				<dhcc:button value="新增" action="新增" onclick="window.parent.openBigForm('${webPath}/mfCusCapitalInfo/input')"></dhcc:button>
				<!--我的筛选按钮-->
