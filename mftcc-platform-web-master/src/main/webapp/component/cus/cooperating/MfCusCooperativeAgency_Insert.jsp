			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					...
					<div class="form-tips">说明：带*号的为必填项信息，请填写完整。</div>
						<form  method="post" id="MfCusCooperativeAgency" theme="simple" name="operform" action="${webPath}/mfCusCooperativeAgency/insertAjax">
							<dhcc:bootstarpTag property="formcuscoop00002" mode="query"/>
						</form>	
					</div>
				</div>
	   		</div>
