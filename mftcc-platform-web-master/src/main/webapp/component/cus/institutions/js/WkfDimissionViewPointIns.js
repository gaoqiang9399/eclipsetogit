;
var WkfDimissionViewPointIns = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfBusInstitutions/submitUpdateAjax?appNo="+agenciesId+"&opinionType="+opinionType,formObj,'agenciesId');
		}
	};
	//返回详情页面
