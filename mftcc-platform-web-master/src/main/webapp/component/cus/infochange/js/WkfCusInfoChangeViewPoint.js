;
var WkfCusInfoChangeViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfCusInfoChange/submitUpdateAjax?appNo="+changeId+"&opinionType="+opinionType,formObj,'cusInfoChange');
		}
	};
	//返回详情页面
