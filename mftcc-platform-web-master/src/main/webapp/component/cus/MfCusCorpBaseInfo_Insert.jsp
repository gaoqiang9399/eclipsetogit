...
// 			});
            ...
            //企业性质默认股份有限公司
            $("select[name='corpNature']").find("option[value = '9']").attr("selected",true);
			//行业分类默认为快递服务
            $("input[name=wayClassDes]").val("快递服务");
            $("input[name=wayClass]").val("G602");
            $("[name=industryClass]").val("3");
            $("input[name=wayMaxClass]").val("G");
			...
			<div class="scroll-content">
				<div class="col-md-10 col-md-offset-1 column margin_top_20">
					<div class="bootstarpTag fourColumn">
						...
						<form  method="post" id="cusCorpBaseInsert" theme="simple"
							name="operform"
							action="${webPath}/mfCusCorpBaseInfo/updateAjax">
							<dhcc:bootstarpTag property="formcuscorp00002" mode="query" />
						</form>
					</div>
				</div>
			</div>
