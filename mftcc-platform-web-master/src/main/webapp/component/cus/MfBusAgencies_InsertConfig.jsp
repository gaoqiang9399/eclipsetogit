...
<body class="bg-white">
	<div class="container form-container">
		<div class="scroll-content">
			...
			<form  method="post" theme="simple" name="operform" action="${webPath}/mfBusAgencies/insertConfigAjax"  id="insertForm">
		...
		<div id="formRowCenter" class="formRowCenter">
			<dhcc:thirdButton value="保存" action="保存" onclick="myInsertConfigAjax('#insertForm')"></dhcc:thirdButton>
...
<script type="text/javascript">
	$(function(){
		MfBusAgencies.insertConfigInit();
	});
