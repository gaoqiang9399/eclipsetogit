...
<div class="container form-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-3 column">
                        <div style="height:90px;padding-top: 50px;">
                            <button type="button" class="btn btn-primary btn-rec active"
                                    onclick="ReCallBaseInsert.recallRegist(this);">催收办理
                            </button>
                            <button type="button" class="btn btn-primary btn-rec"
                                    onclick="ReCallBaseInsert.recallAssign(this);">催收指派
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-10 col-md-offset-1 column margin_top_20">
                    <div id="registDiv">
                        ...
                        <div class="bootstarpTag">
                            <form method="post" id="registForm" theme="simple" name="edit-form"
                                  action="${webPath}/recallBase/insertForSimuAjax">
                    ...
                    <div id="assignDiv" class="hide">
                        ...
                        <div class="bootstarpTag">
                            <form method="post" id="assignForm" theme="simple" name="edit-form"
                                  action="${webPath}/recallBase/insertAjax">
    ...
    <div id="registBtn" class="formRowCenter">
        <dhcc:thirdButton value="保存" action="保存"
                          onclick="ReCallBaseInsert.doSubmit('#registForm','regist');"></dhcc:thirdButton>
    ...
    <div id="assignBtn" class="formRowCenter hide">
        <dhcc:thirdButton value="保存" action="保存"
                          onclick="ReCallBaseInsert.doSubmit('#assignForm','assign');"></dhcc:thirdButton>
        <c:if test='${query eq "detailPage"}'>
            <dhcc:thirdButton value="返回" action="返回" typeclass="cancel"
                              onclick="ReCallBaseInsert.returnChoose();"></dhcc:thirdButton>
        </c:if>
...
<script type="text/javascript">
    ...
    var cusName = '${recallBase.cusContactName}';
    var cusTel ='${recallBase.cusTel}';
