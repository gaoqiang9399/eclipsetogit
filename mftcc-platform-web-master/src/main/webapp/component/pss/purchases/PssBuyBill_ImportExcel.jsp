...
<script type="text/javascript">
	$(function() {
		...
		var uploadInstance = WebUploader.create({
			...
			// 文件接收服务端。
			server: webPath+'/pssBuyBill/uploadExcelAjax',
			//参数
		...
		uploadInstance.on('uploadSuccess', function(file, response) {
			...
			if (response === " ") {
				...
				if('error'==response.flag){
					var downloadError = '<a href=webPath+"/pssBuyBill/downloadErrorExcel?errorFileUrl=' + response.result + '" class="link">下载错误数据文件</a>'
		...
		<div class="mod-inner">
			...
			<div id="import-wrap" class="cf">
				<div id="import-step1" class="step-item" style="">
					...
					<a href=webPath+"/pssBuyBill/downloadTemplate" class="link">下载模版</a>
					<div class="step-btns">
