...
<html>
	...
	<body class="body_bg" style="overflow:hidden; height:96%;">
		<div class="bigform_content" style="padding-top:20px;" align="center">
			...
			<form method="post" theme="simple" name="operform" action="${webPath}/scence/update">
				<dhcc:formTag property="formparam0002" mode="query"/>
				<div class="formRow">
	    			<dhcc:thirdButton value="保存" action="Scence002" commit="true"></dhcc:thirdButton>
     			</div>
			</form>	
			</div>
		</div>
