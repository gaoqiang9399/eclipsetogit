;
var MfSalesOptions_Detail = function(window, $) {
	var _init = function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.flag == "success") {
                            ...
                            $("[name=colorsDic]").val(mfCarModelDetail.colorDic);
	...
	var _ifRepeat = function(){
		var flag = true;
		var modelId = $("[name='modelId']").val();
		var salesOptionsId = $("[name='salesOptionsId']").val();
