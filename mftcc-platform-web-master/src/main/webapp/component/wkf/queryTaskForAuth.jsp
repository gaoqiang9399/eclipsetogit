...
<html>
	...
	<form method="post" theme="simple" name="cms_form"
		action="${webPath}/query/listTaskForAuth">
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						<table width="100%" align="center" class="searchstyle">
							<tr>
								<td><dhcc:formTag property="formwkf0032" mode="query" /></td>
							</tr>
						</table>
						<div class="tools_372">
			...
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						...
						<dhcc:tableTag paginate="workflowTaskList" property="tablewkf0047" head="true" />
					</div>
				</div>
			</div>
		</div>
