				...
				<div class="from_bg">
					<div class="right_v">
						<table width="100%" align="center" class="searchstyle">
							<tr>
								<td><dhcc:formTag property="formwkf0020" mode="query" /></td>
							</tr>
						</table>
						<div class="tools_372">
			...
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						...
						<dhcc:tableTag paginate="workflowTaskList" property="tablewkf0034" head="true" />
					</div>
				</div>
			</div>
		</div>
