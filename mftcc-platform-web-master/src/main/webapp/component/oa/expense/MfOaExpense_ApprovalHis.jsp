...
<%-- 			<iframe src='tech/wkf/processDetail.jsp?appNo=${expenseId}'  marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%"   id = "processDetailIframe"></iframe> --%>
...
<script type="text/javascript" src="${webPath}/component/oa/expense/js/MfOaExpenseApprovalHis.js"></script>
