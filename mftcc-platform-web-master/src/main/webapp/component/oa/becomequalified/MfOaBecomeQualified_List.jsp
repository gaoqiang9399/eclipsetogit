		...
		<div class="container">
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					<div class="btn-div">
						<div class="col-md-2">
							<button type="button" class="btn btn-primary" onclick="MfOaBecomeQualified_List.applyInsert();">新增</button>
						</div>
						<div class="col-md-8 text-center">
							<span class="top-title">转正管理</span>
						</div>
					</div>
...
<script type="text/javascript" src="<%=webPath %>/component/oa/becomequalified/js/MfOaBecomeQualified_List.js"></script>
<script type="text/javascript">
	filter_dic =[{
					"optCode":"applySts",
					"optName":"申请状态",
