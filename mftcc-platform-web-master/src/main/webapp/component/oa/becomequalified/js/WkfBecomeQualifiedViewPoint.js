;
var WkfBecomeQualifiedViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaBecomeQualified/submitUpdateAjax?appNo="+becomeQualifiedId+"&opinionType="+opinionType,formObj,'becomeQualified');
		}
	};
	//返回详情页面
