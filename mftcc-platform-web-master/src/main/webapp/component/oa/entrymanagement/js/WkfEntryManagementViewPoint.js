;
var WkfEntryManagementViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaEntryManagement/submitUpdateAjax?appNo="+entryManagementId+"&opinionType="+opinionType,formObj,'entryApply');
		}
	};
	//返回详情页面
