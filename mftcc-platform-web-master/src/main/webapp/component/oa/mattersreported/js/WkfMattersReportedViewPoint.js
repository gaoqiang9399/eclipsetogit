;
var WkfMattersReportedViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaMattersReported/submitUpdateAjax?appNo="+mattersReportedId+"&opinionType="+opinionType,formObj,'mattersReportedId');
		}
	};
	//返回详情页面
