		...
		<script type="text/javascript" >
			$(function() {
				myCustomScrollbar({
					...
					url : webPath+"/archiveInfoMain/findByPageAjax",//列表数据查询的url
					tableId : "tabledl_archive_main01",//列表数据查询的table编号
				...
				<div class="btn-div">
					<div class="col-md-2">
	  				...
	  				<div class="col-md-8 text-center">
	  					<span class="top-title">归档合同</span>
	  				</div>
	  				<div class="col-md-2">
	  				</div>
				</div>
