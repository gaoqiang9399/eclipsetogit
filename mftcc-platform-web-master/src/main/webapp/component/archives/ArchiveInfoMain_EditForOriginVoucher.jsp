...
<script type="text/javascript">
	...
	var dataDocParm = {
		...
		docType:"22",
		docTypeName: "原始凭证",
		docSplitNoArr : "[{'docSplitNo':20042315503804210}]",
		docSplitName: "原始凭证上传",
		query:''
	};
	$(function(){
...
<div class="container form-container">
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="originVoucher" theme="simple" name="operform" action="${webPath}/archiveInfoMain/insertOriginVoucherAjax">
					<dhcc:bootstarpTag property="formarchiveoriginvoucher" mode="query"/>
				</form>
	...
	<div class="formRowCenter">
		...
		<dhcc:thirdButton value="保存" action="保存" onclick="ajaxSave('#originVoucher')"></dhcc:thirdButton>
