...
<script type="text/javascript">
	...
	function save(obj){
		...
		if (flag) {
			...
			$.ajax({
				...
				url : "${webPath}/archiveInfoMain/updateArchiveInfo",
				dataType : "json",
	...
	function addPactExtend(obj){
		if(appId == ""  && creditAppId == ""){
			alert("请先选择要归档的项目！", 0);
			return false;
		}
		top.openBigForm(webPath+"/archiveInfoMain/addPactExtend?archiveMainNo="+archiveMainNo+"&appId="+appId, "添加非系统生成相关合同", function(){
	...
	<div class="scroll-content" id="quanxuan">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="cwBillForm" theme="simple" name="operform" action="${webPath}/archiveInfoMain/updateArchiveInfo">
					<dhcc:bootstarpTag property="formarchivemainupdate" mode="query"/>
				</form>
			</div>
