...
<script type="text/javascript" >
	$(function() {
		myCustomScrollbar({
			...
			url : webPath+"/archiveInfoMain/findApplyByPageAjax?type=1",//列表数据查询的url
			tableId : "tablearchivemainapply",//列表数据查询的table编号
	...
	function inputArchive(){
		top.openBigForm(webPath+"/archiveInfoMain/input", "新增", function () {
			window.location.reload();
		});
	}

	//归档待确认的记录可以修改
	function editForArchiveMain(obj,lk){
				...
				<div class="btn-div">
					<div class="col-md-2">
	  				...
	  				<div class="col-md-8 text-center">
	  					<span class="top-title">资料合同归档</span>
	  				</div>
	  				<div class="col-md-2">
	  				</div>
				</div>
