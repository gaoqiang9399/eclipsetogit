/**
 * 借阅/借出的js
 * @type {{init: _init, selectArchiveAppNameDialog: _selectArchiveAppNameDialog, selectCusDialog: _selectCusDialog, selectArchiveDocDialog: _selectArchiveDocDialog}}
 */
var ArchiveInfoBorrow_Insert=function(window,$){
	var _init=function(){
    ...
    var _selectArchiveDocDialog=function(){
        ...
        if(archivePactStatus == "01"){
            ...
            selectArchiveDocDialog(_selectArchiveDocBack,archivePactStatus,creditAppId,docType);
        }else{
            ...
            selectArchiveDocDialog(_selectArchiveDocBack,archivePactStatus,appId,docType);
        }
	...
	return{
        ...
        selectArchiveCreditBack:_selectArchiveCreditBack,
...
function selectArchiveAppNameDialog(callback,cusNo,archiveStatus,archivePactStatus){
    var url = "/archiveInfoMain/getArchiveAppNameListForBorrow?cusNo="+cusNo+"&archiveStatus="+archiveStatus+"&archivePactStatus="+archivePactStatus;
    dialog({
...
function selectArchiveDocDialog(callback,archivePactStatus,relationId,docType){
    var url = "/archiveInfoDetail/getArchiveDocList?relationId="+relationId+"&docType="+docType+"&archivePactStatus="+archivePactStatus;
    dialog({
        id:'archiveDocDialog',
        title:"选择资料",
        url:webPath+url,
