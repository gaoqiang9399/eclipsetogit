    ...
    function save(obj){
        ...
        if (flag) {
            ...
            $.ajax({
                ...
                url : "${webPath}/archiveConfig/updateAjax",
                dataType : "json",
    ...
    <div class="scroll-content">
        <div class="col-md-10 col-md-offset-1 column margin_top_20">
            <div class="bootstarpTag">
                ...
                <form method="post" id="insertForm" theme="simple" name="operform" action="${webPath}/archiveConfig/updateAjax">
                    <dhcc:bootstarpTag property="formarchiveconfigedit" mode="query"/>
                </form>
            </div>
        </div>
    </div>
