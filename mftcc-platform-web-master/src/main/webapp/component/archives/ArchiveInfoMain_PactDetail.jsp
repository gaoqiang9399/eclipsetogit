	...
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="formarchivepaperinsert" theme="simple" name="operform" action="${webPath}/archiveInfoMain/insertPactAjax">
					<dhcc:bootstarpTag property="formarchiveextendpactedit" mode="query"/>
				</form>
