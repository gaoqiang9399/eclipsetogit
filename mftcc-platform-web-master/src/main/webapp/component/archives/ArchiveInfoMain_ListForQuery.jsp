...
<script type="text/javascript" >
	...
	$(function(){
		myCustomScrollbar({
			...
			url : webPath + "/archiveInfoMain/findQueryByPage", //列表数据查询的url
			tableId : "tablearchivemainquery", //列表数据查询的table编号
	...
	//查看借阅借出记录
	function getBorrowPageForQuery(obj,url){
		if(url.substr(0,1)=="/"){
			url =webPath + url;
		}else{
			url =webPath + "/" + url;
		}
		top.openBigForm(url, "借阅借出记录", function () {
			window.location.reload();
		});
	}
</script>
		...
		<div class="col-md-12 column">
			<div class="btn-div">
				...
				<div class="col-md-8 text-center">
					<span class="top-title">档案查询</span>
				</div>
				<div class="col-md-2">
				</div>
			</div>
