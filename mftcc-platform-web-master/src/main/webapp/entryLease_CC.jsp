...
//移植的代码 待确定结构后精简
	...
	String bzLogo=ymlConfig.getUpload().get("wareLogoFilePath");
	String bzLogin=ymlConfig.getUpload().get("wareLoginFilePath");
%>
	...
	<div style="margin: 35% auto;text-align: center;">
		<div class="logo-div" >
			<div class="logo-img">
				...
				<br>
				<span style="margin-top:25px;font-size: 25px;color:#fff">仓储业务平台</span>
			</div>
		</div>
		<div class="loginFormDiv" style="margin: 30px 15px;padding:35px; background-color:rgba(80, 67, 67, 0.66);height: 10px;">
			<div class="login-div">
				<form action="${webPath}/sysWareLogin/userLogin" name="LoginForm" method="post">
					<div class="form-group IdInputDiv" style="position: relative;margin-bottom: 0px;">
						<input type="text" class="form-control" style="background:#CED6D9;border: none;color:#212121;,height: 40px;padding-left: 34px;" placeholder="账户" id="IdInput" name="opNo" autocomplete="off" value="${opNo}">
						<span class="glyphicon glyphicon-user form-control-feedback" style="left:0px;top:4px;font-size:16px;color:#dd9752;"></span>
					...
					<div class="form-group PwdInputDiv" style="position: relative;margin-bottom: 0px;">
						<input type="password" class="form-control"  style="background:#CED6D9;border: none;color:#212121;,height: 40px;padding-left: 34px;"  placeholder="密码" id="PwdInput" name="passwordhash" autocomplete="off" value="${passwordhash}">
						<span class="glyphicon glyphicon-lock form-control-feedback" style="left:0px;top:4px;font-size:16px;color:#dd9752 "></span>
					...
					<div class="form-group">
						<input type="button" id="logonBtn" class="form-control" value="登录" style="background:#dd9752;border: none;height: 40px;font-size: 16px;letter-spacing: 5px;color:#555" onclick="chklogon();">
					</div>
					<!--手机扫码登陆备用-->
					<%--
