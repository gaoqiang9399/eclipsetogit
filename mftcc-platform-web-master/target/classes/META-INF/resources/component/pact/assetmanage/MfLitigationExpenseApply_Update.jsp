	...
	<div class="scroll-content">
		...
		<div class="col-md-10 col-md-offset-1 margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="MfCusWhitenameForm" theme="simple" name="operform" action="${webPath}/mfLitigationExpenseApply/insertApplyAjax?flag=1">
					<dhcc:bootstarpTag property="formlitigationexpenseapply0001" mode="query"/>
				</form>
			</div>
		</div>
...
<script type="text/javascript" >
    ...
    var applyStatus='${mfLitigationExpenseApply.applyStatus}';
    var isf='1';
    //金额格式化
