	...
	<head>
		...
		<script type="text/javascript">
			...
			function doSubmit(obj){
				...
				if(flag){
					commitProcess(webPath+"/mfLitigationExpenseApply/updateForSubmit?litigationId="+litigationId+"&appNo="+taskId+"&opinionType="+opinionType,obj,'SP');
				}
			}
		</script>
	</head>
				...
				<div class="col-md-10 col-md-offset-1 margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="MfCusWhitenameForm" theme="simple" name="operform" action="">
							<dhcc:bootstarpTag property="formlitigationexpenseapplyapproval" mode="query"/>
						</form>
					</div>
				</div>
	   		</div>
