...
<html>
		...
		<script type="text/javascript" >
			$(function(){
			      myCustomScrollbar({
			    	...
			    	url:webPath+"/mfAssetManage/getOverdueCus",
			    	tableId:"tableoverduecusts",//列表数据查询的table编号
		...
		<div class="row clearfix bg-white tabCont">
			<div class="col-md-12 column">
				...
				<div class="search-div" id="search-div">
						<!-- begin -->
							<jsp:include page="/component/include/mySearch.jsp?blockType=4&placeholder=客户名称/客户号"/>
						<!-- end -->
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
			function choseCredit(parm){
				...
				$.ajax({
					url:webPath+"/mfAssetManage/getInfo",
					dataType:"json",
					data:{cusNo:cusNo},
					type:"POST",
