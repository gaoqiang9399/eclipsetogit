...
%>
<script type="text/javascript" src="${webPath}/component/pact/receaccount/pubview/js/pub_batch_finc_main_head_info.js?v=${cssJsVersion}"></script>
<script type="text/javascript">
    pub_batch_finc_main_head_info.fincMainId = '<%=fincMainId%>';
    pub_batch_finc_main_head_info.appId = '<%=appId%>';
    pub_batch_finc_main_head_info.pactId = '<%=pactId%>';
    $(function(){
        pub_batch_finc_main_head_info.init();
    });
...
<div class="row clearfix head-info">
	...
	<div class="col-xs-3 column text-center head-img ">
		...
		<div class="btn btn-link" onclick="pub_batch_finc_main_head_info.getKindInfo();"></div>
	</div>
	<!--概要信息 -->
