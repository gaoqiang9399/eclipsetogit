		...
		<script type="text/javascript">
			...
			function doSubmit(obj){
				...
				if(flag){
					...
					commitProcess(webPath+"/mfBusFincAppMain/submitUpdateAjax?appId=${appId}&fincMainId="+fincMainId+"&appNo="+fincMainId+"&opinionType="+opinionType,obj,'applySP');
				}
...
<body  class="overflowHidden bg-white multi-select-list">
	<div class="container form-container">
		<div id="infoDiv" style="display:block;height:100%;">
				<iframe src="${webPath}/mfBusFincAppMain/getSummary?appId=${appId}&pactId=${pactId}&fincMainId=${fincMainId}&busEntrance=rece_finc_approve&operable=" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
		</div>
		<div id="approvalDiv" class="scroll-content" style="display:none;">
			<div class="col-md-10 col-md-offset-1 column margin_top_20" >
				<div class="bootstarpTag fourColumn">
					...
					<form id="edit-form">
						<dhcc:bootstarpTag property="formrecefincapprovalbase" mode="query" />
					</form>	
				</div>
