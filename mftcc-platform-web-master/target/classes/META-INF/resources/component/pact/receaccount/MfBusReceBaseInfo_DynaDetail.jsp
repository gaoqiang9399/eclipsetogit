...
<head >
	...
	<script type="text/javascript" src="${webPath}/component/pact/receaccount/js/MfBusReceBaseInfo_DynaDetail.js?v=${cssJsVersion}"></script>
	...
	<script type="text/javascript">
		...
		var query ='${query}';
        var docParm = "query="+query+"&cusNo="+cusNo+"&relNo="+appId+"&appId="+appId;//查询文档信息的url的参数
		$(function(){
            MfBusReceBaseInfo_DynaDetail.init();
		});
	</script>
</head>
