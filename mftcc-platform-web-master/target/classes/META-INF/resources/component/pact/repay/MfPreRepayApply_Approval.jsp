...
<html>
  <head>
		...
		<script type="text/javascript">
			...
			var appId = '${mfPreRepayApply.appId}';
			var pactId = '${mfPreRepayApply.pactId}';
			...
			function doSubmit(obj){
				...
				if(flag){
					commitProcess("${webPath}/mfPreRepayApply/submitUpdateAjax?opinionType="+opinionType+"&preRepayAppId="+preRepayAppId+"&appNo="+appId,obj,'applySP');
				}
			}
		</script>
</head>
