...
<script type="text/javascript" src="${webPath}/component/pact/repay/js/mfLiXiRepaymentJsp.js"></script>
<script type="text/javascript" src="${webPath}/component/pact/repay/js/liXiRepayMent.js"></script>
	...
	<div class="bigform_content">
		<div class="content_table" style="background: #F9F9F9;">
			...
			<div class="payinf clearfix">
				...
				<div class="realpay">
					<form method="post" theme="simple" name="operform" action="${webPath}/mfLiXiRepayment/liXiRepaymentAjax">
						<table id="formrepay0003" class="from_w" title="formrepay0003" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
							   <tr>
									...
									<td class="tdvalue" align="left">
										<div class="realvalue">
											<input title="还款日期" name="systemDateLong" id="systemDateLong" value="${mfRepaymentBean.systemDateLong }" datatype="6" mustinput="1" maxlength="10" readonly="readonly"
												onfocus="fPopUpCalendarDlg({min: '${mfRepaymentBean.shangCiHuanKuanRiQi}',max: new Date().toLocaleDateString()});" class="datelogo BOTTOM_LINE" type="text">
											<i class="i i-rili pointer" style="color: #32b5cb; margin-left: -20px;" onclick="$('#systemDateLong').focus();"></i>
										</div>
									</td>
								</tr>
								<tr>
									<td class="tdlable" align="right">应收息费</td>
									<td class="tdvalue" align="left">
								...
								<tr>
									<td class="tdlable" align="right">
										<font color="#FF0000">*</font>实收息费
									</td>
									<td class="tdvalue" align="left">
										<div class="realvalue">
											<input title="实收息费" name="shiShouZongJi" id="shiShouZongJi" placeholder="本次应收总额 ${mfRepaymentBean.yingShouZongJiAllFormat}元" datatype="12"
												onchange="funcCheckRepay(this); resetTimes(); liXiRepayTotalChg()" mustinput="0" type="text">
								...
								<td class="tdvalue" align="left">
									<div class="repay-btn">
										...
										<dhcc:pmsTag pmsId="loan-return-money">
											<dhcc:thirdButton value="还款" action="还款" typeclass="nor-repay" onclick="ajaxLiXiRepayment(this.form,myclose)"></dhcc:thirdButton>
										</dhcc:pmsTag>
							...
							<div class="content margin_left_15 collapse in">
								<table id="yingShou_List_table_001" width="100%" border="0" cellspacing="1" class="ls_list" title="">
									<tr>
										...
										<th scope="col" align="center" sorttype="0" style="display: none">本金</th>
											...
											<c:when test="true">
												<tr id="tr_${loanReceivableBean.termNum}_termNum" termNum="${loanReceivableBean.termNum}">
													...
													<td align="center" title="${loanReceivableBean.yingShouYuQiLiXi}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouYuQiLiXi_Text" datatype="12" onchange="funcCheckRepay(this); resetTimes(); modifyLiXiAmtFun('${loanReceivableBean.termNum}','YuQiLiXi');"
													...
													<td align="center" title="${loanReceivableBean.yingShouFuLiLiXi}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouFuLiLiXi_Text" datatype="12" onchange="funcCheckRepay(this); resetTimes(); modifyLiXiAmtFun('${loanReceivableBean.termNum}','FuLiLiXi');"
													...
													<td align="center" title="${loanReceivableBean.yingShouFuLiLiXiPart}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouFuLiLiXiPart_Text" datatype="12" onchange="funcCheckRepay(this); resetTimes(); modifyLiXiAmtFun('${loanReceivableBean.termNum}','FuLiLiXiPart');"
													...
													<td align="center" title="${loanReceivableBean.yingShouYuQiWeiYueJin}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouYuQiWeiYueJin_Text" datatype="12"
															onchange="funcCheckRepay(this); resetTimes(); modifyLiXiAmtFun('${loanReceivableBean.termNum}','YuQiWeiYueJin');" value="${loanReceivableBean.yingShouYuQiWeiYueJin}"
													...
													<td align="center" title="${loanReceivableBean.yingShouLiXi}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouLiXi_Text" datatype="12" onchange="funcCheckRepay(this); resetTimes();modifyLiXiAmtFun('${loanReceivableBean.termNum}','LiXi');"
													...
													<td align="center" title="${loanReceivableBean.yingShouFeiYong}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouFeiYong_Text" datatype="12"
															onchange="funcCheckRepay(this); resetTimes();modifyLiXiAmtFun('${loanReceivableBean.termNum}','FeiYong');" value="${loanReceivableBean.yingShouFeiYong}" type="text"
													...
													<td align="center" title="${loanReceivableBean.yingShouFeiYongFaXi}">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouFeiYongFaXi_Text" datatype="12"
															onchange="funcCheckRepay(this); resetTimes();modifyLiXiAmtFun('${loanReceivableBean.termNum}','FeiYongFaXi');" value="${loanReceivableBean.yingShouFeiYongFaXi}" type="text"
													...
													<td align="center" style=" display: none">
														<input id="input_text_${loanReceivableBean.termNum}_yingShouBenJin_Text" datatype="12"
															onchange="funcCheckRepay(this); resetTimes();modifyLiXiAmtFun('${loanReceivableBean.termNum}','BenJin');" value="${loanReceivableBean.yingShouBenJin}" type="text"
													...
													<td align="center">
														<span class="tab_span">
															<input id="${loanReceivableBean.termNum}_youHuiJine_input" datatype="12" name="name_youHuiJine_input" placeholder="${loanReceivableBean.maxYouhuiAmt}" disabled
																maxYouHui="${loanReceivableBean.maxYouhuiAmt}" onchange="funcCheckRepay(this); resetTimes();modifyFavorableLiXiAmt('${loanReceivableBean.termNum}','')" value="0.00" fromVal="0.00"
