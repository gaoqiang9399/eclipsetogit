...
<script type="text/javascript" src="${webPath}/component/pact/repay/js/mfRepaymentJspForAccount.js"></script>
...
<div class="container form-container">
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag fourColumn">
				...
				<form method="post" id="buyerRepayment" theme="simple" name="operform" action="${webPath}/mfRepayment/repaymentAjaxForAccount">
					<dhcc:bootstarpTag property="formaccountRepaymentBase" mode="query"/>
				</form>
			</div>
			<!-- 还款资料 -->
	...
	<div class="formRowCenter">
		...
		<dhcc:thirdButton value="保存" action="保存" onclick="MfRepaymentJspForAccount.ajaxInsert('#buyerRepayment')"></dhcc:thirdButton>
