		...
		<script type="text/javascript" >
			...
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/mfBusPact/collateralAmtWarnListAjax?pactWarning="+pactWarning+"&repayWarning="+repayWarning+"&warningType="+outFlag,//列表数据查询的url
			    	tableId:"tablecollateralAmtWarnList",//列表数据查询的table编号
	...
	<body class="overflowHidden">
		...
		<div class="row clearfix bg-white tabCont">
			<div class="col-md-12 column">
				<div class="btn-div top-title">货值预警</div>
