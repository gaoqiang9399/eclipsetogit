...
<script type="text/javascript">
	...
	var cusNo;
    var addFormId = "insertForExamineTaskForm";
	$(function() {
	...
	<div class="container form-container" id="normal">
		<div class="scroll-content">
			<div class="col-md-10 col-md-offset-1 column margin_top_20">
				<div class="bootstarpTag fourColumn">
					...
					<form id="insertForExamineTaskForm" method="post" theme="simple" name="operform" action="${webPath}/mfBusFincApp/insertForExamineTaskAjax">
		...
		<div class="formRowCenter">
			<dhcc:thirdButton value="提交" action="提交"
				onclick="insertForExamineTaskForm('#insertForExamineTaskForm','1');"></dhcc:thirdButton>
