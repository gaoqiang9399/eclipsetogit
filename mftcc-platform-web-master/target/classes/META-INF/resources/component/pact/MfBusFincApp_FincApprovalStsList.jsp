...
<script type="text/javascript">
	$(function() {
		myCustomScrollbar({
			...
			url : webPath+"/mfBusFincApp/findFincApprovalStsListByPageAjax",//列表数据查询的url
			tableId : "tablefincapprovalstslist",//列表数据查询的table编号
	...
	<div class="container">
		<div class="row clearfix bg-white tabCont">
			<div class="col-md-12 column">
				<div class="btn-div top-title">放款审批状态查询</div>
