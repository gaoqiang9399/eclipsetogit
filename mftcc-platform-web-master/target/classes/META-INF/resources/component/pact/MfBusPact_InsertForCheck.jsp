    ...
    function save(obj){
        ...
        if (flag) {
            ...
            $.ajax({
                ...
                url : "${webPath}/mfBusPact/updateForCheck",
                dataType : "json",
    ...
    <div class="scroll-content">
        <div class="col-md-10 col-md-offset-1 column margin_top_20">
            <div class="bootstarpTag">
                ...
                <form method="post" id="insertForm" theme="simple" name="operform" action="${webPath}/mfBusPact/updateForCheck">
                    <dhcc:bootstarpTag property="formpactcheck" mode="query"/>
                </form>
            </div>
        </div>
    </div>
