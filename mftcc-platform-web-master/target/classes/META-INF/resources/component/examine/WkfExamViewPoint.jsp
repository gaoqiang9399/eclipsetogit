...
<body  class="overflowHidden bg-white">
	<div class="container form-container">
		<div id="infoDiv" style="display:block;height:100%;">
			<iframe src="${webPath}/mfBusPact/getById?pactId=${dataMap.pactId}&examHisId=${examHisId}&operable=" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
		</div>
			...
			<div class="col-md-10 col-md-offset-1 column margin_top_20" >
				<div class="bootstarpTag fourColumn">
					...
					<form id="examApprovForm">
						<dhcc:bootstarpTag property="formexamapprov001" mode="query" />
					</form>
				</div>
			</div>
			<!-- 检查模板 -->
