...
<script type="text/javascript" src='${webPath}/component/examine/js/ExamineApply4Risk.js'> </script> 
<script type="text/javascript" src='${webPath}/component/examine/js/ExamineApplySave4Risk.js'> </script> 
...
<script type="text/javascript">
	...
	$(function(){
		$("select[name=templateId]").val("1005");
		ExamineApply4Risk.init();
...
<body class="overflowHidden bg-white">
	<div class="eval-content" style="display: none;">
		<div class="showprogress">
			<!--进度-->
			<ul>
				<li class="selected" name="chosefin" style="display: none"><span class="span_btn">
						<span class="lable">模型匹配<i class="i i-jiantou2"></i></span>
				</span></li>
				<li name="dx" style="display: none"><span class="span_btn"> <span
						class="lable">检查卡<i class="i i-jiantou2"></i></span>
				</span></li>
				<li name="evalapp"><span class="span_btn"> <span
						class="lable">风险登记<i class="i i-jiantou2"></i></span>
				</span></li>
			</ul>
		</div>
					...
					<div name="chosefin" class="li_content_type container form-container">
						<div class="scroll-content" id="chosefin">
							<div class="col-md-10 col-md-offset-1 column margin_top_20">
								<div class="bootstarpTag fourColumn">
									...
									<form method="post" id="ecamHisInsertForm" theme="simple"
										name="operform" action="${webPath}/mfExamineHis/insertAjax">
										<div id="choseFinDiv">
							...
							<div class="formRowCenter" id ="chosefinButton" style="bottom:40px\9;">
								<dhcc:thirdButton value="保存" action="保存" onclick="ExamineApplySave4Risk.examApplySaveAjax('#ecamHisInsertForm')"></dhcc:thirdButton>
							...
							<c:if test="${query!='query'}">
								<div class="formRowCenter" id="addEval" style="bottom:40px\9;">
									<dhcc:thirdButton value="保存" action="保存"
										onclick="ExamineApplySave4Risk.examCardSave()"></dhcc:thirdButton>
								</div>
							</c:if>
							 <c:if test="${query!='query'}">
								<div class="formRowCenter" id="editEval" style="display: none;bottom:40px\9;">
									<dhcc:thirdButton value="编辑" action="编辑"
										onclick="ExamineApply4Risk.editEval()"></dhcc:thirdButton>
								</div>
							</c:if>
						</div>
					</div>
					...
					<div  name="evalapp" class="li_content_type container form-container">
						...
						<c:if test="${query!='query'}">
							<div class="formRowCenter" id ="evalappButton" style="display: none;bottom:40px\9;">
								<dhcc:thirdButton value="提交" action="提交" onclick="ExamineApplySave4Risk.examApplySubmit('#evalMsg')"></dhcc:thirdButton>
							</div>
						</c:if>
						</div>
					</div>
