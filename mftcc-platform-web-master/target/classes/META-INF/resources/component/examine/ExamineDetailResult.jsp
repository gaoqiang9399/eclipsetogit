...
<head >
		...
		<script type="text/javascript" src="${webPath}/component/examine/js/ExamineDetailResult.js"></script>
			...
			<div class='cell' cellid='cell_1' data-handle=".handle">
				<div id = "detailInfo-div" class="scroll_xy">
					...
					<%-- 	<s:iterator value="examCardListDataList" var="examCard">
							<!-- 定性 -->
							<div id="dx<s:property value="examineCardId" />" name = "dx<s:property value="examineCardId" />" class="li_content_type">
								<div class='cover'>
									<div class='handle'>
										<span>${examineCardName}</span>
									</div>
								</div>
