		...
		<div class="row clearfix">
			<div class="col-xs-12 column">
				<div style="text-align: center; margin-top: 5px;">
					<button id="sysUserTelConfirm" type="button"
...
<script type="text/javascript" src="${webPath}/component/rec/js/sysUserRec.js"></script>
<script type="text/javascript" >
	...
	$(document).ready(function() {
		SysUserRec.init(zNodes);
		SysUserRec.bindTelConfirm();
	});
