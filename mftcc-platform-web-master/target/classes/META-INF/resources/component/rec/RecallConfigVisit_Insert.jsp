...
// 			});
		...
		function insertRecallConfigVisit(obj) {
		...
		function ajaxDeleteThis(){
			var id = $("input[name=visitNo]").val();	
			var url =webPath+"/recallConfigVisit/deleteAjax?visitNo="+id;
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="recallConfigVisitInsert" theme="simple" name="operform" action="${webPath}/recallConfigVisit/updateAjax">
							<dhcc:bootstarpTag property="formdlrecallconfigvisit0003" mode="query"/>
						</form>
					</div>
				</div>
	   		</div>
			<div class="formRowCenter">
	   			<dhcc:thirdButton value="修改" action="修改" onclick="insertRecallConfigVisit('#recallConfigVisitInsert');"></dhcc:thirdButton>
	   			<!--<dhcc:thirdButton value="删除" action="删除" onclick="ajaxDeleteThis('#recallConfigVisitInsert');"></dhcc:thirdButton>-->
