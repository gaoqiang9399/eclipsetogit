...
// 			});
		...
		function insertRecallConfigLaw(obj) {
		...
		function ajaxDeleteThis(){
			var id = $("input[name=lawNo]").val();	
			var url =webPath+"/recallConfigLaw/deleteAjax?lawNo="+id;
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="recallConfigLawInsert" theme="simple" name="operform" action="${webPath}/recallConfigLaw/updateAjax">
							<dhcc:bootstarpTag property="formdlrecallconfiglaw0003" mode="query"/>
						</form>
					</div>
				</div>
	   		</div>
			<div class="formRowCenter">
	   			<dhcc:thirdButton value="修改" action="修改" onclick="insertRecallConfigLaw('#recallConfigLawInsert');"></dhcc:thirdButton>
	   			<!--<dhcc:thirdButton value="删除" action="删除" onclick="ajaxDeleteThis('#recallConfigLawInsert');"></dhcc:thirdButton>-->
