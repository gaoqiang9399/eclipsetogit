...
// 			});
		...
		function insertRecallConfigOut(obj) {
		...
		function ajaxDeleteThis(){
			var id = $("input[name=outNo]").val();	
			var url =webPath+"/recallConfigOut/deleteAjax?outNo="+id;
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="recallConfigOutInsert" theme="simple" name="operform" action="${webPath}/recallConfigOut/updateAjax">
							<dhcc:bootstarpTag property="formdlrecallconfigout0003" mode="query"/>
						</form>
					</div>
				</div>
	   		</div>
			<div class="formRowCenter">
	   			<dhcc:thirdButton value="修改" action="修改" onclick="insertRecallConfigOut('#recallConfigOutInsert');"></dhcc:thirdButton>
	   			<!--<dhcc:thirdButton value="删除" action="删除" onclick="ajaxDeleteThis('#recallConfigOutInsert');"></dhcc:thirdButton>-->
