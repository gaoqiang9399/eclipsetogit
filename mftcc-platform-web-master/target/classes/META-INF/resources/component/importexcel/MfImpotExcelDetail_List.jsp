	...
	<head>
		...
		<script type="text/javascript" >
			$(function(){
				...
				url : "${webPath}/mfImpotExcelDetail/findByPageAjax", //列表数据查询的url
                data:{
                    hisId:'${hisId}',
                    readSts:'${readSts}',
                    importTable:'${importTable}'
                },
				tableId : "tableimportexcelexcellist", //列表数据查询的table编号
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="search-div">
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=关键信息"/>
					</div>
				</div>
			</div>
