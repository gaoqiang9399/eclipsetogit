...
<html>
		...
		<script type="text/javascript" >
			...
			$(function(){
			 ...
			 function getPlanList(){
					...
					url : webPath+"/mfCusRecommend/findByPageAjax", //列表数据查询的url
					tableId : "tablemobileinterfacerecommend0001", //列表数据查询的table编号
					tableType : "thirdTableTag", //table所需解析标签的种类
					pageSize:30, //加载默认行数(不填为系统默认行数)
					//,topHeight : 50 //顶部区域的高度，用于计算列表区域高度。
					data:{"rdCusTel":rdCusTel,"redDate":redDate,"endDate":endDate}
				    });
			  };
		</script>
	</head>
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="btn-div">
						...
						class="datelogo BOTTOM_LINE" type="text">
						&nbsp;&nbsp;
						共有：<span id="perCounts">--人</span>&nbsp;&nbsp;
						借款人数：<span id="loanCounts">--人</span>&nbsp;&nbsp;
						成功借款：<span id="loanAmt">--万</span>&nbsp;&nbsp;
						应付佣金：<input type="text" name="brokerage" id="brokerage" onkeyup="value=value.replace(/[^\d.]/g,'')"/>&nbsp;&nbsp;
						已打款金额：<span id="remittance">--万</span>&nbsp;&nbsp;
	...
	<script type="text/javascript" >
		...
		function getLoanAmt(){
			...
			$.ajax({
				url:webPath+'/mfCusRecommend/getperCountAndLoanAmtAjax',
				data:{"rdCusTel":rdCusTel,"redDate":redDate,"endDate":endDate},
				type:"POST",
				dataType:"json",
				beforeSend:function(){  
				...
				success:function(data){
					if(data.flag=="success"){
						 $("#perCounts").html(data.perCounts+"人");
						  $("#loanCounts").html(data.loanCounts+"人");
	...
	function remittanceMoney(){
	   ...
	   if(""==brokerage){
		...
		$.ajax({
			...
			data:{"rdCusTel":rdCusTel,"brokerage":brokerage,"redDate":redDate,"endDate":endDate},
			type:"POST",
			dataType:"json",
			beforeSend:function(){  
			},
