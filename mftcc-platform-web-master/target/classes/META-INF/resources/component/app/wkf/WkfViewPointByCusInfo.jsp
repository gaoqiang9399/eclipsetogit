...
<body  class="overflowHidden bg-white">
	<div class="container form-container">
		<div id="infoDiv" style="display:block;height:100%;">
			<iframe src="${webPath}/mfCusCustomer/getById?cusNo=<s:property value="mfBusApply.cusNo"/>&appId=<s:property value="mfBusApply.appId"/>&busEntrance=4&operable=" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" id="iframepage" name="iframepage"></iframe>
		</div>
