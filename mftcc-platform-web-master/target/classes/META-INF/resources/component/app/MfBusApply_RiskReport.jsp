	...
	<div class="container block-left padding_right_10">
			...
			<div class="row clearfix head-info ">
				...
				<div class="col-md-6" style="padding:0px 80px;">
					...
					<div class="row clearfix margin_top_5">
						...
						<span class="content-span"><i class="i i-tongji1"></i>${mfBusApply.fincRateStr}</span><span class="unit-span">${rateUnit}</span>
					</div>
				</div>
				</div>
				<div class="row clearfix">
					<div class="search-div">
						...
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=名称/查询时间"/>
					</div>
				</div>
			</div>
			<div class="row clearfix">
		...
		<div class="formRowCenter">
			<c:if  test="${query!='query'}">
				<dhcc:thirdButton value="提交" action="提交" typeclass="insertAjax" onclick="MfBusApply_RiskReport.doCommitAjax();"></dhcc:thirdButton>
			</c:if>
			<dhcc:thirdButton value="关闭" action="关闭" typeclass="cancel" onclick="myclose();"></dhcc:thirdButton>
		</div>
	</div>
</body>
 <script type="text/javascript" src="${webPath}/component/app/js/MfBusApply_RiskReport.js"></script>
