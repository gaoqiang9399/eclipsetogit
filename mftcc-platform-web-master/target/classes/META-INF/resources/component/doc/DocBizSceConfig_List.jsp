		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/docBizSceConfig/findByPageAjax",//列表数据查询的url
			    	tableId:"tabledoc0001",//列表数据查询的table编号
	...
	<body>
		<div>
			<div style="vertical-align: bottom;display: block;" class="tabCont">
				<strong >文档配置详情</strong>
				<div class="search-group">
				<!--我的筛选选中后的显示块-->
				<div class="search-lable" id="pills">
					<dhcc:thirdButton value="新增" action="新增" onclick="${webPath}/docBizSceConfig/input"></dhcc:thirdButton>
				<!--我的筛选按钮-->
