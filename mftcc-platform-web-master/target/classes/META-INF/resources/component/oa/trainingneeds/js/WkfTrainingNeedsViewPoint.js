;
var WkfTrainingNeedsViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaTrainingNeeds/submitUpdateAjax?appNo="+trainingNeedsId+"&opinionType="+opinionType,formObj,'trainingNeeds');
		}
	};
	//返回详情页面
