...
<script type="text/javascript">
		...
		var applySts = '${mfOaDimission.applySts}';
</script>
</head>
	...
	<c:choose>
		...
		<div class="col-xs-10 col-xs-offset-1" style="margin-top:20px;">
			<div class="arch_sort" style="border: 0px;">
				<div class="dynamic-block" title="离职申请" name="MfOaDimissionAction" data-sort="14" data-tablename="mf_oa_dimission">
					<div class="list-table">
						<div class="title">
							<span class="formName"><i class="i i-xing blockDian"></i>离职申请</span>
						...
						<div disable="true" class="content collapse in" id="MfOaDimissionAction" style="margin-top: 10px;">
							<form method="post" id="MfOaDimissionActionForm" theme="simple" name="operform" action="${webPath}/mfOaDimission/insertAjax">
				...
				<div id="dimissionApproveHis" class="row clearfix" style="display: none;">
					<div class="col-xs-12 column info-block">
						<div id="spInfo-block" class="approval-hist">
							<div class="list-table">
							   <div class="title">
									 <span><i class="i i-xing blockDian"></i>离职申请审批历史</span>
...
<script type="text/javascript">
		...
		function ajaxSave(){
			$.ajax({
				url : webPath+"/mfOaDimission/submitProcessAjax",
				data : {
