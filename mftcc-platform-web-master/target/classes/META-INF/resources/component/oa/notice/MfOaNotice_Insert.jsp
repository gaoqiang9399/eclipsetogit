...
<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="OaNoticeInsert" theme="simple" name="operform" action="${webPath}/mfOaNotice/insertAjax">
							<dhcc:bootstarpTag property="formoanotice0002" mode="query" />
			...
			<div class="formRowCenter">
				<dhcc:thirdButton value="发布" action="发布" typeclass ="insertAjax"></dhcc:thirdButton>
...
<script type="text/javascript" src="${webPath}/component/oa/notice/js/MfOaNoticeInsert.js"></script>
