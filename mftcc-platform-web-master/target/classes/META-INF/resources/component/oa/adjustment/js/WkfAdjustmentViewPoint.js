;
var WkfAdjustmentViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaAdjustment/submitUpdateAjax?appNo="+adjustmentId+"&opinionType="+opinionType,formObj,'adjustment');
		}
	};
	//返回详情页面
