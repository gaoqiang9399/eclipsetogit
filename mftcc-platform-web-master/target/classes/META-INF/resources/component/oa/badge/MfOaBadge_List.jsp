...
<html>
		...
		<script type="text/javascript" >
			$(function(){
			 ...
			 function initPage(){
				...
				url : webPath+"/mfOaBadge/findByPageAjax", //列表数据查询的url
				tableId : "tablebadge0001", //列表数据查询的table编号
		...
		<div class="container">
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					<!-- 新增用章申请按钮 -->
					<div  class="btn-div">
						<dhcc:pmsTag pmsId="oa-badge-apply-btn">
	...
	<script type="text/javascript" src="${webPath}/component/oa/badge/js/MfOaBadge_List.js"></script>
	<script type="text/javascript">
