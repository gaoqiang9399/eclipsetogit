		...
		<div class="container form-container">
			<div class="scroll-content">
				...
				<div class="bootstarpTag">
					...
					<form  method="post" id="docModelForm" theme="simple" name="operform" action="${webPath}/mfCusFormConfig/updateDocAjax">
						<dhcc:bootstarpTag property="formdocmodelcus0001" mode="query" />
					</form>
					<script type="text/javascript">
						$("[name='docModelName']").parent().parent().parent().remove();
						$("[name='kindNoDes']").parent().parent().parent().remove();
						$("[name='useFlag']").parent().parent().parent().remove();
					</script>
				</div>
...
// 		});
	...
	<script type="text/javascript" src='${webPath}/component/cus/js/editDocPage.js'></script>
	<script type="text/javascript">
		var $scenceItem001	= $("#scenceList").find(".scenceItem[name='0000000001']");
		$scenceItem001.show();
		var $scenceItem002	= $("#scenceList").find(".scenceItem[name='0000000022']");
		$scenceItem002.show();
		
		$("#scenceList p:first").hide();
		$(".docTypeItem1").hide();
		$(".jiaDiv .docTypeItem1").css("display","inline-block");
		$("span[class='btn btn-link-theme del-btn']").remove();
		$("input[name='cusTypeDes']").attr("readonly","readonly");
		$("body").show();
	</script>
</html>
