		...
		<div class="container form-container">
			<div class="scroll-content">
				...
				<div class="col-md-10 col-md-offset-1 margin_top_20">
					<div class="bootstarpTag">
						...
						<form  method="post" id="MfCusBorrowerInfoForm" theme="simple" name="operform" action="${webPath}/mfCusBorrowerInfo/insertAjax">
			...
			<div class="formRowCenter">
				...
				<%--<dhcc:pmsTag pmsId="cus-saveAndAdd">--%>
					<%--<dhcc:thirdButton value="保存并新增" action="保存并新增" onclick="MfCusBorrowerInfo_Insert.ajaxSaveAndAdd('#MfCusBorrowerInfoForm')"></dhcc:thirdButton>--%>
				<%--</dhcc:pmsTag>--%>
