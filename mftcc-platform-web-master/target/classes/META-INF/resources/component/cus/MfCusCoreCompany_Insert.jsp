		...
		<div class="scroll-content">
			<div class="col-md-8 col-md-offset-2 column margin_top_20">
				<div class="bootstarpTag">
					...
					<form  method="post" theme="simple" name="operform" action="${webPath}/mfCusCoreCompany/insertAjax" id="insertForm">
						<dhcc:bootstarpTag property="formCoreCompany0002" mode="query"/>
					</form>	
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(function(){
		MfCusCoreCompany.insertInit();
	});
	$("form").delegate("[name=cusType]","change",function(){
		window.location.href=webPath+"/mfCusCoreCompany/input?typeNo="+$(this).val();
	})
</script>
</html>
