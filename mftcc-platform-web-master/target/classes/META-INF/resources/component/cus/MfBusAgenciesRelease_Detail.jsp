...
<body class="bg-white">
	<div class="container form-container">
		<div class="scroll-content">
			...
			<form  method="post" theme="simple" name="operform" action="${webPath}/mfBusAgencies/updateDetailAjax"  id="insertForm">
		...
		<div class="formRowCenter">
			<dhcc:thirdButton value="保存" action="保存" onclick="myUpdateReleaseDetailAjax('#insertForm')"></dhcc:thirdButton>
			<dhcc:thirdButton value="关闭" action="关闭" typeclass="cancel" onclick="closeMfAgenciesDetailInput();"></dhcc:thirdButton>
		</div>
		<div class="formCloseReleaseCenter">
			<dhcc:thirdButton value="关闭" action="关闭" typeclass="cancel" onclick="closeMfAgenciesDetailInput();"></dhcc:thirdButton>
		</div>
	</div>
</body>
...
<script type="text/javascript">
	...
	$(function(){
		MfBusAgencies.updateReleaseDetailInit();
	});
