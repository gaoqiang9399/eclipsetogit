...
<html>
		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/mfCusHighInfo/findByPageAjax",//列表数据查询的url
			    	tableId:"tablecushigh00001",//列表数据查询的table编号
	...
	<body>
		...
		<!--页面显示区域-->
		<div id="content" class="table_content"  style="height: auto;">
			<dhcc:tableTag property="tablecushigh00001" paginate="mfCusHighInfoList" head="true"></dhcc:tableTag>
