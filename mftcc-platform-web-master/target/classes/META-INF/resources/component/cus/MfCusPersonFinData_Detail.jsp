	...
	<div class="list-table">
		...
		<div id="CusFinMainAction" class="content collapse in">
			<table cellspacing="1" border="0" align="center" width="100%" class="ls_list" id="tablist">
				...
				<thead>
					<tr>
						<th align="center" width="10%" scope="col" name="shareholderName" sorttype="0">报表日期2</th>
						<th align="center" width="10%" scope="col" name="shareholderName" sorttype="0">企业名称2</th>
					...
					<c:forEach items="${ cusFinMainList}" var="cusFinMain" varStatus="status">
						<tr>
							<td align="center" width="10%">
								<a class="abatch" onclick="reportView(this,'${webPath}/cusFinMain/inputReportView?finRptType=${cusFinMain.finRptType}&finRptDate=${cusFinMain.finRptDate}&cusNo=${cusFinMain.cusNo}&accRule=1&relationCorpNo=${cusFinMain.relationCorpNo}&relationCorpName=${cusFinMain.relationCorpName}');return false;" href="javascript:void(0);">${cusFinMain.finRptDate}</a>
							</td>
							...
							<td align="center" width="15%">
								...
								<c:if test="${cusFinMain.finCapFlag != true}">
									...
									<c:if test="${cusFinMain.finRptSts != 1}">
										<a class="abatch" href="javascript:void(0);" onclick="getPersonPfsDialog();return false;">上传</a>
									</c:if>
								</c:if>
							</td>
							<td align="center" width="15%">
							...
							<td align="center" width="20%">
								...
								<c:if test="${cusFinMain.finRptSts != 1}">
									<a id="finDataFirm" class="abatch" onclick="confirmFinMain(this,'${webPath}/cusFinMain/updateReportConfirmAjax?finRptType=${cusFinMain.finRptType}&finRptDate=${cusFinMain.finRptDate}&cusNo=${cusFinMain.cusNo}&relationCorpName=${cusFinMain.relationCorpName}&relationCorpNo=${cusFinMain.relationCorpNo}');return false;" href="javascript:void(0);">数据确认</a>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:if>
