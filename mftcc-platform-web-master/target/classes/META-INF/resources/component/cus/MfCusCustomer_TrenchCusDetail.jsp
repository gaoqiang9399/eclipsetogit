...
<body class="overflowHidden">
								...
								<div class="col-xs-10 column">
									...
									<div class="margin_bottom_10">
										...
										<dhcc:pmsTag pmsId="cus-auth-credit">
											<s:if test="%{mfCusCreditApply.creditSts == 1|| mfCusCreditApply.creditSts == 2 ||mfCusCreditApply.creditSts == 3}">
								...
								<div>
									<p>
										<i class="i i-location "></i>
											<span id = "commAddress">
												<s:if test="mfCusCustomer.commAddress!=null&&mfCusCustomer.commAddress!=''">
	...
	<!-- 								</button> -->
									...
									<dhcc:pmsTag pmsId="cus-auth-btn">
										<button id="creditApply" class="btn btn-opt" onclick="getAppAuth();" type="button">
