...
<%-- 	<head>
		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/mfCusAssets/findByPageAjax",//列表数据查询的url
			    	tableId:"tablecusassets00001",//列表数据查询的table编号
	...
	<body>
		...
		<dhcc:tableTag property="tablecusassets00001" paginate="mfCusAssetsList" head="true"></dhcc:tableTag>
		</div>
	</body>	 --%>
	<head>
		<title>列表</title>
