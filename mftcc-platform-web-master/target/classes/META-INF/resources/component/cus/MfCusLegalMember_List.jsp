...
<html>
		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/mfCusLegalMember/findByPageAjax",//列表数据查询的url
			    	tableId:"tablecuslegm00001",//列表数据查询的table编号
	...
	<body>
		...
		<!--页面显示区域-->
		<div id="content" class="table_content"  style="height: auto;">
			<dhcc:tableTag property="tablecuslegm00001" paginate="mfCusLegalMemberList" head="true"></dhcc:tableTag>
