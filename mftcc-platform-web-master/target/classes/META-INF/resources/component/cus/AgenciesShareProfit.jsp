...
<html>
	...
	<body class="overflowHidden">
		...
		<div class="formRowCenter">
   			<dhcc:thirdButton value="保存" action="保存" onclick="AgenciesShareProfit.ajaxSave();"></dhcc:thirdButton>
   			<dhcc:thirdButton value="取消" action="取消" typeclass="myclose cancel" onclick="myclose();"></dhcc:thirdButton>
   		</div>	
				<%@ include file="/component/include/PmsUserFilter.jsp"%>
	</body>	
	<script src="${webPath}/component/cus/js/AgenciesShareProfit.js"></script>
