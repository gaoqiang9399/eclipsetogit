...
<body class="overflowHidden">
								...
								<div class="col-xs-10 column">
									...
									<div>
										<p>
											...
											<span class="vertical-line"></span> 
											<span><i class="i i-idcard2 " ></i><span id="idNum">
	...
	<!-- 								</button> -->
									...
									<dhcc:pmsTag pmsId="cus-eval-btn">
										<button class="btn btn-opt" onclick="cusEval.getInitatEcalApp('${cusNo}','4','1');" type="button">
									...
									<dhcc:pmsTag pmsId="cus-auth-btn">
										<button class="btn btn-opt" onclick="MfCusCredit.getAppAuth('1');" type="button">
