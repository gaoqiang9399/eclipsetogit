;
var MfCusWhitename_List = function(window, $) {
	var _init = function() {
	...
	//申请新增
	 var _finForminput = function(){
	 	top.window.openBigForm(webPath+'/mfCusWhitename/input', '白名单客户新增',function(){
	 		window.updateTableData();
	 	});
	 };
	/* //详情页面
    ...
    var _downloadTemplate = function(){
        var url = webPath+'/mfCusWhitename/downloadTemplate';
        jQuery.ajax({
            url:url,
            data:{},
            type:"POST",
