...
<html>
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="search-div">
						<button type="button" class="btn btn-primary" onclick="MfCusGuaLoanOuterSum_List.gualoanInsert();">新增</button>
	...
	<script type="text/javascript" src="${webPath}/component/cus/gualoan/js/MfCusGuaLoanOuterSum_List.js"></script>
	<script type="text/javascript">
		$(function(){
			MfCusGuaLoanOuterSum_List.init();
		});
	</script>
</html>
