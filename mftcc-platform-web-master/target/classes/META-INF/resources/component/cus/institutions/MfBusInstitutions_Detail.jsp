...
<script type="text/javascript">
		...
		var applySts = '${mfBusInstitutions.applySts}';
</script>
</head>
	...
	<c:choose>
		...
		<div class="col-xs-10 col-xs-offset-1" style="margin-top:20px;">
			<div class="arch_sort" style="border: 0px;">
				<div class="dynamic-block" title="机构审批" name="MfBusInstitutionsAction" data-sort="14" data-tablename="mf_oa_dimission">
					<div class="list-table">
						<div class="title">
							<span class="formName"><i class="i i-xing blockDian"></i>机构审批</span>
							<button class=" btn btn-link pull-right formAdd-btn" data-toggle="collapse" data-target="#MfBusInstitutionsAction">
								<i class="i i-close-up"></i><i class="i i-open-down"></i>
							</button>
						</div>
						<div disable="true" class="content collapse in" id="MfBusInstitutionsAction" style="margin-top: 10px;">
							<form method="post" id="InstitutionsDetail" theme="simple" name="operform" action="${webPath}/mfBusInstitutions/insertAjax">
								<dhcc:propertySeeTag property="formmfbusinsdetail" mode="query" />
							</form>
						</div>
					</div>
				</div>
			</div>
			<c:if test = "${mfBusInstitutions.applySts != 0}">
			<div class="arch_sort">
...
<script type="text/javascript">
		...
		function ajaxSave(){
			$.ajax({
				url : webPath+"/mfBusInstitutions/submitProcessAjax",
				data : {
