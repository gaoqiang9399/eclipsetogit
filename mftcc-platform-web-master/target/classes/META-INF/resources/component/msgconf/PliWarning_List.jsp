	...
	<head >
		...
		$(function(){
		    myCustomScrollbar({
		    	...
		    	url : webPath + "/pliWarning/findByPageAjax", //列表数据查询的url
		    	tableId : "tablepliwarn0001", //列表数据查询的table编号
        ...
        function baseTagSet(obj, url){
			...
			function addConfig(){
				top.openBigForm(webPath + "/pliWarning/getInputPage","新增",function(){
