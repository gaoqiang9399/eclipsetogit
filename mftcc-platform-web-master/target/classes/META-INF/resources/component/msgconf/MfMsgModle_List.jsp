	...
	<head >
		...
		$(function(){
		    myCustomScrollbar({
		    	...
		    	url : webPath + "/cuslendWarning/findMsgByPageAjax", //列表数据查询的url
		    	tableId : "tablecuslendmsg0001", //列表数据查询的table编号
        ...
        function baseTagSet(obj, url){
			...
			function addConfig(){
				top.openBigForm(webPath + "/cuslendWarning/getSMSInputPage","新增",function(){
					...
					<div class="search-div">
						<div class="col-xs-9 column">
							...
							<ol class="breadcrumb pull-left">
								<li><a href="${webPath}/sysDevView/setC?setType=model">参数设置</a></li>
								<li class="active">消息模板配置</li>
							</ol>
						</div>
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=检查模板名称"/>
					</div>
				</div>
			</div>
