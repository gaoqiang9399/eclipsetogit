	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				//方案类型设置为只读
				$("select[name=funType]").attr("readonly","readonly");
				...
				MfMsgPledge.changeWaveType("update");
			});
		</script>
	</head>
	<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				...
				<form method="post" id="mfMsgPledge" theme="simple" name="operform" action="${webPath}/mfMsgPledge/updateAjax">
