		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/evalScenceAdjRel/findByPageAjax",//列表数据查询的url
			    	tableId:"tableeval0004",//列表数据查询的table编号
	...
	<body>
		<div>
			<div style="vertical-align: bottom;display: block;" class="tabCont">
				<strong >评级调整评分指标项关联表</strong>
				<!--我的筛选按钮-->
				<div class="filter-btn-group">
					<!--自定义查询输入框-->
					<input placeholder="智能搜索"  class="filter_in_input" type="text" />
					<div class="filter-sub-group">
						<button  class="filter_btn_search" type="button" ><i class="i i-fangdajing"></i></button>
