function func_getById(obj, url) {
	...
	c = new RightForm(
			{actionUrl:url,formUrl:webPath+"/evalSysAssess/updateAjax",title:"评级信息配置",
...
function func_input(url) {
	c = new RightForm(
			{actionUrl:url,formUrl:webPath+"/evalSysAssess/insertAjax",title:"评级信息配置",
		...
		jQuery.ajax({
			...
			success:function(data){
				if(data.flag == "success"){
					...
					myCustomScrollbar({
						obj:"#content",
						url:webPath+"/evalSysAssess/findByPageAjax",
						tableId:"tableEval4001",
