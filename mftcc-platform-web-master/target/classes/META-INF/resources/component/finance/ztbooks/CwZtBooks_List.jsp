...
<html>
	<head>
		...
		<script type="text/javascript" >
			...
			function goBooksDetail(url){
				cwZtBooksList.goBooksDetail(url);
			}
			function deleteUpdateBooks(url){
				window.top.alert(top.getMessage("CONFIRM_DELETE"),2,function(){
					cwZtBooksList.deleteUpdateBooksAjax(url);
				});
				
			}
			function copyAddBooks(url){
				url=webPath+url;
				cwZtBooksList.copyAddInsert(url);
			}
		</script>
	</head>
		...
		<div class="container">
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="btn-div">
						<button type="button" class="btn btn-primary pull-left" onclick="cwZtBooksList.ztbooksInsert()">新增帐套</button>
					</div>
					...
					<div class="search-div">
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=帐套名称"/>
					</div>
				</div>
			</div>
