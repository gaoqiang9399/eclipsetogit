	...
	<head>
		...
		function checkOrg(obj) {
			...
			if(autoComData.length == 0){
				url = webPath+"/cwCusBankAccManage/getAccNameDataSourceAjax?accountName="+accountName;
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="bankacc_form"  theme="simple" name="operform" action="${webPath}/cwCusBankAccManage/insertAjax">
							<dhcc:bootstarpTag property="formbankacc0002" mode="query" />
						</form>
					</div>
				</div>
			</div>
			<div class="formRowCenter">
				<dhcc:thirdButton value="保存" action="保存" onclick="ajaxAddBankAcc('#bankacc_form');"></dhcc:thirdButton>
