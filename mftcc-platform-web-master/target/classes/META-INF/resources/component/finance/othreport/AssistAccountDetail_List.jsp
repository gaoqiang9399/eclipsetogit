		...
		<script type="text/javascript" >
			...
			$(function(){
			    ...
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/assistAccountDetail/getAccountLedgerAjax",//列表数据查询的url
			    	tableId:"tableassistAccountDetail0001",//列表数据查询的table编号
				...
				<div class="col-xs-9 column mysearch-div" id="pills">
					...
					<div class="mod-toolbar-top">
						<div class="left">
							<form id="cwListForm">
								<!-- 	查询标题 -->
								<span class="txt fl">辅助核算明细账</span>
...
<!-- 											<li class="li-one-wrap"><label for="#filter-fromLevel">包含凭证:</label> <input type="checkbox" name="noAccountpz" id="noAccountpz" value="1" onclick="checkcwpz(this);">未记账凭证</input> <input type="checkbox" name="wrongpz" id="wrongpz" value="1" disabled="disabled">错误凭证</input></li> -->
								...
								<span class="txt fl">辅助类别:</span> 
								<select class="items-btn menu-btn fl" name="txType" id="txType" autocomplete="off"></select> 
								<a onclick="sure_Search();" class="ui-btn ui-btn-refresh fl" id="refresh">查询</a>
								<span class="txt fl">「辅助项目：<font id="fontAccName">未选</font>」
								</span>
							</form>
						</div>
					</div>
