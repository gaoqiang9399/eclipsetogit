...
<script type="text/javascript">
	...
	function doSubmit(obj){
		...
		if(flag){
			commitProcess(webPath+"/mfStampCredit/submitUpdateAjax?id="+id+"&primaryAppId="+id+"&appNo="+id+"&opinionType="+opinionType+"&approvalOpinion="+approvalOpinion,obj,'applySP');
		}
	}
	...
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag">
				<div class="form-title">用印申请</div>
				<div class="form-tips">说明：带*号的为必填项信息，请填写完整。</div>
				<form method="post" id="stampCreditForm" theme="simple" name="operform" action="${webPath}/mfStampCredit/submitUpdateAjax">
					<dhcc:bootstarpTag property="formstampcreditapproval" mode="query"/>
				</form>
			</div>
		</div>
	</div>
