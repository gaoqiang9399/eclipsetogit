;
var WkfDimissionViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfOaDimission/submitUpdateAjax?appNo="+dimissionId+"&opinionType="+opinionType,formObj,'dimission');
		}
	};
	//返回详情页面
