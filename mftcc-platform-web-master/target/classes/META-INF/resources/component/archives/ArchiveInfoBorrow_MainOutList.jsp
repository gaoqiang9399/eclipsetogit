...
<div class="row clearfix padding_top_10">
	<div class="col-xs-12 col-md-12 column padding_left_15">
		<button class="btn btn-link block-title">借出记录</button>
...
<div class="row clearfix padding_left_12 his-statistic">
	<div class="col-xs-12 col-md-12 column" >
		<div id="lend_out_div" class="list-table">
			<dhcc:thirdTableTag property="tabletablearchiveborrowdetailin" paginate="archiveLendInfoList" head="true"></dhcc:thirdTableTag>
		</div>
	</div>
</div>		
