		...
		function save(obj){
			...
			if (flag) {
				...
				$.ajax({
					...
					url : "${webPath}/archiveInfoVoucherReturn/confimAjax",
					dataType : "json",
	...
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="cwBillForm" theme="simple" name="operform" action="${webPath}/archiveInfoVoucherReturn/confimAjax">
					<dhcc:bootstarpTag property="formarchivevoucherconfim" mode="query"/>
				</form>
			</div>
			...
			<div class="list-table">
				...
				<div class="mfBusApplyList content collapse in" id="mfBusApplyList" name="receAccountList">
					<dhcc:tableTag property="tablearchivevoucherreturnconfim" paginate="mfBusApplyList" head="true"></dhcc:tableTag>
				</div>
			</div>
			<div class="list-table">
				<div class="title">
			...
			<div class="list-table">
				<div class="title">
					<span><i class="i i-xing blockDian"></i>原始凭证登记列表</span>
					<button class=" btn btn-link pull-right formAdd-btn" data-toggle="collapse" data-target="#pledgeBaseInfoList">
						<i class="i i-close-up"></i><i class="i i-open-down"></i>
					</button>
				</div>
				<div class="pledgeBaseInfoList content collapse in" id="pledgeBaseInfoList" name="pledgeBaseInfoList">
					<dhcc:tableTag property="tablearchivevoucherreurnori" paginate="pledgeBaseInfoList" head="true"></dhcc:tableTag>
				</div>
			</div>
