...
<script type="text/javascript" >
	$(function(){
		myCustomScrollbar({
			obj : "#content",
			url : webPath+"/archiveInfoBorrow/findByPageAjax?optType=01", //列表数据查询的url
			tableId : "tablearchiveborrowin", //列表数据查询的table编号
	...
	function applyInsert(){
		top.openBigForm(webPath+"/archiveInfoBorrow/inputIn", "新增", function () {
	...
	function getOutDetail(obj,lk){
		top.openBigForm(webPath+lk, "借阅详情", function () {
			window.location.reload();
		});
	}
</script>
