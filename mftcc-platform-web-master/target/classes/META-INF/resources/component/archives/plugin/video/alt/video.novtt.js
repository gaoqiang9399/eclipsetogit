...
var ModalDialog = function (_Component) {
  ...
  ModalDialog.prototype.closeable = function closeable(value) {
    if (typeof value === 'boolean') {
      var closeableOther = this.closeable_ = !!value;
      var close = this.getChild('closeButton');

      // If this is being made closeable and has no close button, add one.
      if (closeableOther && !close) {
...
var Player = function (_Component) {
  ...
  Player.prototype.buffered = function buffered() {
    var bufferedOther = this.techGet_('buffered');

    if (!bufferedOther || !bufferedOther.length) {
        bufferedOther = (0, _timeRanges.createTimeRange)(0, 0);
    }

    return bufferedOther;
  };
...
var Flash = function (_Tech) {
  ...
  Flash.prototype.duration = function duration() {
    ...
    var durationOther = this.el_.vjs_getProperty('duration');

    return durationOther >= 0 ? durationOther : Infinity;
  };
