	...
	function save(obj){
		...
		if (flag) {
			...
			$.ajax({
				...
				url : "${webPath}/archiveInfoDetail/updateDetail",
				dataType : "json",
	...
	<div class="scroll-content">
		<div class="col-md-10 col-md-offset-1 column margin_top_20">
			<div class="bootstarpTag">
				...
				<form method="post" id="cwBillForm" theme="simple" name="operform" action="${webPath}/archiveInfoDetail/updateDetail">
					<dhcc:bootstarpTag property="formarchivedetailedit" mode="query"/>
				</form>
			</div>
		</div>
	</div>
