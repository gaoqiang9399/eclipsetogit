;
var WkfAssetsDisposalViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath + "/mfAssetsDisposal/submitUpdateAjax?appNo=" + disposalId + "&opinionType=" + opinionType + "&handleType=" + handleType,formObj,'mfAssetsDisposal');
		}
	};
	//返回详情页面
