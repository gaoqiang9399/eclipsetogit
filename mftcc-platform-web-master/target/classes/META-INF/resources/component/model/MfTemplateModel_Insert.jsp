...
<html>
	...
	<div class="mf_content">
		<div class="content-box">
			...
			<div class="tab-content">
				<form method="post" id="tempModel-form"  theme="simple" name="operform" action="${webPath}/mfTemplateModel/insertAjax">
	...
	<div class="formRowCenter" style="position: fixed;left: 40%;bottom: 0px;">
		<dhcc:thirdButton value="保存" action="保存" onclick="ajaxInsertThis('#tempModel-form');"></dhcc:thirdButton>
