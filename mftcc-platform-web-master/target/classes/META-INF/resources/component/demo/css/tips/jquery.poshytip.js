...
(function($) {
	...
	$.Poshytip.prototype = {
		init: function() {
			...
			if(this.$elm.attr('tips')==""||typeof(this.$elm.attr('tips'))=="undefined")return false;
			this.$elm.data('title.poshytip', this.$elm.attr('tips')).data('poshytip', this);
		...
		mouseleave: function() {
			...
			this.clearTimeouts();
			this.$elm.attr('tips', this.$elm.data('title.poshytip'));
