;
var WkfRiskLevelManageViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfRiskLevelManage/submitUpdateAjax?appNo="+riskId+"&opinionType="+opinionType,formObj,'mfRiskLevelManage');
		}
	};
	//返回详情页面
