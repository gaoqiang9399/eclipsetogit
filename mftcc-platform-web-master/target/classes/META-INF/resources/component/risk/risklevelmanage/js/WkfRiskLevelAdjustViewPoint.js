;
var WkfRiskLevelAdjustViewPoint = function (window,$){
	var _init = function(){
	...
	var _doSubmitAjax = function(formObj){
		...
		if (flag) {
			...
			commitProcess(webPath+"/mfRiskLevelAdjust/submitUpdateAjax?appNo="+id+"&opinionType="+opinionType,formObj,'mfRiskLevelAdjust1');
		}
	};
	//返回详情页面
