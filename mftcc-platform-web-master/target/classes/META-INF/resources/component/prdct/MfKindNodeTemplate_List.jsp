	...
	<head>
		...
		<script type="text/javascript" >
			$(function(){
				...
				url : webPath+"/mfKindNodeTemplate/findByPageAjax", //列表数据查询的url
				tableId : "tablenodetemplate0001", //列表数据查询的table编号
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="search-div">
						<jsp:include page="<%=webPath %>/component/include/mySearch.jsp?blockType=2&placeholder=客户名称/项目名称"/>
					</div>
				</div>
			</div>
