    ...
    <script type="text/javascript">
        ...
        var batchFunc = function(returnFileName) {
            ...
            if(count <= pssBillsJson.length){	
            	var billId = "";
            	if(printBizType == 'USEMONEYQUERY'){
            		billId = pssBillsJson[count - 1].fincId;
            	}    	
            	
				
            	$.ajax({
            		url : '${webPath}/batchPrint/batchPrintAjax',
            		data : {
            			bussinessId : billId,
                ...
                document.getElementById("ProgressBar").style.width = "0%";
               	window.location.href = "<%=ajaxUrl %>component/batchprint/fileMerge.jsp?fileNameArray=" + fileNameArray;
            }
