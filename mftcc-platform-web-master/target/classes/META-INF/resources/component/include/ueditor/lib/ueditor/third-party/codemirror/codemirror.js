...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onMouseDown(e) {
            ...
            for (n = e_target(e); n != wrapper; n = n.parentNode)
        ...
        function updateLinesNoUndo(from, to, newText, selFrom, selTo) {
            ...
            if (from.ch == 0 && to.ch == 0 && newText[newText.length - 1] == "") {
                ...
                for (i = 0, e = newText.length - 1; i < e; ++i)
                ...
                if (newText.length == 1)
                    ...
                    added = [];
                    for (i = 1, e = newText.length - 1; i < e; ++i)
        ...
        function patchDisplay(from, to, intact) {
            ...
            if (!intact.length) lineDiv.innerHTML = "";
                ...
                for (var i = 0; i < intact.length; ++i) {
                    ...
                    for (j = 0, e = cur.to - cur.from; j < e; ++j) {curNode = curNode.nextSibling; domPos++;}
                }
        ...
        function matchBrackets(autoclear) {
            ...
            for (var off = pos + 1, i = 0, e = st.length; i < e; i+=2)
                if ((off -= st[i].length) <= 0) {style = st[i+1]; break;}
            ...
            function scan(line, from, to) {
                ...
                for (i = forward ? 0 : st.length - 2, e = forward ? st.length : -2; i != e; i += 2*d) {
                    var text = st[i];
            ...
            for (i = head.line, e = forward ? Math.min(i + 100, doc.size) : Math.max(-1, i - 100); i != e; i+=d) {
                line = getLine(i), first = i == head.line;
        ...
        function highlightWorker() {
            ...
            var task;
            while (work.length) {
                if (!getLine(showingFrom).stateAfter) task = showingFrom;
                else task = work.pop();
    ...
    Line.prototype = {
        ...
        append: function(line) {
            ...
            var i;
            if (mymk) {
                for (i = 0; i < mymk.length; ++i)
                    if (mymk[i].to == null) mymk[i].to = mylen;
            }
            if (mk && mk.length) {
                if (!mymk) this.marked = mymk = [];
                outer: for (i = 0; i < mk.length; ++i) {
                    var mark = mk[i];
                    if (!mark.from) {
    ...
    function lineAtHeight(chunk, h) {
        ...
        var i, e;
        outer: do {
            for (i = 0, e = chunk.children.length; i < e; ++i) {
        ...
        for (i = 0, e = chunk.lines.length; i < e; ++i) {
    ...
    function heightAtLine(chunk, n) {
        ...
        for (i = 0; i < n; ++i) h += chunk.lines[i].height;
        return h;
    }
    ...
    History.prototype = {
        addChange: function(start, added, old) {
            ...
            if (time - this.time > 400 || !last ||
                ...
                var i;
                if (start < last.start) {
                    for (i = last.start - start - 1; i >= 0; --i)
                ...
                for (i = last.added - oldoff, e = old.length; i < e; ++i)
                    last.old.push(old[i]);
    ...
    function eltOffset(node, screen) {
        ...
        for (n = node.parentNode; n != e; n = n.parentNode)
    ...
    (function() {
        var i;
        // Number keys
        for (i = 0; i < 10; i++) keyNames[i + 48] = String(i);
        // Alphabetic keys
