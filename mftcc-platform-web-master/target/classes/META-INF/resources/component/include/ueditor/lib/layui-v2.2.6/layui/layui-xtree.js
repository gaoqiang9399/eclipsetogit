...
layuiXtree.prototype.Rendering = function () {
    ...
    for (i = 0; i < xtree_ckitems.length; i++) {
    ...
    for (i = 0; i < xtree_items.length; i++) {
    ...
    for (i = 0; i < xtree_icons.length; i++) {
        xtree_icons[i].style.position = "relative";
        xtree_icons[i].style.top = "8px";
    ...
    for (i = 0; i < xtree_nullicons.length; i++) {
        ...
        xtree_nullicons[i].style.display = "none";
    ...
    for (i = 0; i < _xtree_disableds.length; i++) {
