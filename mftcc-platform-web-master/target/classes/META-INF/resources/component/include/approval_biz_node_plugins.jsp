...
<script type="text/javascript">
    ...
    var approvalNodeNo =(typeof (approvalNodeNo) == 'undefined') ? '${approvalNodeNo}' : approvalNodeNo;// 用于加载配置在审批节点要件或模板, primary_apply_approval-初选审批, apply_approval-融资审批, contract_approval-合同审批, certidInfo_appr-权证审批, putout_approval-支用审批
	// 要件
    ...
    if(typeof (makePolicyMeetingAppId) != "undefined" && makePolicyMeetingAppId != null && makePolicyMeetingAppId != ""){
        temBizNo = makePolicyMeetingAppId;
	}
	// 费用
...
<!-- 文档 -->
<div class="row clearfix" id="#fileButton">
	<%@ include file="/component/model/templateIncludePage.jsp"%>
</div>

<!-- 要件 -->
<div class="row clearfix" id="docButton" >
