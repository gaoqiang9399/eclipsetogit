		...
		<div class="scroll-content">
			<div class="col-md-8 col-md-offset-2 column margin_top_20">
				<div class="bootstarpTag">
					...
					<form method="post" id="updateForm" theme="simple" name="operform" action="${webPath}/vwLinkManage/updateAjax" enctype="multipart/form-data">
...
<ul id="viewer" style="display: none;">
    <li><img src="" alt="链接图片" id="template"></li>
</ul>
</body>
<script>
$(function () {
...
<script src="${webPath}/component/frontview/js/VwLinkManage_Detail.js"></script>
<script type="text/javascript">
$(function(){
	VwLinkManageDetail.init();
})
</script>
</html>
