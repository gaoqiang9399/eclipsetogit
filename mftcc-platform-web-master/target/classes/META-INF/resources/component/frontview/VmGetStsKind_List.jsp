    ...
    <script type="text/javascript" >
        $(function(){
            myCustomScrollbar({
                ...
                url:webPath+"/vwProductManage/getsyskindinfo",
                tableId:"tabletablegetsyskindinfo",//列表数据查询的table编号
    ...
    <div class="row clearfix bg-white tabCont">
        <div class="col-md-12 column">
            ...
            <div class="search-div" id="search-div">
                <!-- begin -->
                <jsp:include page="/component/include/mySearch.jsp?blockType=4&placeholder=产品名称/产品编号"/>
                <!-- end -->
            </div>
        </div>
    </div>
