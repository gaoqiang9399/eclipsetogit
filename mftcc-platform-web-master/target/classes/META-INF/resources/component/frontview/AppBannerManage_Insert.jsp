		...
		<div class="scroll-content">
			<div class="col-md-8 col-md-offset-2 column margin_top_20">
				<div class="bootstarpTag">
					...
					<form method="post" id="insertForm" theme="simple" name="operform" action="${webPath}/vwBannerManage/insertAjax">
...
<script src="${webPath}/component/frontview/js/AppBannerManage_Insert.js"></script>
<script type="text/javascript">
$(function(){
	AppBannerManageInsert.init();
});
</script>
</html>
