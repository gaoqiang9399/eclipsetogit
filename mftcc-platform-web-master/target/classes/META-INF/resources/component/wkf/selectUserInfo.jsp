...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function enterClick() {
				var selectedValue = getSelectedValue("radioUserId");
				if( selectedValue == "" ) {
					alert("请选择用户！");
					return;
				}
	...
	<body class="body_bg">
		<div class="right_bg">
			<div class="right_w">
				<!--con -->
				<div class="from_bg">
					<form id="${webPath}/system/findUsersInfo" name="cms_form" action="${webPath}/wkf/System/findUsersInfo" method="post">
						<!-- search start -->
						...
						<div class="table_w">
							...
							<%for(int i = 0; i < total ;i++) {
								...
								%>
								<tr >
									<td align="center"><input name="userIdCheckbox" type="checkbox" value="<%=user.getId() %>:<%=user.getName()%>" /></td>
