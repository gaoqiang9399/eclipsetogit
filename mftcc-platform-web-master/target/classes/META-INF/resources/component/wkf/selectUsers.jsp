		...
		<script type="text/javascript">
			...
			function enterClick() {
				...
				for(var i=0; i<values.length; i++) {
					userNames += "," + document.getElementById(values[i]).value;
				}
				
				window.returnValue = selectedValue + ":" + userNames.substring(1);
				window.close();
				return;
			}
		</script>
	...
	<body class="body_bg">
		<div class="right_bg">
			<div class="right_w">
				<!--con -->
				<div class="from_bg">
					<form id="${webPath}/wkfSystem/findUsersInfo" name="cms_form" action="${webPath}/wkf/WkfSystem/findUsersInfo" method="post">
						<!-- search start -->
						<!-- 
						...
						<div class="table_w">
							...
							<table id="tablist" width="80%" border="0"   align="center" cellspacing="1" class="ls_list" title="用户列表">
								...
								<thead> 
									<tr> 
										...
										<th scope="col"  align="center">所在机构</th>
							...
							<%for(int i = 0; i < total ;i++) {
								...
								%>
								<tr >
									<td align="center"><input name="userIdCheckbox" type="checkbox" value="<%=user[0] %>" />
										<input type="hidden" id="<%=user[0] %>" value="<%=user[1] %>"> 
									</td>
