...
<html>
	...
	<form method="post" theme="simple" name="cms_form"
		action="${webPath}/wkfApprovalUser/findByPage">
		<!-- <div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
				...
				<div class="from_bg">
					<div class="right_v">
						<div style="vertical-align: bottom;" class="tabCont">
							<div style="float:left" class="tabTitle">审批用户列表</div>
							<dhcc:button value="新增" action="新增" typeclass="t_ico_tj"
										onclick="${webPath}/wkfApprovalUser/input"></dhcc:button>
						</div>
						<dhcc:tableTag paginate="wkfApprovalUserList" property="tablewkf0002"
								head="true" />
					</div>
				</div>
			</div>
		...
		<div>
			<div style="vertical-align: bottom; display: block;" class="tabCont">
				<strong>审批用户列表</strong>
				<div class="search-group">
				<!--我的筛选选中后的显示块-->
				<div class="search-lable" id="pills">
					<dhcc:formTag property="formwkf0003" mode="query" />
					<dhcc:button value="查询" action="查询" commit="true"
								typeclass="btn_80"></dhcc:button>
					<dhcc:button value="新增" action="新增" typeclass="t_ico_tj"
										onclick="${webPath}/wkfApprovalUser/input"></dhcc:button>
