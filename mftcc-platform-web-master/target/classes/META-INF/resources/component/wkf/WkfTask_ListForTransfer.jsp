...
<form method="post" theme="simple" name="cms_form"
					action="${webPath}/wkfTask/findByPageForTransfer">
<div class="right_bg">
	<div class="right_w">
		<div class="from_bg">
			<div class="right_v">
					<table width="100%" align="center" class="searchstyle">
						<tr>
							<td>
								<dhcc:formTag property="formwkf0039" mode="query" />
							</td>
						</tr>
					</table>
					<div class="tools_372">
	...
	<div class="right_w">
		<div class="from_bg">
			...
			<div style="vertical-align: bottom;" class="tabCont">
				<div style="float:left" class="tabTitle">产权转移待处理列表</div>
			</div>
			<dhcc:tableTag paginate="wkfTaskList" property="tablewkf0054" head="true" />
			</div>
		</div>
	</div>
</div>
