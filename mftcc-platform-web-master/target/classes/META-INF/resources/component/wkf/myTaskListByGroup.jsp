	...
	<body class="body_bg">
		<div class="right_bg">
			<div class="right_w">
							...
							%>
								<tr >
									...
									<td width="5%" align="center">
										...
										<button onclick="javascript:lkconfirm('<%=webPath %>/wkf/Task/take?taskId=<%=task.getId() %>')" class="ico_button4All" title="签收任务">签收任务</a>
										<%} %>
 			...
 			<pageC:page urlPath="${webPath}/task/listMyTaskByGroup" scope="request" page="ipage" />
						</div>
						<!--table end -->
					</form>
				</div>
