...
<html>
	<head>
		<title>列表</title>
		<script type="text/javascript" src='${webPath}/component/calc/fee/js/MfBusAppFee_mfBusAppFee.js'> </script>
		<script type="text/javascript" >
			var appId = '${appId}';
			var fincId = '${fincId}';
			$(function(){
				MfBusAppFee_mfBusAppFee.init();
			});
		</script>
	</head>
	<body class="overflowHidden bg-white">
					...
					<div class="bigform_content col_content">
						...
						<div class="col-sm-offset-5 col-sm-5" style="margin-top:20px;">
							<button id="fincFeePlanTrial_button" type="button" class="btn btn-default" value="计算"
								...
								onclick="MfBusAppFee_mfBusAppFee.ajaxInsertThis();" >计算</button>
						</div>
					</div>
		...
		<div class="formRowCenter">
   			<dhcc:thirdButton value="提交" action="提交" onclick="MfBusAppFee_mfBusAppFee.submitForm();"></dhcc:thirdButton>
