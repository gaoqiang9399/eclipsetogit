		...
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="MfCusCreditBreedForm" theme="simple" name="operform" action="${webPath}/mfCusCreditApply/breedInsertAjax">
			...
			<div class="formRowCenter">
				<!-- ajaxSave方法不适用时需另行实现。新写JS代码必须闭包。 -->
	   			<dhcc:thirdButton value="保存" action="保存" onclick="MfBusBreed_Insert.ajaxSave('#MfCusCreditBreedForm')"></dhcc:thirdButton>
