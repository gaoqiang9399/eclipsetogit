	...
	<head>
		...
		<script type="text/javascript">
			...
			function pactAgenciesInit() {
				...
				if(templateId!=""){
                    $.ajax({
                        url:  webPath + "/mfCusCreditApply/pactAgenceisInit",
                        data:{templateId:templateId,creditAppId:creditAppId,cusNo:cusNo},
                        type:'post',
                        dataType:'json',
                                ...
                                if(pactAgenciesInitFlag==0){
                                    $("input[name='agenciesId']").popupSelection({
                                        ...
                                        changeCallback: function (obj,elem) {
                                            ...
                                            if(templateId=='119'){
                                                $.ajax({
                                                    url:  webPath + "/mfCusCreditApply/getClientAjax",
                                                    data:{templateId:templateId,creditAppId:creditAppId,agenciesId:agenciesId},
                                                    type:'post',
                                                    dataType:'json',
                                                    success: function (data) {
                                                        if (data.flag == "success") {
			...
			<div class="scroll-content">
				<div class="col-md-10 col-md-offset-1 margin_top_20">
					<div class="bootstarpTag">
						...
						<form method="post" id="formpactExtendCredit" theme="simple" name="operform" action="${webPath}/mfCusCreditApply/insertExtendAjax">
