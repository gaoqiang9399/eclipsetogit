var MfCusCreditApprove = function(window,$){
	var _init = function(){
        ...
        if(nodeNo.indexOf("credit_supplement")!=-1||nodeNo.indexOf("dep_manager")!=-1){
            $("#agenciesAdd").show();
            $("#breedAdd").show();
    ...
    var _getKindAmtAdjInfo=function(creditAppId,adjustAppId){
        ...
        if(typeof(adjustAppId)=='undefined' || adjustAppId==""){
	...
	var _doSubmit = function(obj){
		...
		if(flag){
			...
			commitProcess(webPath+"/mfCusCreditApproveInfo/submitApproveAjax?appNo="+creditApproveId+"&opinionType="+opinionType+"&creditApproveId="+creditApproveId,obj,'creditSP');
		}
	};
