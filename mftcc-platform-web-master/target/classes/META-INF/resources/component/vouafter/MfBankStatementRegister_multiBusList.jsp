...
<html>
	...
	var mfBankStatementRegisterProjectListSize='${mfBankStatementRegisterProjectListSize}';
	$(function(){
        //处理暂无数据的情况
        if(mfBankStatementRegisterProjectListSize == "0"){
...
<body class="bg-white">
 	<div class="container scroll-content">
 		 <div class="row clearfix">
			<c:if test="${mfBankStatementRegisterProjectList != null and fn:length(mfBankStatementRegisterProjectList) > 0}">
				<div class="arch_sort">
