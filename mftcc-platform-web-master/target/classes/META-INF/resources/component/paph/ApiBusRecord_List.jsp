			...
			<div class="row clearfix bg-white tabCont">
				...
				<div  class="btn-div">
					<div class="col-md-12 text-center">
						<span class="top-title">引流接口数据查询</span>
					</div>
				</div>
				</div>
				<div class="col-md-12">
				...
				<div class="search-div" id="search-div">
						<!-- begin -->
							<jsp:include page="/component/include/mySearch.jsp?blockType=4&placeholder=业务申请号/订单号"/>
						<!-- end -->
				</div>
				</div>
			</div>
...
<script src="${webPath}/component/paph/js/ApiBusRecord_List.js"></script>
<script type="text/javascript">
	$(function(){
		ApiBusRecordList.init();
	});
</script>
</html>
