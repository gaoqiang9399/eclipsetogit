...
var setting = {
	async:{  
        ...
        type: 'post',  
        dataType: 'json',
        url: webPath+"/mfHouseEval/getChildAjax",//异步加载时的请求地址
        dataFilter: filter
     },
	data: {
		simpleData: {
...
function zTreeOnClick(event, treeId, treeNode) {
	if(treeNode.isParent){
        ...
        res.areaCode = treeNode.areaCode;

        res.complateDate = treeNode.complateDate;
        res.floorNum = treeNode.floorNum;
        res.floor = treeNode.floor;
        res.orientation = treeNode.orientation;
        res.roomNum = treeNode.roomNum;
