...
<html>
		...
		<script type="text/javascript" >
			$(function(){
			    myCustomScrollbar({
			    	...
			    	url:webPath+"/sysLoginLog/findByPageAjax",//列表数据查询的url
			    	tableId:"tablesys1101",//列表数据查询的table编号
	...
	<body>
		...
		<!--页面显示区域-->
		<div id="content" class="table_content"  style="height: auto;min-width:1280px;">
		</div>
	</body>	
</html>
