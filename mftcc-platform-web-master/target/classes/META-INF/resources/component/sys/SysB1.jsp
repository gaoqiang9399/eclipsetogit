			   ...
			   var jData={"pageNo":1,"pasSts":0,"pasMaxNo":pasMaxNo,"pasMinNo":"","pasAware":"","createDate":""};			   
				$.ajax({
					...
					success : function(jsonData) {	
						...
						taskB.initTasks(".work-zone-tasks",initData.sysTaskInfoArray.result, pasSubType,pasTypeOperation);
	...
	<div class="row clearfix homepage" id="home-page" >
		...
		<div class="col-md-8 column" >
			<div style="margin-top:6px;">	
				...
				<button class="homebtn" onclick="updateHomePage();">
					设为首页
				</button>
				<i class="i i-x3 setHomePageClose" onclick="cancle();">
				</i>
			</div>			
		</div>
	</div>
