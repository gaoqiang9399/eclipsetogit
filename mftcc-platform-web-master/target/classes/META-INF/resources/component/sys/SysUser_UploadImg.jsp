		...
		$.ajax({
			...
			success:function(data){
				if(data.flag == "success"){
					$.ajax({
						url:webPath+"/sysUser/submitUploadHeadImg",
						data:{opNo:'${opNo}',headImg:fileName},
						type:'post',
						dataType:'json',
						success:function(data){
							if(data.flag == "success"){
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
		            <div id = "headimgdiv" style="height:170px;">
		            	...
		            	<c:if test="${statu.fromPage=='perCenter'}" >
					...
					<div class="bootstarpTag">
						...
						<form method="post" id="uploadForm" theme="simple" name="operform" enctype="multipart/form-data" action="${webPath}/uploadFile/upload">
