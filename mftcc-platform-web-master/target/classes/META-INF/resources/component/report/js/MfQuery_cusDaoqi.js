var cusDaoqi = function(window,$){
	...
	var submit_onclick = function(){
		...
		top.createShowDialog("/report_new/report/rbc/designPreviewIndex.jsp?reporttype=D&uid=3e008f6ddf0419ba884d877ee6bf3e92&opno="+opNo+"&kindno="+kindNo+"&date1="+date11+"&date2="+date22+"&flagA="+flagA+"&flagB="+flagB+"&flagC="+flagC,"客户到期",'85','85');
	};
