...
<%@ page import="app.component.report.entity.MfBusMonth"%>
<% 
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=042089842fda9181f89857bcd327374e";
	List<MfBusMonth> list = new ArrayList<MfBusMonth>();
