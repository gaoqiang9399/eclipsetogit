...
<%@ page import="app.component.report.entity.MfReportPledge"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=a8ae01efa689068dd0a61d7345f388e3";
	List<MfReportPledge> list = new ArrayList<MfReportPledge>();
