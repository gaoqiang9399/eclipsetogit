...
<%@ page import="app.component.report.entity.MfCountByVouType"%>
<% 
	List<MfCountByVouType> list = new ArrayList<MfCountByVouType>();
	list = (List)request.getAttribute("list");
	Gson gson = new Gson(); 
	String json = gson.toJson(list);
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=55c9bc31406e3f65e0145a753f25ea91";
 %>
