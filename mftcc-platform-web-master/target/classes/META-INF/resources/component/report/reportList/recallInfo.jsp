...
<%@ page import="app.component.report.entity.MfReportRecall"%>
<% 
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=ce085fffc9738a379c40d7ebb0bfbeab";
	List<MfReportRecall> list = new ArrayList<MfReportRecall>();
