...
<%@ page import="app.component.report.entity.MfLoanAccountBean"%>
<% 
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=6fe45fc6ef732fc32da52b4096e1982f";
	List<MfLoanAccountBean> list = new ArrayList<MfLoanAccountBean>();
