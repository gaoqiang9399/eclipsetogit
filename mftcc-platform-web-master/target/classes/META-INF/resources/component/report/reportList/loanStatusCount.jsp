...
<%@ page import="app.component.report.entity.MfReportStatus"%>
<% 
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=9f5808bf81612ef4cd9d1acf15ba31b2";
	List<MfReportStatus> list = new ArrayList<MfReportStatus>();
