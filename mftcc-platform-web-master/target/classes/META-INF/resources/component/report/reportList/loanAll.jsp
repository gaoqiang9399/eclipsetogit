...
<%@ page import="app.component.report.entity.MfReportBus"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=eb2e97017861ffc042139443b4d6a172";
	List<MfReportBus> list = new ArrayList<MfReportBus>();
