...
<%@ page import="app.component.report.entity.MfReportFinc"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=cf7125cb8b2815de3656618831d45f08";
	List<MfReportFinc> list = new ArrayList<MfReportFinc>();
