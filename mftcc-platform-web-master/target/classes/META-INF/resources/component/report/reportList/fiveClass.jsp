...
<%@ page import="app.component.report.entity.MfReportFiveClass"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=6c55a87342d3056659d2a5b8ddc610a6";
	List<MfReportFiveClass> list = new ArrayList<MfReportFiveClass>();
