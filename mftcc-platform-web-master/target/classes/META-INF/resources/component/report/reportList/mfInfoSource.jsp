...
<%@ page import="app.component.report.entity.MfInfoSource"%>
<% 
	List<MfInfoSource> list = new ArrayList<MfInfoSource>();
	...
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=7954b029f8ff6c3304f909126575634e";
	Gson gson = new Gson();
