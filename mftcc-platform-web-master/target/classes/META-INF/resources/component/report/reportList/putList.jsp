...
<%@ page import="app.component.report.entity.MfLoanBean"%>
<%@ include file="/component/include/webPath.jsp" %>
<% 
	List<MfLoanBean> list = new ArrayList<MfLoanBean>();
	list = (List)request.getAttribute("list");
	Gson gson = new Gson(); 
	String json = gson.toJson(list);
	String reportUrl = String.valueOf(request.getAttribute("reportUrl"));
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=2d255b2ad66f1266deef36db3ff8a98e";
 %>
...
<html> 
	...
	<style>
	 ...
	 <script src="${webPath}/report_new/report/lib/jquery.min.js"></script>
	<script type="text/javascript">
		function search(){
			ifmreport.getSearch("1","","");
		}
		function searchpage(page){
			ifmreport.getSearch(page,"","");
		}
	</script>
	<body class="body_bg">
...
<tr><td valign="top" height="100%"><div style="width:100%;height:100%;z-index:-1;"><iframe id="ifmreport" name="ifmreport" src="${webPath}<%=repPath %>" frameborder="0" style="width: 100%; height: 100%;"></iframe></div></td></tr>
</tbody></table>
	</body>
</html>