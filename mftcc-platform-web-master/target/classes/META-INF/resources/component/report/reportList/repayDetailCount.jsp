...
<%@ page import="app.component.report.entity.MfRepayDetail"%>
<% 
	String repPath = "/report_new/report/rbc/designJavabean.jsp?reporttype=D&uid=49857cbdc94a3e5c3a2456eb17b6ac72";
	List<MfRepayDetail> list = new ArrayList<MfRepayDetail>();
