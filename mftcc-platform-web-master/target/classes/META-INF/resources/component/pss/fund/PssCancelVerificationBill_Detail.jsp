...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=webPath %>/component/pss/fund/js/PssCancelVerificationBill_Detail.js"></script>
		<script type="text/javascript">
			...
			$(function() {
				pssCancelVerificationBillDetail.init();
			...
			<div class="btn-div column">
				<div class="show-btn" style="float:left">
					<dhcc:pmsTag pmsId="pss-cancel-verification-insert">
						<button type="button" class="btn btn-primary" onclick="pssCancelVerificationBill.cancelVerificationBillInsertLink();">新增</button>
					...
					<div class="col-md-12 column">
							...
							<div class="col-xs-11 column mysearch-div" id="pills">
								<div class="mod-toolbar-top">
									...
									<div class="right">
										...
										<input class="items-btn" type="text" id="top-cancelNo" name="top-cancelNo" readonly value="${dataMap.cancelNo} "/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="pss-bigform-form">
							<div class="bootstarpTag">
								<form method="post" enctype="multipart/form-data" id="formpsscancelverificationbill0002" theme="simple" name="operform" action="${webPath}/pssCancelVerificationBill/updateAjax">
