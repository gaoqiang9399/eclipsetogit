...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=webPath %>/component/pss/fund/js/PssPaymentBill_Detail.js"></script>
		<script type="text/javascript" src="${webPath}/component/model/js/mfPageOffice.js?v=${cssJsVersion}"></script>
		<script type="text/javascript">
			var ajaxData = '${ajaxData}';
		    ajaxData =JSON.parse(ajaxData);
		    var auditSts =  '${dataMap.auditSts}';
		    var paymentId = '${pssPaymentBill.paymentId}';
		    
			$(function() {
				pssPaymentBillDetail.init();
		...
		<div class="btn-div column">
			<div class="show-btn" style="float:left">
				<dhcc:pmsTag pmsId="pss-payment-insert">
					<button type="button" class="btn btn-primary" onclick="pssPaymentBill.paymentBillInsertLink();">新增</button>
				</dhcc:pmsTag>
				<dhcc:pmsTag pmsId="pss-payment-print">
					<button type="button" class="btn btn-default" onclick="pssPaymentBillDetail.printBill();">打印</button>
				</dhcc:pmsTag>
				...
				<dhcc:pmsTag pmsId="pss-payment-check">
					<c:if test='${dataMap.auditSts eq "1"}'>
						<button type="button" class="btn btn-default" onclick="pssPaymentBill.reAuditOrder('#formpsspaymentbill0002');">反审核</button>
					</c:if>
				</dhcc:pmsTag>
			</div>
		</div>
				...
				<div class="row clearfix bg-white tabCont">
							...
							<div class="col-xs-11 column mysearch-div" id="pills">
								<div class="mod-toolbar-top">
									...
									<div class="right">
										...
										<input class="items-btn" type="text" id="top-paymentNo" name="top-paymentNo" readonly />
									</div>
									<c:if test='${dataMap.auditSts eq "1"}'>
					...
					<div class="pss-bigform-form">
						<div class="bootstarpTag">
							<form method="post" enctype="multipart/form-data" id="formpsspaymentbill0002" theme="simple" name="operform" action="${webPath}/pssPaymentBill/updateAjax">
