		...
		<script type="text/javascript">
			...
			$(function() {
				myCustomScrollbar({
			    	...
			    	url:webPath+"/pssCostAdjustDetailBill/findByPageAjax",//列表数据查询的url
		...
		<div class="btn-div column">
			<div class="show-btn" style="float:left">
				<dhcc:pmsTag pmsId="pss-cost-adjust-insert">
					<button type="button" class="btn btn-primary" onclick="saveAndAddOrder('#formpsscostadjustbill0002');">保存并新增</button>
					...
					<div class="col-md-12 column">
							...
							<div class="col-xs-11 column mysearch-div" id="pills">
								<div class="mod-toolbar-top">
									...
									<div class="right">
										...
										<input class="items-btn" type="text" id="top-costAdjustNo" name="top-costAdjustNo" value="${dataMap.costAdjustNo} "/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="pss-bigform-form">
							<div class="bootstarpTag">
								<form method="post" enctype="multipart/form-data" id="formpsscostadjustbill0002" theme="simple" name="operform" action="${webPath}/pssCostAdjustBill/saveOrderAjax">
