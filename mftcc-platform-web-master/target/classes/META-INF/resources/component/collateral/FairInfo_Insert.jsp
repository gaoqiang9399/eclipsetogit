...
// 			});
	...
	function validateFairNo(){
				$.ajax({
					url:webPath+"/fairInfo/validateFairNoAjax",
					data : {
						ajaxData : 	$("input[name=fairNo]").val()
					},
					type : "POST",
					dataType : "json",
					beforeSend : function() {
					...
					success : function(data) {
						if(data.result == "0"){
							func_uior_addTips($("input[name=fairNo]"),"公证书编号已存在");
			...
			<div class="scroll-content">
				<div class="col-md-8 col-md-offset-2 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form  method="post" id="fairInfoInsert" theme="simple" name="operform" action="${webPath}/fairInfo/insertAjax">
							<dhcc:bootstarpTag property="formdlfairinfo0002" mode="query"/>
						</form>	
					</div>
				</div>	
			</div>
