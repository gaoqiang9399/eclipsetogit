;
var WkfReceDisputedViewPoint=function(window,$){
	var _init=function(){
...
//		});
	...
	var _doSubmit=function(obj){
		...
		if(flag){
			commitProcess(webPath+"/mfReceivablesDisputedApp/submitUpdateAjax?opinionType"+opinionType+"&disputedAppId="+disputedAppId
			+"&appId="+appId,obj,'receTranSP');
		}
	};
	return{
		init:_init,
