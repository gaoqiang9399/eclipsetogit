;
var pleNotarizationList=function(window,$){
	var _init=function(){
	    ...
	    myCustomScrollbar({
	    	...
	    	data:{pledgeMethod:pledgeMethod,cusNo:cusNo,appId:appId,pleFlag:"notarization"},//指定参数
	    	callback:function(){
	    		LoadingAnimate.stop();
	...
	var _enterClick=function(parmArgs){
		...
		window.location.href = webPath+"/mfBusCollateralRel/pleNotarizationForm?pledgeNo="+pledgeNo+"&pactId="+pactId;
