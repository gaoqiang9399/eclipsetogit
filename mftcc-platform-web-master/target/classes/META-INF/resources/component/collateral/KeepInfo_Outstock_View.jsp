...
<div class="mf_content">
	<div class="content-box">
		...
		<div class="tab-content">
			<form  method="post" id="instockInsert" theme="simple" name="operform" action="${webPath}/keepInfo/outstockAjax1">
				<dhcc:bootstarpTag property="formdlkeepoutview0008" mode="query"/>
			</form>
		</div>
	</div>
</div>
