...
var MfBusCollateralRel_receivables_Detail= function(window, $){
	var _init=function(){
	...
	var _addCollateralInfo =function(){
		var url = webPath+"/mfBusCollateralRel/infoCollectInput?cusNo="+cusNo+"&appId="+relId+"&entrFlag=collateral&entrance="+entrance+"&infoType=account";
