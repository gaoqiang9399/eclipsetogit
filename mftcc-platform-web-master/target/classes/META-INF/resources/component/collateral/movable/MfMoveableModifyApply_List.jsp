	...
	<head>
		...
		var busPleId = '${busPleId}';
			$(function(){
				...
				url:webPath+"/mfMoveableModifyApply/findByPageAjax?busPleId="+busPleId, //列表数据查询的url
				tableId : "tablemodify0001", //列表数据查询的table编号
			...
			<div class="row clearfix bg-white tabCont">
				<div class="col-md-12">
					...
					<div class="search-div">
						<jsp:include page="/component/include/mySearch.jsp?blockType=2&placeholder=押品名称/押品编号"/>
					</div>
				</div>
			</div>
