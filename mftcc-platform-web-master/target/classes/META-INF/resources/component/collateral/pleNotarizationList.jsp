...
<html>
	<head>
		...
		<script type="text/javascript" src="${webPath}/component/collateral/js/pleNotarizationList.js"></script>
		...
		$(function(){
			pleNotarizationList.init();
		});
		function enterClick(parm){
			pleNotarizationList.enterClick(parm);
		};
		</script>
	</head>
	<body>
