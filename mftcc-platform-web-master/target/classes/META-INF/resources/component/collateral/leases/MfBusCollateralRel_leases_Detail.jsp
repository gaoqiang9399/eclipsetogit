						...
						<div class="col-xs-3 column text-center head-img">
							<div>
								<button type="button" class="btn btn-font-pledge font-pledge-div padding_left_15">
									<i class="i i-lease font-icon"></i>
									<div class="font-text-left">租赁物</div>
								</button>
							</div>
								...
								<div class="margin_bottom_10">
									...
									<c:if test="${mfBusApply.busModel==5||mfBusApply.busModel==1}">
										<dhcc:pmsTag pmsId="pledge-prove">
											<button class="btn btn-view  btn-lightgray" type="button" id= "recePledge" onclick="MfBusCollateralRel_leases_Detail.getRecePledgeInfo();">
									...
									<c:if test="${mfBusApply.busModel==13}">
										<dhcc:pmsTag pmsId="pledge-prove">
											<button class="btn btn-view  btn-lightgray" type="button" id= "recePledge" onclick="MfBusCollateralRel_leases_Detail.getReceTranInfo();">
									...
									<c:if test="${mfBusApply.busModel==5||mfBusApply.busModel==13}">
										<dhcc:pmsTag pmsId="pledge-rebate-history">
											<button class="btn btn-view btn-lightgray" type="button" id="rebateHistory" onclick="MfBusCollateralRel_leases_Detail.getRebateHistory();">
												<i class="i i-zherang1"></i><span>折让历史</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-disputed-history">
											<button class="btn btn-view btn-lightgray" type="button" id="disputedHistory" onclick="MfBusCollateralRel_leases_Detail.getDisputedHistory();">
									...
									<c:if test="${mfBusApply.busModel==1}">
										...
										<dhcc:pmsTag pmsId="pledge-modify-history">
											<button class="btn btn-view  btn-lightgray " type="button" id="modifyHistory" onclick="MfBusCollateralRel_leases_Detail.getModifyHistory();">
									...
									<dhcc:pmsTag pmsId="pledge-repo-affirm-info">
										<button class="btn btn-view  btn-lightgray" type="button" id="repoAffirmInfo" onclick="MfBusCollateralRel_leases_Detail.getRepoAffirmInfo();">
						...
						<div class="col-xs-12 column info-collect">
								<table>
									<tr>
										...
										<td>
											<p class="cont-title">租赁物数量</p>
											<p><span id='envalueAmt_lease' class="content-span">
												${mfBusCollateralRel.pledgeNum}
											</span></p>
										</td>
										<td>
											<p class="cont-title">租赁物价值</p>
											<p><span id='pledgeNum_lease' class="content-span">
										...
										<td>
											 <p class="cont-title">保险到期日</p>
											<p><span id='receiptsAmount_lease' class="content-span">											
							...
							<div class="col-xs-12 column">
								<div class="btn-group pull-right">
									<dhcc:pmsTag pmsId="add-pledge-info">
										<button class="btn btn-opt" id ="addCollateralInfo" onclick="MfBusCollateralRel_leases_Detail.addCollateralInfo();" type="button">
												<i class="i i-jia1"></i><span>新增</span>
										</button>
									</dhcc:pmsTag>
									<dhcc:pmsTag pmsId="pledge-batch-inStock">
										<button id="batchInStock" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.inStockCollateralBatch();" type="button">
									...
									<c:if test="${mfBusApply.busModel==4}">
										<dhcc:pmsTag pmsId="pledge-moveable-buy-back">
											<button id="moveableBuyBack" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.moveableBuyBack();" type="button">
												<i class="i i-rebate"></i><span>回购申请</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-moveable-buy-back-confirm">
											<button id="moveableBuyBackConfirm" class="btn btn-opt" style="display:none" onclick="MfBusCollateralRel_leases_Detail.moveableBuyBackConfirm();" type="button">
									...
									<c:if test="${mfBusApply.busModel==13||mfBusApply.busModel==5}">
										<dhcc:pmsTag pmsId="pledge-rebate-apply">
											<button id="rebatePledge" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.rebatePledge();" type="button">
												<i class="i i-zherang1"></i><span>折让</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-rebate-affirm">
											<button id="rebateAffirm" class="btn btn-opt" style="display: none;" onclick="MfBusCollateralRel_leases_Detail.rebateAffirm();" type="button">
												<i class="i i-zherang1"></i><span>折让确认</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-disputed-deal-apply">
											<button id="disputedDealPledge" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.disputedDealPledge();" type="button">
												<i class="i i-rebate"></i><span>争议处理</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-relieve-disputed">
											<button id="relieveDisputed" class="btn btn-opt" style="display: none;" onclick="MfBusCollateralRel_leases_Detail.relieveDisputed();" type="button">
									...
									<c:if test="${mfBusApply.busModel==13}">
										<dhcc:pmsTag pmsId="pledge-buy-back-apply">
											<button id ="buyBackPledge" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.buyBackPledge();" type="button">
												<i class="i i-fanzhuanrang"></i><span>反转让</span>
											</button>
										</dhcc:pmsTag>
										<dhcc:pmsTag pmsId="pledge-rece-repo-affirm">
											<button id ="receRepoAffirm" class="btn btn-opt" style="display: none;" onclick="MfBusCollateralRel_leases_Detail.receRepoAffirm();" type="button">
												<i class="i i-fanzhuanrang"></i><span>反转让确认</span>
											</button>
										</dhcc:pmsTag>
									</c:if>
									<dhcc:pmsTag pmsId="pledge-batch-out-stock">
										<button id="batchOutStock" class="btn btn-opt" onclick="MfBusCollateralRel_leases_Detail.outStockCollateralBatch();" type="button">
...
<script type="text/javascript" src="${webPath}/component/collateral/leases/js/MfBusCollateralRel_leases_Detail.js"></script>
...
<script type="text/javascript">
		...
		$(function(){
			MfBusCollateralRel_leases_Detail.init();
		});
		</script>
		<script type="text/javascript">								
