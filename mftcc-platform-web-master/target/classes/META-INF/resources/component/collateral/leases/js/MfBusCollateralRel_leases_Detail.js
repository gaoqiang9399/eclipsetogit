...
function getCusInfo(){
	...
	if(busEntrance == 'credit' || busEntrance == 'cus_credit'){
...
function oneCallback(data) {
	...
	if(name=="evalAmount"){
		MfBusCollateralRel_leases_Detail.updateCollateral();
	};
	if(name=="assureAmt"){
		MfBusCollateralRel_leases_Detail.updateCollateral();
	};
	...
	$(".form-table").empty();
	MfBusCollateralRel_leases_Detail.showCollateralBaseInfo();
}
...
var MfBusCollateralRel_leases_Detail= function(window, $){
	var _init=function(){
					...
					$.each(data.htmlMap,function(index,obj){
                        ...
                        var collateralName,pledgeMethod,collateralNameCapture,releaseCollateralStr,htmlStr;
							if(vouType!="2"){//抵质押信息
								...
								releaseCollateralStr = '<button class="btn btn-link formAdd-btn" id="release'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.releaseCollateral(\''+collateralId+'\',\''+collateralName+'\');" title="删除">删除</button>';
								var inStockStr = '<button class="btn btn-link formAdd-btn" id="inStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.inStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+pledgeMethod+'\');" title="入库">入库</button>';
								var outStockStr = '<button class="btn btn-link formAdd-btn" id="outStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.outStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+pledgeMethod+'\');" title="出库">出库</button>';
								var replaceCollateral = '<button class="btn btn-link formAdd-btn" id="replace'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.replaceCollateral(\''+collateralId+'\');" title="置换">置换</button>';
	...
	var _addCollateralInfo =function(){
		var url = webPath+"/mfBusCollateralRel/infoCollectInput?cusNo="+cusNo+"&appId="+relId+"&entrFlag=collateral&entrance="+entrance+"&infoType=lease";
				...
				jQuery.ajax({
					...
					beforeSend:function(){
						...
						if(data.flag="success"){
                            ...
                            var releaseCollateralStr,htmlStr;
							if(vouType!="2"){//抵质押信息
								var keepStsName=data.pledgeBaseInfo.extOstr01;
								var keepStatus=data.pledgeBaseInfo.keepStatus;
								releaseCollateralStr = '<button class="btn btn-link formAdd-btn" id="release'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.releaseCollateral(\''+collateralId+'\',\''+collateralName+'\');" title="删除">删除</button>';
								var inStockStr = '<button class="btn btn-link formAdd-btn" id="inStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.inStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+vouType+'\');" title="入库">入库</button>';
								var outStockStr = '<button class="btn btn-link formAdd-btn" id="outStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.outStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+vouType+'\');" title="出库">出库</button>';
								var replaceCollateral = '<button class="btn btn-link formAdd-btn" id="replace'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.replaceCollateral(\''+collateralId+'\');" title="置换">置换</button>';
								var lowestWorthAdjust = '<button class="btn btn-link formAdd-btn" id="worthAdjust'+collateralId+'" onclick="MfMoveableCommon.lowestWorthAdjust(\''+collateralId+'\');" title="最低监管价值调整">监管调整</button>';
				...
				jQuery.ajax({
					...
					beforeSend:function(){  
						...
						if(data.flag="success"){
							...
							var releaseCollateralStr = '<button class="btn btn-link formAdd-btn" id="release'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.releaseCollateral(\''+collateralId+'\',\''+collateralName+'\');" title="删除">删除</button>';
							var inStockStr = '<button class="btn btn-link formAdd-btn" id="inStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.inStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+collateralType+'\');" title="入库">入库</button>';
							var outStockStr = '<button class="btn btn-link formAdd-btn" id="outStock'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.outStockKeepInfo(\''+collateralId+'\',\''+collateralName+'\',\''+collateralType+'\');" title="出库">出库</button>';
							var replaceCollateral = '<button class="btn btn-link formAdd-btn" id="replace'+collateralId+'" onclick="MfBusCollateralRel_leases_Detail.replaceCollateral(\''+collateralId+'\');" title="置换">置换</button>';
							var lowestWorthAdjust = '<button class="btn btn-link formAdd-btn" id="worthAdjust'+collateralId+'" onclick="MfMoveableCommon.lowestWorthAdjust(\''+collateralId+'\');" title="最低监管价值调整">监管调整</button>';
