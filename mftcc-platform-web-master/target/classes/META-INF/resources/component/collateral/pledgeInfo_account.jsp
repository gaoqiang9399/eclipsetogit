...
<head>
	...
	<script type="text/javascript">
        var tableId  = "tablepactAccountInfoBase";
        $(function() {
            PledgeInfo_account.init();
        });
			...
			<div class="btn-div">
				<%--<div class="col-md-2">
					<c:if test="${subEntrance ne 'query'}">
						<dhcc:pmsTag pmsId="account-account-add-btn">
							<button type="button" class="btn btn-primary" onclick="MfBusCollateralList.pledgeInsert(this);">新增</button>
						</dhcc:pmsTag>
					</c:if>
				</div>--%>
				<div class="col-md-12 text-center">
					<span class="top-title">应收账款质押</span>
				</div>
			</div>
			<div class="search-div" id="search-div">
				<jsp:include page="/component/include/mySearch.jsp?blockType=3&placeholder=应收账款名称/关联客户"/>
			</div>
		</div>
	</div>
