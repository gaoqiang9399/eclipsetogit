...
<html>
	<head>
		<title>新增</title>
        <script type="text/javascript" src='${webPath}/component/invoicemanage/js/MfBusInvoicemanage_Form.js?v=${cssJsVersion}'></script>
		...
		<div class="scroll-content">
			<div class="col-md-10 col-md-offset-1 margin_top_20">
				<div class="bootstarpTag fourColumn">
						...
						<form  method="post" id="cusInsertForm" theme="simple" name="operform" action="${webPath}/mfBusInvoicemanage/insertInvoiceAjax?invoiceId">
			...
			<div class="formRowCenter">
	   			...
	   			<dhcc:thirdButton value="取消" action="取消" typeclass="cancel" onclick="MfBusInvoicemanage_Form.cancelInsert()"></dhcc:thirdButton>
	   		</div>
   		</div>
	</body>
</html>
