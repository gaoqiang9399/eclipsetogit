...
<html>
	<head>
		<title>新增</title>
        <script type="text/javascript" src='${webPath}/component/invoicemanage/js/MfBusInvoiceOutmanage_Form.js?v=${cssJsVersion}'></script>
        ...
        MfBusInvoiceOutmanage_Form.init();
	...
	<body class="overflowHidden bg-white">
		<div class="container form-container">
			<div class="scroll-content">
				<div class="col-xs-10 col-md-offset-1 column margin_top_20">
					<div class="bootstarpTag">
						...
						<form  method="post" id="cusInsertForm" theme="simple" name="operform" action="${webPath}/mfBusInvoicemanage/insertInvoiceOutAjax">
			...
			<div class="formRowCenter">
	   			<dhcc:thirdButton value="审批" action="审批" typeclass="save" onclick="MfBusInvoiceOutmanage_Form.ajaxSave('#cusInsertForm')"></dhcc:thirdButton>
	   			<dhcc:thirdButton value="取消" action="取消" typeclass="cancel" onclick="MfBusInvoiceOutmanage_Form.cancelInsert()"></dhcc:thirdButton>
	   		</div>
   		</div>
	</body>
</html>
