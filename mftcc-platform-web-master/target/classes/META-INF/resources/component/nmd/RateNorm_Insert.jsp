...
<html>
	...
	<body class="body_bg" style="overflow:hidden; height:96%;">
		<div class="bigform_content" style="padding-top:20px;" align="center">
			...
			<form method="post" theme="simple" name="operform" action="${webPath}/tateNorm/insert">
				<dhcc:formTag property="formnmd0003" mode="query"/>
				<div class="formRow">
	    			<dhcc:thirdButton value="保存" action="RateNorm002" commit="true"></dhcc:thirdButton>
	    		</div>
			</form>	
			</div>
		</div>
