...
<html>
			...
			$(function(){
			 ...
			 function initPage(){
				 myCustomScrollbar({
				    	...
				    	url:webPath+"/sysLegalHolidayRecord/findByPageAjax",//列表数据查询的url
				    	tableId:"tableholiday0001",//列表数据查询的table编号
		...
		<div class="row clearfix bg-white tabCont">
			...
			<div  class="btn-div">
						<button type="button" class="btn btn-info pull-left"
							onclick="finForm_input('${webPath}/sysLegalHolidayRecord/input');">新增</button>
						<ol class="breadcrumb pull-left">
							<li><a href="${webPath}/sysDevView/setC?setType=base">基础配置</a></li>
							<li class="active">假日</li>
						</ol>
			</div>
				...
				<div class="search-div" id="search-div">
							<jsp:include page="/component/include/mySearch.jsp?blockType=4&placeholder=年份"/>
				</div>
			</div>
		</div>
	</div>
	...
	function finForm_input(url){//新增弹框
		top.addFlag = false;
		top.createShowDialog(url,"新增假日",'90','90',function(){
			if(top.addFlag){
	...
	function getByIdThis(url){//详情弹框
		...
		top.createShowDialog(url,"设置假日",'70','60',function(){
			if(top.detailFlag){
				 updateTableData();//重新加载列表数据
	   		}
		});
