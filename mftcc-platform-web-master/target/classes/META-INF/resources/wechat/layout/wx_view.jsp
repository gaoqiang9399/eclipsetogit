...
<body ontouchstart="">
	<nav id="menu">
			  ...
			  <div class="weui_panel_bd">
			    <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
			      ...
			      <div class="weui_media_bd">
			        <h4 class="weui_media_title"><%=request.getSession().getAttribute("regName")%></h4>
		...
		<footer>
			<a href="javascript:;" onclick="loginout();"  class="weui_btn weui_btn_mini weui_btn_default">退出</a>
		</footer>
	</nav>
	<main id="panel" >
		<div class="header">
		...
		<div class="mainbody">
			<iframe id="a_iframe" src="<%=contextpath%>/SysSkipAction_skipToC.action?entranceNo=99" marginheight="0" marginwidth="0" frameborder="0" scrolling="auto" width="100%" height="100%" name="iframepage"></iframe>
		</div>
	</main>
	<script type="text/javascript">
	function loginout(){
		window.top.loadPage("WxSysLoginAction_logout.action");
	}
