...
function createRoot(jQ, root, textbox, editable) {
  ...
  if (!editable) {
    textareaManager = manageTextarea(textarea, { container: jQ });
    ...
    textareaManager = manageTextarea(textarea, {
    container: jQ,
...
jQuery.fn.mathquill = function(cmd, latex) {
  ...
  case 'text':
    ...
    return block && block.text();*/
      var blockIdOther = $(this).attr(mqBlockId),
          blockOther = blockIdOther && MathElement[blockIdOther];
      return blockOther && blockOther.text();
  case 'html':
