...
\----------------------------------------------------------------------------*/
 ...
 var webFXTreeConfig = {
    rootIcon        : '../UIplug/xtree/images/foldericon.png',
    openRootIcon    : '../UIplug/xtree/images/openfoldericon.png',
    folderIcon      : '../UIplug/xtree/images/foldericon.png',
    openFolderIcon  : '../UIplug/xtree/images/openfoldericon.png',
    fileIcon        : '../UIplug/xtree/images/file.png',
    iIcon           : '../UIplug/xtree/images/I.png',//
    lIcon           : '../UIplug/xtree/images/L.png',
    lMinusIcon      : '../UIplug/xtree/images/Lminus.png',
    lPlusIcon       : '../UIplug/xtree/images/Lplus.png',
    tIcon           : '../UIplug/xtree/images/T.png',//
    tMinusIcon      : '../UIplug/xtree/images/Tminus.png',
    tPlusIcon       : '../UIplug/xtree/images/Tplus.png',
    blankIcon       : '../UIplug/xtree/images/blank.png',
    defaultText     : 'WebTree',
    defaultAction   : '#',
...
// 2005-3-29ҹ �޸���http://webfx.eae.net/webboard/
// ����ie�������һ��domain���������20��cookie, �����ɱ��server��session
// û�и������ʲôԭ��, ������ie��JSESSIONIDɾ����ɵ����,
// firefox��������������
...
//---------WebFXCheckBoxTreeItem �޸���2005-2-19
...
WebFXCheckBoxTreeItem.prototype.getChecked = function () {
        var obj = this;
    	var divEle,divParentE1e,inputEle,inputParentEle;
        while(obj.parentNode != null) {
            divEle = document.getElementById(obj.id);
            divParentE1e = document.getElementById(obj.parentNode.id);
            inputEle = divEle.getElementsByTagName("INPUT")[0];
            if(inputEle.checked) {
                if(divParentE1e != null) {
                    inputParentEle = divParentE1e.getElementsByTagName("INPUT")[0];
        ...
        divEle = document.getElementById(this.id);
        inputEle = divEle.getElementsByTagName("INPUT")[0];
