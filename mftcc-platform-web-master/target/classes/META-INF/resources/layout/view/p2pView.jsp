			...
			<div class="outer-west-center" style="background-color: #153754 !important;overflow:visible;">
				...
				<ul class ="menu_A" style="" id="cwMenu">
					<li class = "menu-active">
						<i class="i i-fangkuai"></i><a href="${webPath}/p2pCreditorPoolManage/getListPage" pagetype="diannao" onclick="return false">债权</a>
					</li>
					<li class = "">
						<i class="i i-chilun"></i><a href="${webPath}/p2pBidissueManage/getListPage" pagetype="qian2" onclick="return false">标的</a>
					</li>
					<li class = "">
						<i class="i i-fukuanjihua"></i><a href="${webPath}/p2pRepayPlan/getListPage" pagetype="qian2" onclick="return false">还款</a>
					</li>
				</ul>
			</div>
		</div>
