...
<html>
  <head>
		...
		function showPageInfo(value){  
			...
			/**系统退出**/
	    	function sysQuit(){
	    		window.top.location.href = webPath+"/logout";
	    	}
...
/* 				filter: alpha(opacity=0); */
	...
	<body onLoad="onPageLoad();" class="bgView">
			...
			<div class="middle-center pt-perspective">
				...
				<div class="middle-north-west TopBar-chevron" style="height:55px;">
					<span class="logodes" ><%= mfSysCompanyMst.getSystemName() %></span>
					 <img src="${webPath}/<%= mfSysCompanyMst.getPropagandaLanguageImg() %>" style="width: 214px;height: 39px; position: relative; top: 15px; margin-left:283px;" />
				</div>
				<!-- 详情 -->
		...
		<div class="outer-west" style="overflow:visible!important;">
			<!-- LOGO-->
			<!-- 视角-->
			<div class="set-page outer-west-center" style="overflow:visible;display: table;" id="setView">
				...
				<ul class ="menu_A" style="width:120px;">
					...
					<li class = "menu-active">
						<a href="${webPath}/sysOrg/listSysOrg?opNoType=1" pagetype="diannao" onclick="return false">机构设置</a>
					</li>
					<!-- <li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=orga" pagetype="diannao" onclick="return false">组织架构</a>
					</li>
					<li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=limit" pagetype="diannao" onclick="return false">权限设置</a>
					</li> -->
					<dhcc:pmsTag pmsId="set-cus-conf">
					<li class = "menu-active">
						<a href="${webPath}/mfCusFormConfig/getMfCusConfig" pagetype="diannao" onclick="return false">客户设置</a>
					</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="set-kind-conf">
					<li class = "menu-active">
						<a href="${webPath}/mfSysKind/toKindConfig" pagetype="diannao" onclick="return false">产品设置</a>
					</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="set-loan-after-conf">
					<li class = "menu-active">
						<a href="${webPath}/mfExamineTemplateConfig/getLoanAfterConfig" pagetype="diannao" onclick="return false">保后设置</a>
					</li>
					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="set-front-conf">
					<li class = "menu-active"> 
 						<a href="${webPath}/mfFrontKind/getAppKindConfig" pagetype="diannao" onclick="return false">前端设置</a> 
 					</li> 
 					</dhcc:pmsTag>
					<dhcc:pmsTag pmsId="set-mobile-conf">
						<li class = "menu-active">
							<a href="${webPath}/mfCusFormConfig/getMfCusConfigToApp" pagetype="diannao" onclick="return false">移动设置</a>
						</li>
					</dhcc:pmsTag>
					<!-- <li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=form" pagetype="diannao" onclick="return false">表单设置</a>
					</li> -->
					
					<!--<li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=task" pagetype="diannao" onclick="return false">流程设置</a>
					</li>
					<li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=argu" pagetype="diannao" onclick="return false">参数设置</a>
					</li>
					 <li class = "menu-active">
						<a href="/factor/sysDevView/setC?setType=template" pagetype="diannao" onclick="return false">模板设置</a>
					</li> -->
<!-- 					<li class = "menu-active"> -->
<!-- 						<a href="/factor/sysDevView/setC?setType=clean" pagetype="diannao" onclick="return false">数据清理</a> -->
<!-- 					</li> -->
					<dhcc:pmsTag pmsId="set-base-conf">
						<li class = "menu-active">
							<a href="${webPath}/sysDevView/setC?setType=base" pagetype="diannao" onclick="return false">基础配置</a>
						</li>
					</dhcc:pmsTag>
				</ul>
			</div>
