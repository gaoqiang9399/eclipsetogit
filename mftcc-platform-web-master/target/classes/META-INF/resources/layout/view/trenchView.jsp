...
String orgName = (String)request.getSession().getAttribute("channelSourceName");
...
<html>
  <head>
		...
		<script type="text/javascript" src="${webPath}/<%=layout%>/js/trenchZl.js?v=${cssJsVersion}"></script>
		...
		<link rel="stylesheet" href="${webPath}/themes/factor/css/viewUserDef.css?v=${cssJsVersion}" />
		...
		function closePop(){
			...
			/**系统退出**/
	    	function sysQuit(){
	    		window.top.location.href = webPath+"/trenchLogout.action";
	    	}
			var path = '${webPath}';
...
/* 				filter: alpha(opacity=0); */
			...
			.outer-west-center .menu_A li:hover{
				background-color:#353535;
			}
			.menu-active{
				background:url("${webPath}/themes/factor/images/jiantou.png") no-repeat 0px 0px;
				background-color:#353535;
			}
		</style>
	</head>
	<body onLoad="onPageLoad();dwr.engine.setActiveReverseAjax(true);dwr.engine.setNotifyServerOnPageUnload(true);">
		<div class="outer-center">
			<div class="middle-center pt-perspective">
				...
				<div class="middle-north-west TopBar-chevron" style="background-color:#32b5cb;height:55px;">
					<span class="logodes" >渠道业务系统</span>
							...
							<!-- <li>
						 	 ...
						 	 <li  id="perDa" class="user-menu">
								<a href="#">
								  ...
								  <span>欢迎您，<%=request.getSession().getAttribute("cusNickname")%></span>
								</a>
							</li>
						 </ul>
					</div>
		...
		<div class="outer-west" style="overflow:visible!important;">
			...
			<div class="outer-west-center" style="background-color: #e2e6f0;overflow:visible;">
				...
				<ul class ="menu_A" id="cwMenu">
					<li class = "menu-active" id="cus-li">
						<i class="i i i-account"></i><a href="${webPath}/mfCusCustomer/getCusListByTrenchPage?entranceNo=8" pagetype="qian2" onclick="return false">客户</a>
					</li>
					<li class = "menu-active" id="apply-li">
						<i class="i i-bi1"></i><a href="${webPath}/mfBusApply/getTrenchApplyListPage?entranceNo=2" pagetype="qian2" onclick="return false">进件</a>
					</li>
					<li class = "menu-active" id="pact-li">
						<i class="i i-wenjian3"></i><a href="${webPath}/mfBusPact/getTrenchListPage?entranceNo=3" pagetype="qian2" onclick="return false">签约</a>
					</li>
					<li class = "menu-active" id="bussQuery-li">
						<i class="i i-fangdajing"></i><a href="${webPath}/mfBusApply/getTrenchBussList?entranceNo=2" pagetype="qian2" onclick="return false">查询</a>
					</li>
				</ul>
			</div>
		</div>
		<div id="my-info" class="my-info">
			...
			<div class="row clearfix my-info-opt btn-group">
				<button class="btn btn-link" onclick="view.editPasswordInput();">
...
<script type="text/javascript" src="${webPath}/<%=layout%>/js/trenchView.js" ></script>
<script type="text/javascript">
	var viewFlag = "view";
	var opNo = "<%=opNo%>";
