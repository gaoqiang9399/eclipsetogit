...
$(function() {
	...
	var temp = "<div class='cell fw-float' style=' top :" + sy + "px; left :" + sx + "px; width:190px; height: 140px; background-color: #EBEBEB; z-index:9999' data-handle='.handle'><div class='cover'><div class='handle handle-line'><span>点此拖拽</span></i><i class='fa fa-refresh jt-down'></i><i class='jt-down'>"+trash+"</i></div></div><i class='bottomright'></i><div class='info'></div></div>";
