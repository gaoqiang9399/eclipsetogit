...
{
src="FormForToolBean_initForm.action?formId="+currFormId;
}
...
<head>
    ...
    <link rel="stylesheet" href="./sea-modules/bootstrap-switch/css/bootstrap-switch.min.css"/>
    <!--引用font-awesome图标样式库-->
    ...
    <link rel="stylesheet" href="./app/common/css/formIframe.css" />
    <link rel="stylesheet" href="./app/common/css/myBootStrap.css" />
    <!--页面加载样式-->
    <link rel="stylesheet" href="./sea-modules/pace/css/pace-theme-corner-indicator.tmpl.css" />
    <!-- select样式 -->
...
<body style="min-width: 1300px" class="mystyle">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行单击参数</div>
                                    <input id="addTableTrClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行双击参数</div>
                                    <input id="addTableTrDbClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行换色参数</div>
                                    <input id="addTableTrColorCol" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行单击参数</div>
                                    <input id="modifyTableTrClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行双击参数</div>
                                    <input id="modifyTableTrDbClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                     </div>
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行换色参数</div>
                                    <input id="modifyTableTrColorCol" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                <div class="input-group text-center">
                                    <div class="input-group-addon">原列表号</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group text-center">
                                <div class="input-group text-center">
                                    <div class="input-group-addon">新列表号</div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行单击参数</div>
                                    <input id="newPageTrClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                <div class="input-group text-center input_group_width">
                                    <div class="input-group-addon">行双击参数</div>
                                    <input id="newPageTrDbClick" class="form-control" type="text"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
	                     <div class="col-md-12">
	                         <div class="form-group text-center">
	                             <div class="input-group text-center input_group_width">
	                                 <div class="input-group-addon">行换色参数</div>
	                                 <input id="newPageTrColorCol" class="form-control" type="text"/>
	                             </div>
	                         </div>
	                     </div>
	                 </div>
...
<script type="text/javascript">
    ...
    seajs.use('<%=contextpath%>/tech/dragDesginerClient/app/common/js/formIframe.js');
    //解决兼容性
