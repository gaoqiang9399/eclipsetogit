...
+ function($) {
  ...
  $.actions = function(params) {
    params = $.extend({}, defaultsArgs, params);
    show(params);
  }
  ...
  var Picker = function (params) {
      ...
      p.updateValue = function () {
          ...
          if (p.input && p.input.length > 0) {
              ...
              $(p.input).attr("data-values",p.params.formatValue ? p.params.formatValue(p, p.value, p.displayValue) : p.value.join(' '));
...
+function ($) {
  ...
  var Calendar = function (params) {
      ...
      function onPickerClose() {
          ...
          //根据需求自定义
          if(p.params.hasOwnProperty('onClose')){
        	  p.params.onClose.call(this,p);
          }
      }
