...
<%
	...
	WxFormData2 form0001 = new WxFormData2();
	WxFormDataService2 wf2 = new WxFormDataService2();
	form0001 = wf2.getFormData("form0001");
	...
	wf2.getObjectValue(form0001, dataMap);
	request.setAttribute("form0001",form0001);
...
<body>
<wx:wxformTag2 property="form0001"/>
</body>
</html>
